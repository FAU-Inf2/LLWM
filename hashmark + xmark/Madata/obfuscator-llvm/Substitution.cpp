...
//===----------------------------------------------------------------------===//
//
// This file implements the substitution pass
//
//===----------------------------------------------------------------------===//
...
bool Substitution::runOnFunction(Function &F) {
   ...
   if (ObfTimes <= 0) {
    ...
    //initialization stuff to make this be able to stand alone
    this->funcAdd[0] = &Substitution::addNeg;
    this->funcAdd[1] = &Substitution::addDoubleNeg;
    this->funcAdd[2] = &Substitution::addRand;
    this->funcAdd[3] = &Substitution::addRand2;

    this->funcSub[0] = &Substitution::subNeg;
    this->funcSub[1] = &Substitution::subRand;
    this->funcSub[2] = &Substitution::subRand2;

    this->funcAnd[0] = &Substitution::andSubstitution;
    this->funcAnd[1] = &Substitution::andSubstitutionRand;

    this->funcOr[0] = &Substitution::orSubstitution;
    this->funcOr[1] = &Substitution::orSubstitutionRand;

    this->funcXor[0] = &Substitution::xorSubstitution;
    this->funcXor[1] = &Substitution::xorSubstitutionRand;
      ...
      for (BasicBlock::iterator inst = bb->begin(); inst != bb->end(); ++inst) {
        ...
        if (inst->isBinaryOp()) {
          ...
          case BinaryOperator::Add:
            ...
            boperator=dyn_cast<BinaryOperator>(inst);
