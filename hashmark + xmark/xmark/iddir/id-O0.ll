...
221:                                              ; preds = %149
  ...
  %222 = load i8, i8* @just_user, align 1
  %223 = trunc i8 %222 to i1
  br i1 %223, label %224, label %227

224:                                              ; preds = %221
  %225 = load i8, i8* @use_real, align 1
  %226 = trunc i8 %225 to i1
  br i1 %226, label %251, label %236

227:                                              ; preds = %221
  %228 = load i8, i8* @just_group, align 1
  %229 = trunc i8 %228 to i1
  br i1 %229, label %251, label %230

230:                                              ; preds = %227
  %231 = load i8, i8* @just_group_list, align 1
  %232 = trunc i8 %231 to i1
  br i1 %232, label %251, label %233

233:                                              ; preds = %230
  %234 = load i8, i8* @just_context, align 1
...
236:                                              ; preds = %233, %224
  ...
  %238 = call i32 @geteuid() #9
  store i32 %238, i32* @euid, align 4
...
242:                                              ; preds = %236
  %243 = call i32* @__errno_location() #14
  %244 = load i32, i32* %243, align 4
  %245 = icmp ne i32 %244, 0
  br i1 %245, label %246, label %250

246:                                              ; preds = %242
  %247 = call i32* @__errno_location() #14
  %248 = load i32, i32* %247, align 4
  %249 = call i8* @gettext(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.23, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %248, i8* %249)
  unreachable
...
251:                                              ; preds = %250, %233, %230, %227, %224
  %252 = load i8, i8* @just_user, align 1
  %253 = trunc i8 %252 to i1
  br i1 %253, label %254, label %257

254:                                              ; preds = %251
  %255 = load i8, i8* @use_real, align 1
  %256 = trunc i8 %255 to i1
  br i1 %256, label %266, label %281

257:                                              ; preds = %251
  %258 = load i8, i8* @just_group, align 1
  %259 = trunc i8 %258 to i1
  br i1 %259, label %281, label %260

260:                                              ; preds = %257
  %261 = load i8, i8* @just_group_list, align 1
  %262 = trunc i8 %261 to i1
  br i1 %262, label %266, label %263

263:                                              ; preds = %260
  %264 = load i8, i8* @just_context, align 1
...
266:                                              ; preds = %263, %260, %254
  ...
  %268 = call i32 @getuid() #9
  store i32 %268, i32* @ruid, align 4
  %269 = load i32, i32* @ruid, align 4
  %270 = load i32, i32* %14, align 4
  %271 = icmp eq i32 %269, %270
  br i1 %271, label %272, label %280

272:                                              ; preds = %266
  %273 = call i32* @__errno_location() #14
  %274 = load i32, i32* %273, align 4
  %275 = icmp ne i32 %274, 0
  br i1 %275, label %276, label %280

276:                                              ; preds = %272
  %277 = call i32* @__errno_location() #14
  %278 = load i32, i32* %277, align 4
  %279 = call i8* @gettext(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %278, i8* %279)
  unreachable
...
281:                                              ; preds = %280, %263, %257, %254
  %282 = load i8, i8* @just_user, align 1
  %283 = trunc i8 %282 to i1
  br i1 %283, label %322, label %284

284:                                              ; preds = %281
  %285 = load i8, i8* @just_group, align 1
  %286 = trunc i8 %285 to i1
  br i1 %286, label %293, label %287

287:                                              ; preds = %284
  %288 = load i8, i8* @just_group_list, align 1
  %289 = trunc i8 %288 to i1
  br i1 %289, label %293, label %290

290:                                              ; preds = %287
  %291 = load i8, i8* @just_context, align 1
...
293:                                              ; preds = %290, %287, %284
  ...
  %295 = call i32 @getegid() #9
  store i32 %295, i32* @egid, align 4
  %296 = load i32, i32* @egid, align 4
  %297 = load i32, i32* %15, align 4
  %298 = icmp eq i32 %296, %297
  br i1 %298, label %299, label %307

299:                                              ; preds = %293
  %300 = call i32* @__errno_location() #14
...
303:                                              ; preds = %299
  ...
  %306 = call i8* @gettext(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %305, i8* %306)
  unreachable

307:                                              ; preds = %299, %293
  %308 = call i32* @__errno_location() #14
  store i32 0, i32* %308, align 4
  %309 = call i32 @getgid() #9
  store i32 %309, i32* @rgid, align 4
  %310 = load i32, i32* @rgid, align 4
...
317:                                              ; preds = %313
  ...
  %320 = call i8* @gettext(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %319, i8* %320)
  unreachable
...
322:                                              ; preds = %321, %290, %281
  ...
  call void @print_stuff(i8* %323)
  br label %324

324:                                              ; preds = %322, %220
  %325 = load i8, i8* @ok, align 1
  %326 = trunc i8 %325 to i1
  %327 = zext i1 %326 to i64
  %328 = select i1 %326, i32 0, i32 1
  ret i32 %328
}
