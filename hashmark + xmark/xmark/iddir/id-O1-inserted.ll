...
59:                                               ; preds = %55
  ...
  %62 = load i8*, i8** %61
  %controle = call i32 @controle(i8* %62, i32 0)
  store i32 %controle, i32* %collatzVar
  br label %63

63:                                               ; preds = %81, %77, %58, %59
...
81:                                               ; preds = %77
  ...
  br i1 %84, label %128, label %63

85:                                               ; preds = %63
  %86 = icmp ne i32 %27, 1
  %87 = zext i1 %86 to i8
  store i8 %87, i8* @multiple_users, align 1, !tbaa !13
  %88 = sext i32 %26 to i64
  %89 = add nsw i64 %28, %88
  %90 = load i32, i32* @optind, align 4, !tbaa !11
  %91 = sext i32 %90 to i64
  %92 = icmp ugt i64 %89, %91
  br i1 %92, label %93, label %177

93:                                               ; preds = %123, %85
  %94 = phi i64 [ %126, %123 ], [ %91, %85 ]
  %95 = getelementptr inbounds i8*, i8** %1, i64 %94
  %96 = load i8*, i8** %95, align 8, !tbaa !4
  %97 = load i8, i8* %96, align 1, !tbaa !15
  %98 = icmp eq i8 %97, 0
  br i1 %98, label %106, label %99

99:                                               ; preds = %93
  %100 = tail call i8* @parse_user_spec(i8* %96, i32* nonnull @euid, i32* null, i8** null, i8** null) #17
  %101 = icmp eq i8* %100, null
  br i1 %101, label %102, label %106

102:                                              ; preds = %99
  %103 = load i32, i32* @euid, align 4, !tbaa !11
  %104 = tail call %struct.passwd* @getpwuid(i32 %103) #17
  %105 = icmp eq %struct.passwd* %104, null
  br i1 %105, label %106, label %115

106:                                              ; preds = %102, %99, %93
  %107 = tail call i32* @__errno_location() #22
  %108 = load i32, i32* %107, align 4, !tbaa !11
  %109 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.22, i64 0, i64 0), i32 5) #17
  %110 = load i32, i32* @optind, align 4, !tbaa !11
  %111 = sext i32 %110 to i64
  %112 = getelementptr inbounds i8*, i8** %1, i64 %111
  %113 = load i8*, i8** %112, align 8, !tbaa !4
  %114 = tail call i8* @quote(i8* %113) #17
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %108, i8* %109, i8* %114) #17
  store i8 0, i8* @ok, align 1, !tbaa !13
  br label %123

115:                                              ; preds = %102
  %116 = getelementptr inbounds %struct.passwd, %struct.passwd* %104, i64 0, i32 0
  %117 = load i8*, i8** %116, align 8, !tbaa !16
  %118 = tail call noalias i8* @xstrdup(i8* %117) #17
  %119 = getelementptr inbounds %struct.passwd, %struct.passwd* %104, i64 0, i32 2
  %120 = load i32, i32* %119, align 8, !tbaa !18
  store i32 %120, i32* @euid, align 4, !tbaa !11
  store i32 %120, i32* @ruid, align 4, !tbaa !11
  %121 = getelementptr inbounds %struct.passwd, %struct.passwd* %104, i64 0, i32 3
  %122 = load i32, i32* %121, align 4, !tbaa !19
  store i32 %122, i32* @egid, align 4, !tbaa !11
  store i32 %122, i32* @rgid, align 4, !tbaa !11
  tail call fastcc void @print_stuff(i8* %118)
  tail call void @free(i8* %118) #17
  br label %123

123:                                              ; preds = %115, %106
  %124 = load i32, i32* @optind, align 4, !tbaa !11
  %125 = add nsw i32 %124, 1
  store i32 %125, i32* @optind, align 4, !tbaa !11
  %126 = sext i32 %125 to i64
  %127 = icmp ugt i64 %89, %126
  br i1 %127, label %93, label %177

128:                                              ; preds = %81
  br i1 %29, label %129, label %131

129:                                              ; preds = %128
  %130 = load i1, i1* @use_real, align 1
...
133:                                              ; preds = %131, %129
  %134 = tail call i32* @__errno_location() #22
  store i32 0, i32* %134, align 4, !tbaa !11
  %135 = tail call i32 @geteuid() #17
  store i32 %135, i32* @euid, align 4, !tbaa !11
  %136 = icmp eq i32 %135, -1
  br i1 %136, label %137, label %142

137:                                              ; preds = %133
  %138 = load i32, i32* %134, align 4, !tbaa !11
  %139 = icmp eq i32 %138, 0
  br i1 %139, label %142, label %140

140:                                              ; preds = %137
  %141 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.23, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %138, i8* %141) #17
  unreachable

142:                                              ; preds = %137, %133, %131, %129
  %143 = load i1, i1* @just_user, align 1
  br i1 %143, label %144, label %146

144:                                              ; preds = %142
  %145 = load i1, i1* @use_real, align 1
  br i1 %145, label %148, label %176

146:                                              ; preds = %142
  %147 = load i1, i1* @just_group, align 1
  br i1 %147, label %159, label %148

148:                                              ; preds = %146, %144
  %149 = tail call i32* @__errno_location() #22
  store i32 0, i32* %149, align 4, !tbaa !11
  %150 = tail call i32 @getuid() #17
  store i32 %150, i32* @ruid, align 4, !tbaa !11
  %151 = icmp eq i32 %150, -1
  br i1 %151, label %152, label %157

152:                                              ; preds = %148
  %153 = load i32, i32* %149, align 4, !tbaa !11
  %154 = icmp eq i32 %153, 0
  br i1 %154, label %157, label %155

155:                                              ; preds = %152
  %156 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %153, i8* %156) #17
  unreachable

157:                                              ; preds = %152, %148
  %158 = load i1, i1* @just_user, align 1
  br i1 %158, label %176, label %159

159:                                              ; preds = %157, %146
  %160 = tail call i32* @__errno_location() #22
  store i32 0, i32* %160, align 4, !tbaa !11
  %161 = tail call i32 @getegid() #17
  store i32 %161, i32* @egid, align 4, !tbaa !11
...
166:                                              ; preds = %163
  %167 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %164, i8* %167) #17
  unreachable

168:                                              ; preds = %163, %159
  store i32 0, i32* %160, align 4, !tbaa !11
  %169 = tail call i32 @getgid() #17
  store i32 %169, i32* @rgid, align 4, !tbaa !11
  %170 = icmp eq i32 %169, -1
  br i1 %170, label %171, label %176

171:                                              ; preds = %168
  %172 = load i32, i32* %160, align 4, !tbaa !11
  %173 = icmp eq i32 %172, 0
  br i1 %173, label %176, label %174

174:                                              ; preds = %171
  %175 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %172, i8* %175) #17
  unreachable

176:                                              ; preds = %171, %168, %157, %144
  tail call fastcc void @print_stuff(i8* null)
  br label %177

177:                                              ; preds = %176, %123, %85
  %178 = load i8, i8* @ok, align 1, !tbaa !13, !range !20
  %179 = xor i8 %178, 1
...
42:                                               ; preds = %38, %35
  %43 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.63, i64 0, i64 0), i32 5) #17
...
48:                                               ; preds = %42
  ...
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %47, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.64, i64 0, i64 0), i8* %49, i8* %43) #17
  br label %51

50:                                               ; preds = %42
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %47, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.65, i64 0, i64 0), i8* %43) #17
  br label %51
