; ModuleID = 'shadir/sha-Ofast-inserted.ll'
...
define dso_local i8* @sha_glibc_memset(i8* returned, i32, i32) local_unnamed_addr #2 {
  ...
  br i1 %5, label %7, label %._crit_edge86, !dbg !239
...
._crit_edge80.loopexit:                           ; preds = %.lr.ph79.7, %.lr.ph79.6, %.lr.ph79.5, %.lr.ph79.4, %.lr.ph79.3, %.lr.ph79.2, %.lr.ph79.1, %.lr.ph79.preheader
  %.lcssa98 = phi i64 [ %18, %.lr.ph79.preheader ], [ %148, %.lr.ph79.1 ], [ %152, %.lr.ph79.2 ], [ %156, %.lr.ph79.3 ], [ %160, %.lr.ph79.4 ], [ %164, %.lr.ph79.5 ], [ %168, %.lr.ph79.6 ], [ %172, %.lr.ph79.7 ], !dbg !256
...
._crit_edge80:                                    ; preds = %._crit_edge80.loopexit, %7
  ...
  %.047.lcssa = phi i64 [ %4, %7 ], [ %.lcssa98, %._crit_edge80.loopexit ], !dbg !232
...
.lr.ph71:                                         ; preds = %.preheader
  ...
  br i1 %49, label %.lr.ph71.split.us.preheader, label %.lr.ph71.split, !dbg !262

.lr.ph71.split.us.preheader:                      ; preds = %.lr.ph71
  %xtraiter = and i32 %.049.lcssa, 64, !dbg !262
  %lcmp.mod = icmp eq i32 %xtraiter, 0, !dbg !262
  br i1 %lcmp.mod, label %.lr.ph71.split.us.prol.loopexit, label %.lr.ph71.split.us.prol, !dbg !262

.lr.ph71.split.us.prol:                           ; preds = %.lr.ph71.split.us.preheader
  call void @llvm.dbg.value(metadata i32 %23, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %.047.lcssa, metadata !236, metadata !DIExpression()), !dbg !232
  %50 = inttoptr i64 %.047.lcssa to i64*, !dbg !263
  store i64 %14, i64* %50, align 8, !dbg !265
  %51 = getelementptr inbounds i64, i64* %50, i64 1, !dbg !266
  store i64 %14, i64* %51, align 8, !dbg !267
  %52 = getelementptr inbounds i64, i64* %50, i64 2, !dbg !268
  store i64 %14, i64* %52, align 8, !dbg !269
  %53 = getelementptr inbounds i64, i64* %50, i64 3, !dbg !270
  store i64 %14, i64* %53, align 8, !dbg !271
  %54 = getelementptr inbounds i64, i64* %50, i64 4, !dbg !272
  store i64 %14, i64* %54, align 8, !dbg !273
  %55 = getelementptr inbounds i64, i64* %50, i64 5, !dbg !274
  store i64 %14, i64* %55, align 8, !dbg !275
  %56 = getelementptr inbounds i64, i64* %50, i64 6, !dbg !276
  store i64 %14, i64* %56, align 8, !dbg !277
  %57 = getelementptr inbounds i64, i64* %50, i64 7, !dbg !278
  store i64 %14, i64* %57, align 8, !dbg !279
  call void @llvm.dbg.value(metadata i64 %.047.lcssa, metadata !236, metadata !DIExpression(DW_OP_plus_uconst, 64, DW_OP_stack_value)), !dbg !232
  %58 = add nsw i32 %23, -1, !dbg !280
  %59 = add i64 %.047.lcssa, 64, !dbg !281
  call void @llvm.dbg.value(metadata i32 %58, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %59, metadata !236, metadata !DIExpression()), !dbg !232
  br label %.lr.ph71.split.us.prol.loopexit, !dbg !262

.lr.ph71.split.us.prol.loopexit:                  ; preds = %.lr.ph71.split.us.preheader, %.lr.ph71.split.us.prol
  %.lcssa97.unr = phi i64 [ undef, %.lr.ph71.split.us.preheader ], [ %59, %.lr.ph71.split.us.prol ]
  %.070.us.unr = phi i32 [ %23, %.lr.ph71.split.us.preheader ], [ %58, %.lr.ph71.split.us.prol ]
  %.14869.us.unr = phi i64 [ %.047.lcssa, %.lr.ph71.split.us.preheader ], [ %59, %.lr.ph71.split.us.prol ]
  %60 = icmp eq i32 %23, 1, !dbg !262
  br i1 %60, label %._crit_edge72, label %.lr.ph71.split.us, !dbg !262

.lr.ph71.split.us:                                ; preds = %.lr.ph71.split.us.prol.loopexit, %.lr.ph71.split.us
  %.070.us = phi i32 [ %78, %.lr.ph71.split.us ], [ %.070.us.unr, %.lr.ph71.split.us.prol.loopexit ]
  %.14869.us = phi i64 [ %79, %.lr.ph71.split.us ], [ %.14869.us.unr, %.lr.ph71.split.us.prol.loopexit ]
  call void @llvm.dbg.value(metadata i32 %.070.us, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %.14869.us, metadata !236, metadata !DIExpression()), !dbg !232
  %61 = inttoptr i64 %.14869.us to i64*, !dbg !263
  ...
  call void @llvm.dbg.value(metadata i64 %.14869.us, metadata !236, metadata !DIExpression(DW_OP_plus_uconst, 64, DW_OP_stack_value)), !dbg !232
  %69 = add i64 %.14869.us, 64, !dbg !281
  call void @llvm.dbg.value(metadata i32 %.070.us, metadata !260, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %69, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 %.070.us, metadata !260, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %69, metadata !236, metadata !DIExpression()), !dbg !232
  %70 = inttoptr i64 %69 to i64*, !dbg !263
  store i64 %14, i64* %70, align 8, !dbg !265
  %71 = getelementptr inbounds i64, i64* %70, i64 1, !dbg !266
  store i64 %14, i64* %71, align 8, !dbg !267
  %72 = getelementptr inbounds i64, i64* %70, i64 2, !dbg !268
  store i64 %14, i64* %72, align 8, !dbg !269
  %73 = getelementptr inbounds i64, i64* %70, i64 3, !dbg !270
  store i64 %14, i64* %73, align 8, !dbg !271
  %74 = getelementptr inbounds i64, i64* %70, i64 4, !dbg !272
  store i64 %14, i64* %74, align 8, !dbg !273
  %75 = getelementptr inbounds i64, i64* %70, i64 5, !dbg !274
  store i64 %14, i64* %75, align 8, !dbg !275
  %76 = getelementptr inbounds i64, i64* %70, i64 6, !dbg !276
  store i64 %14, i64* %76, align 8, !dbg !277
  %77 = getelementptr inbounds i64, i64* %70, i64 7, !dbg !278
  store i64 %14, i64* %77, align 8, !dbg !279
  call void @llvm.dbg.value(metadata i64 %69, metadata !236, metadata !DIExpression(DW_OP_plus_uconst, 64, DW_OP_stack_value)), !dbg !232
  %78 = add nsw i32 %.070.us, -2, !dbg !280
  %79 = add i64 %.14869.us, 128, !dbg !281
  call void @llvm.dbg.value(metadata i32 %78, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %79, metadata !236, metadata !DIExpression()), !dbg !232
  %80 = icmp eq i32 %78, 0, !dbg !261
  br i1 %80, label %._crit_edge72, label %.lr.ph71.split.us, !dbg !262, !llvm.loop !282

.lr.ph74:                                         ; preds = %.lr.ph74.preheader, %thread-pre-split
  %81 = phi i32 [ %storemerge, %thread-pre-split ], [ %.ph, %.lr.ph74.preheader ]
  %82 = and i32 %81, 1
  %83 = icmp eq i32 %82, 0
  %84 = lshr i32 %81, 1
  %85 = mul i32 %81, 3
  %86 = add i32 %85, 1
  %storemerge = select i1 %83, i32 %84, i32 %86
  %87 = sub i32 %27, %storemerge
  %88 = icmp sgt i32 %87, 0
  %89 = add i32 %storemerge, %27
  %90 = icmp slt i32 %89, 4
  %or.cond = and i1 %88, %90
  br i1 %or.cond, label %.loopexit, label %thread-pre-split

.loopexit:                                        ; preds = %.lr.ph74, %.lr.ph, %122, %._crit_edge86, %.lr.ph71.split, %._crit_edge
  %merge = phi i8* [ null, %._crit_edge ], [ null, %.lr.ph71.split ], [ %0, %._crit_edge86 ], [ null, %.lr.ph ], [ %0, %122 ], [ null, %.lr.ph74 ]
  ret i8* %merge

.lr.ph71.split:                                   ; preds = %.lr.ph71
  call void @llvm.dbg.value(metadata i32 %23, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %.047.lcssa, metadata !236, metadata !DIExpression()), !dbg !232
  %91 = inttoptr i64 %.047.lcssa to i64*, !dbg !263
  store i64 %14, i64* %91, align 8, !dbg !265
  %92 = getelementptr inbounds i64, i64* %91, i64 1, !dbg !266
  store i64 %14, i64* %92, align 8, !dbg !267
  %93 = getelementptr inbounds i64, i64* %91, i64 2, !dbg !268
  store i64 %14, i64* %93, align 8, !dbg !269
  %94 = getelementptr inbounds i64, i64* %91, i64 3, !dbg !270
  store i64 %14, i64* %94, align 8, !dbg !271
  %95 = getelementptr inbounds i64, i64* %91, i64 4, !dbg !272
  store i64 %14, i64* %95, align 8, !dbg !273
  %96 = getelementptr inbounds i64, i64* %91, i64 5, !dbg !274
  store i64 %14, i64* %96, align 8, !dbg !275
  %97 = getelementptr inbounds i64, i64* %91, i64 6, !dbg !276
  store i64 %14, i64* %97, align 8, !dbg !277
  %98 = getelementptr inbounds i64, i64* %91, i64 7, !dbg !278
  store i64 %14, i64* %98, align 8, !dbg !279
  call void @llvm.dbg.value(metadata i64 %.047.lcssa, metadata !236, metadata !DIExpression(DW_OP_plus_uconst, 64, DW_OP_stack_value)), !dbg !232
  br label %.loopexit

._crit_edge72:                                    ; preds = %.lr.ph71.split.us.prol.loopexit, %.lr.ph71.split.us, %.preheader
  %.148.lcssa = phi i64 [ %.047.lcssa, %.preheader ], [ %.lcssa97.unr, %.lr.ph71.split.us.prol.loopexit ], [ %79, %.lr.ph71.split.us ], !dbg !232
  ...
  %99 = lshr i32 %.049.lcssa, 3, !dbg !284
  %100 = and i32 %99, 7, !dbg !284
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %.148.lcssa, metadata !236, metadata !DIExpression()), !dbg !232
  %101 = icmp eq i32 %100, 0, !dbg !285
  br i1 %101, label %._crit_edge, label %.lr.ph67, !dbg !286

.lr.ph67:                                         ; preds = %._crit_edge72
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression()), !dbg !243
  call void @llvm.dbg.value(metadata i64 %.148.lcssa, metadata !236, metadata !DIExpression()), !dbg !232
  %102 = inttoptr i64 %.148.lcssa to i64*, !dbg !287
  store i64 %14, i64* %102, align 8, !dbg !289
  %103 = add i64 %.148.lcssa, 8, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %103, metadata !236, metadata !DIExpression()), !dbg !232
  %104 = icmp eq i32 %100, 1, !dbg !285
  br i1 %104, label %._crit_edge, label %.lr.ph67.1, !dbg !286, !llvm.loop !291

._crit_edge:                                      ; preds = %.lr.ph67, %.lr.ph67.1, %.lr.ph67.2, %.lr.ph67.3, %.lr.ph67.4, %.lr.ph67.5, %.lr.ph67.6, %._crit_edge72
  %.2.lcssa = phi i64 [ %.148.lcssa, %._crit_edge72 ], [ %103, %.lr.ph67 ], [ %131, %.lr.ph67.1 ], [ %134, %.lr.ph67.2 ], [ %137, %.lr.ph67.3 ], [ %140, %.lr.ph67.4 ], [ %143, %.lr.ph67.5 ], [ %146, %.lr.ph67.6 ], !dbg !232
  call void @llvm.dbg.value(metadata i64 %.2.lcssa, metadata !236, metadata !DIExpression()), !dbg !232
  %105 = and i32 %.049.lcssa, 7, !dbg !293
  %106 = add nsw i32 %105, -4
  %107 = mul nuw nsw i32 %105, 3
  %108 = add nsw i32 %107, -4
  %109 = add nuw nsw i32 %105, 1
  %110 = mul nsw i32 %106, %106
  %111 = mul nsw i32 %110, %110
  %112 = mul nsw i32 %111, %110
  %113 = mul nsw i32 %108, %108
  %114 = mul nsw i32 %113, %113
  %115 = mul i32 %114, %113
  %116 = mul nuw nsw i32 %109, %109
  %117 = mul nuw nsw i32 %116, %116
  %118 = mul nuw nsw i32 %117, %116
  %119 = add nsw i32 %115, %112
  %120 = icmp eq i32 %119, %118
  br i1 %120, label %._crit_edge86, label %.loopexit

._crit_edge86:                                    ; preds = %3, %._crit_edge
  %.150 = phi i32 [ %105, %._crit_edge ], [ %2, %3 ]
  ...
  call void @llvm.dbg.value(metadata i64 %.3, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 %.150, metadata !234, metadata !DIExpression()), !dbg !232
  %121 = icmp eq i32 %.150, 0, !dbg !295
  br i1 %121, label %.loopexit, label %.lr.ph, !dbg !296

122:                                              ; preds = %.lr.ph
  %123 = add nsw i64 %.462, 1, !dbg !297
  call void @llvm.dbg.value(metadata i64 %123, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i64 %123, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 %126, metadata !234, metadata !DIExpression()), !dbg !232
  %124 = icmp eq i32 %126, 0, !dbg !295
  br i1 %124, label %.loopexit, label %.lr.ph, !dbg !296, !llvm.loop !299

.lr.ph:                                           ; preds = %._crit_edge86, %122
  %.462 = phi i64 [ %123, %122 ], [ %.3, %._crit_edge86 ]
  %.25161 = phi i32 [ %126, %122 ], [ %.150, %._crit_edge86 ]
  ...
  %125 = inttoptr i64 %.462 to i8*, !dbg !301
  store i8 %6, i8* %125, align 1, !dbg !302
  ...
  call void @llvm.dbg.value(metadata i64 %.462, metadata !236, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)), !dbg !232
  call void @llvm.dbg.value(metadata i32 %126, metadata !234, metadata !DIExpression()), !dbg !232
  br i1 %129, label %.loopexit, label %122

.lr.ph67.1:                                       ; preds = %.lr.ph67
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %103, metadata !236, metadata !DIExpression()), !dbg !232
  %130 = inttoptr i64 %103 to i64*, !dbg !287
  store i64 %14, i64* %130, align 8, !dbg !289
  %131 = add i64 %.148.lcssa, 16, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 2, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %131, metadata !236, metadata !DIExpression()), !dbg !232
  %132 = icmp eq i32 %100, 2, !dbg !285
  br i1 %132, label %._crit_edge, label %.lr.ph67.2, !dbg !286, !llvm.loop !291

.lr.ph67.2:                                       ; preds = %.lr.ph67.1
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 2, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %131, metadata !236, metadata !DIExpression()), !dbg !232
  %133 = inttoptr i64 %131 to i64*, !dbg !287
  store i64 %14, i64* %133, align 8, !dbg !289
  %134 = add i64 %.148.lcssa, 24, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 3, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %134, metadata !236, metadata !DIExpression()), !dbg !232
  %135 = icmp eq i32 %100, 3, !dbg !285
  br i1 %135, label %._crit_edge, label %.lr.ph67.3, !dbg !286, !llvm.loop !291

.lr.ph67.3:                                       ; preds = %.lr.ph67.2
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 3, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %134, metadata !236, metadata !DIExpression()), !dbg !232
  %136 = inttoptr i64 %134 to i64*, !dbg !287
  store i64 %14, i64* %136, align 8, !dbg !289
  %137 = add i64 %.148.lcssa, 32, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 4, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %137, metadata !236, metadata !DIExpression()), !dbg !232
  %138 = icmp eq i32 %100, 4, !dbg !285
  br i1 %138, label %._crit_edge, label %.lr.ph67.4, !dbg !286, !llvm.loop !291

.lr.ph67.4:                                       ; preds = %.lr.ph67.3
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 4, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %137, metadata !236, metadata !DIExpression()), !dbg !232
  %139 = inttoptr i64 %137 to i64*, !dbg !287
  store i64 %14, i64* %139, align 8, !dbg !289
  %140 = add i64 %.148.lcssa, 40, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 5, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %140, metadata !236, metadata !DIExpression()), !dbg !232
  %141 = icmp eq i32 %100, 5, !dbg !285
  br i1 %141, label %._crit_edge, label %.lr.ph67.5, !dbg !286, !llvm.loop !291

.lr.ph67.5:                                       ; preds = %.lr.ph67.4
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 5, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %140, metadata !236, metadata !DIExpression()), !dbg !232
  %142 = inttoptr i64 %140 to i64*, !dbg !287
  store i64 %14, i64* %142, align 8, !dbg !289
  %143 = add i64 %.148.lcssa, 48, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 6, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %143, metadata !236, metadata !DIExpression()), !dbg !232
  %144 = icmp eq i32 %100, 6, !dbg !285
  br i1 %144, label %._crit_edge, label %.lr.ph67.6, !dbg !286, !llvm.loop !291

.lr.ph67.6:                                       ; preds = %.lr.ph67.5
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 6, DW_OP_minus, DW_OP_stack_value)), !dbg !243
  call void @llvm.dbg.value(metadata i64 %143, metadata !236, metadata !DIExpression()), !dbg !232
  %145 = inttoptr i64 %143 to i64*, !dbg !287
  store i64 %14, i64* %145, align 8, !dbg !289
  %146 = add i64 %.148.lcssa, 56, !dbg !290
  call void @llvm.dbg.value(metadata i32 %100, metadata !260, metadata !DIExpression(DW_OP_constu, 6, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !243
...
.lr.ph79.1:                                       ; preds = %.lr.ph79.preheader
  call void @llvm.dbg.value(metadata i64 %18, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %147 = inttoptr i64 %18 to i8*, !dbg !303
  store i8 %6, i8* %147, align 1, !dbg !254
  %148 = add nsw i64 %4, 2, !dbg !256
  call void @llvm.dbg.value(metadata i64 %148, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %149 = and i64 %148, 7, !dbg !251
  %150 = icmp eq i64 %149, 0, !dbg !252
  br i1 %150, label %._crit_edge80.loopexit, label %.lr.ph79.2, !dbg !253, !llvm.loop !257

.lr.ph79.2:                                       ; preds = %.lr.ph79.1
  call void @llvm.dbg.value(metadata i64 %148, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %151 = inttoptr i64 %148 to i8*, !dbg !303
  store i8 %6, i8* %151, align 1, !dbg !254
  %152 = add nsw i64 %4, 3, !dbg !256
  call void @llvm.dbg.value(metadata i64 %152, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %153 = and i64 %152, 7, !dbg !251
  %154 = icmp eq i64 %153, 0, !dbg !252
  br i1 %154, label %._crit_edge80.loopexit, label %.lr.ph79.3, !dbg !253, !llvm.loop !257

.lr.ph79.3:                                       ; preds = %.lr.ph79.2
  call void @llvm.dbg.value(metadata i64 %152, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %155 = inttoptr i64 %152 to i8*, !dbg !303
  store i8 %6, i8* %155, align 1, !dbg !254
  %156 = add nsw i64 %4, 4, !dbg !256
  call void @llvm.dbg.value(metadata i64 %156, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %157 = and i64 %156, 7, !dbg !251
  %158 = icmp eq i64 %157, 0, !dbg !252
  br i1 %158, label %._crit_edge80.loopexit, label %.lr.ph79.4, !dbg !253, !llvm.loop !257

.lr.ph79.4:                                       ; preds = %.lr.ph79.3
  call void @llvm.dbg.value(metadata i64 %156, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %159 = inttoptr i64 %156 to i8*, !dbg !303
  store i8 %6, i8* %159, align 1, !dbg !254
  %160 = add nsw i64 %4, 5, !dbg !256
  call void @llvm.dbg.value(metadata i64 %160, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %161 = and i64 %160, 7, !dbg !251
  %162 = icmp eq i64 %161, 0, !dbg !252
  br i1 %162, label %._crit_edge80.loopexit, label %.lr.ph79.5, !dbg !253, !llvm.loop !257

.lr.ph79.5:                                       ; preds = %.lr.ph79.4
  call void @llvm.dbg.value(metadata i64 %160, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %163 = inttoptr i64 %160 to i8*, !dbg !303
  store i8 %6, i8* %163, align 1, !dbg !254
  %164 = add nsw i64 %4, 6, !dbg !256
  call void @llvm.dbg.value(metadata i64 %164, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %165 = and i64 %164, 7, !dbg !251
  %166 = icmp eq i64 %165, 0, !dbg !252
  br i1 %166, label %._crit_edge80.loopexit, label %.lr.ph79.6, !dbg !253, !llvm.loop !257

.lr.ph79.6:                                       ; preds = %.lr.ph79.5
  call void @llvm.dbg.value(metadata i64 %164, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %167 = inttoptr i64 %164 to i8*, !dbg !303
  store i8 %6, i8* %167, align 1, !dbg !254
  %168 = add nsw i64 %4, 7, !dbg !256
  call void @llvm.dbg.value(metadata i64 %168, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
  %169 = and i64 %168, 7, !dbg !251
  %170 = icmp eq i64 %169, 0, !dbg !252
  br i1 %170, label %._crit_edge80.loopexit, label %.lr.ph79.7, !dbg !253, !llvm.loop !257

.lr.ph79.7:                                       ; preds = %.lr.ph79.6
  call void @llvm.dbg.value(metadata i64 %168, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression()), !dbg !232
  %171 = inttoptr i64 %168 to i8*, !dbg !303
  store i8 %6, i8* %171, align 1, !dbg !254
  %172 = add nsw i64 %4, 8, !dbg !256
  call void @llvm.dbg.value(metadata i64 %172, metadata !236, metadata !DIExpression()), !dbg !232
  call void @llvm.dbg.value(metadata i32 undef, metadata !234, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !232
...
attributes #0 = { nofree norecurse nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { nounwind readnone speculatable }
attributes #2 = { nofree norecurse nounwind uwtable writeonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #3 = { nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
