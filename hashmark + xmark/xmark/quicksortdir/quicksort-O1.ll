...
12:                                               ; preds = %10
  %13 = tail call i32 @quicksort___isinff(float %1)
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %15, label %337

15:                                               ; preds = %12, %10
  %16 = icmp ugt i32 %5, 2139095040
...
23:                                               ; preds = %21
  %24 = icmp ugt i32 %6, 1266679807
  br i1 %24, label %36, label %25

25:                                               ; preds = %23
  %26 = icmp ugt i32 %6, 1065353215
  br i1 %26, label %27, label %36

27:                                               ; preds = %25
  %28 = lshr i32 %6, 23
  %29 = sub nuw nsw i32 150, %28
  %30 = lshr i32 %6, %29
  %31 = shl i32 %30, %29
  %32 = icmp eq i32 %31, %6
...
33:                                               ; preds = %27
  %34 = and i32 %30, 1
  %35 = sub nuw nsw i32 2, %34
  br label %36

36:                                               ; preds = %23, %27, %33, %25, %21
  %37 = phi i32 [ %35, %33 ], [ 0, %27 ], [ 0, %25 ], [ 0, %21 ], [ 2, %23 ]
  switch i32 %6, label %55 [
    i32 2139095040, label %38
    i32 1065353216, label %51
  ]

38:                                               ; preds = %36
  %39 = icmp eq i32 %5, 1065353216
...
42:                                               ; preds = %38
  %43 = icmp ugt i32 %5, 1065353216
  br i1 %43, label %44, label %47

44:                                               ; preds = %42
  %45 = icmp sgt i32 %4, -1
  %46 = select i1 %45, float %1, float 0.000000e+00
  br label %337

47:                                               ; preds = %42
  %48 = icmp slt i32 %4, 0
  %49 = fsub float -0.000000e+00, %1
...
53:                                               ; preds = %51
  %54 = fdiv float 1.000000e+00, %0
  br label %337

55:                                               ; preds = %36
  %56 = icmp eq i32 %4, 1073741824
...
59:                                               ; preds = %55
  %60 = icmp eq i32 %4, 1056964608
  %61 = icmp sgt i32 %3, -1
  %62 = and i1 %61, %60
  br i1 %62, label %63, label %65

63:                                               ; preds = %59
  %64 = tail call float @quicksort___ieee754_sqrtf(float %0)
  br label %337

65:                                               ; preds = %59
  %66 = tail call float @quicksort___fabsf(float %0)
  %67 = icmp eq i32 %5, 0
  %68 = or i32 %5, 1073741824
...
71:                                               ; preds = %65
  %72 = icmp slt i32 %4, 0
  %73 = fdiv float 1.000000e+00, %66
  %74 = select i1 %72, float %73, float %66
  br i1 %22, label %75, label %337

75:                                               ; preds = %71
  %76 = add nsw i32 %5, -1065353216
  %77 = or i32 %37, %76
  %78 = icmp eq i32 %77, 0
...
82:                                               ; preds = %75
  ...
  %85 = select i1 %83, float %84, float %74
  ret float %85
...
94:                                               ; preds = %86
  %95 = icmp ugt i32 %6, 1291845632
  br i1 %95, label %96, label %123

96:                                               ; preds = %94
  %97 = icmp ult i32 %5, 1065353208
  br i1 %97, label %98, label %101

98:                                               ; preds = %96
  %99 = icmp slt i32 %4, 0
  %100 = select i1 %99, float 0x7FF0000000000000, float 0.000000e+00
  br label %337

101:                                              ; preds = %96
  %102 = icmp ugt i32 %5, 1065353223
...
106:                                              ; preds = %101
  %107 = fadd float %0, -1.000000e+00
  %108 = fmul float %107, %107
  %109 = fmul float %107, 2.500000e-01
  %110 = fsub float 0x3FD5555560000000, %109
  %111 = fmul float %107, %110
  %112 = fsub float 5.000000e-01, %111
  %113 = fmul float %108, %112
  %114 = fmul float %107, 0x3FF7154000000000
  %115 = fmul float %107, 0x3EDD94AE00000000
  %116 = fmul float %113, 0x3FF7154760000000
...
123:                                              ; preds = %94
  %124 = icmp ult i32 %5, 8388608
  %125 = fmul float %66, 0x4170000000000000
  %126 = bitcast float %125 to i32
  %127 = select i1 %124, i32 %126, i32 %5
  %128 = ashr i32 %127, 23
  %129 = select i1 %124, i32 -151, i32 -127
  %130 = add nsw i32 %129, %128
  %131 = and i32 %127, 8388607
  %132 = or i32 %131, 1065353216
  %133 = icmp ult i32 %131, 1885298
  br i1 %133, label %139, label %134

134:                                              ; preds = %123
  %135 = icmp ult i32 %131, 6140887
  br i1 %135, label %139, label %136

136:                                              ; preds = %134
  %137 = add nsw i32 %130, 1
  %138 = add nsw i32 %132, -8388608
  br label %139

139:                                              ; preds = %134, %123, %136
  %140 = phi i32 [ %138, %136 ], [ %132, %123 ], [ %132, %134 ]
  %141 = phi i32 [ %137, %136 ], [ %130, %123 ], [ %130, %134 ]
  %142 = phi i32 [ 0, %136 ], [ 0, %123 ], [ 1, %134 ]
  %143 = bitcast i32 %140 to float
  %144 = zext i32 %142 to i64
  %145 = getelementptr inbounds [2 x float], [2 x float]* @quicksort_bp, i64 0, i64 %144
  %146 = load float, float* %145, align 4, !tbaa !2
  ...
  %154 = ashr i32 %140, 1
  %155 = or i32 %154, 536870912
  %156 = add nsw i32 %155, 262144
  %157 = shl nuw nsw i32 %142, 21
  %158 = add nsw i32 %156, %157
  %159 = bitcast i32 %158 to float
  %160 = fsub float %159, %146
  %161 = fsub float %143, %160
  %162 = fmul float %159, %153
  %163 = fsub float %147, %162
  %164 = fmul float %161, %153
  %165 = fsub float %163, %164
  %166 = fmul float %149, %165
  %167 = fmul float %150, %150
  %168 = fmul float %167, %167
  %169 = fmul float %167, 0x3FCA7E2840000000
  %170 = fadd float %169, 0x3FCD864AA0000000
  %171 = fmul float %167, %170
  %172 = fadd float %171, 0x3FD17460A0000000
  %173 = fmul float %167, %172
  %174 = fadd float %173, 0x3FD5555560000000
  %175 = fmul float %167, %174
  %176 = fadd float %175, 0x3FDB6DB6E0000000
  %177 = fmul float %167, %176
  %178 = fadd float %177, 0x3FE3333340000000
  %179 = fmul float %168, %178
  %180 = fadd float %150, %153
  %181 = fmul float %180, %166
  %182 = fadd float %181, %179
  %183 = fmul float %153, %153
  %184 = fadd float %183, 3.000000e+00
  ...
  %191 = fsub float %182, %190
  %192 = fmul float %153, %188
  %193 = fmul float %166, %188
  %194 = fmul float %150, %191
  ...
  %202 = fmul float %199, 0x3FEEC70000000000
  %203 = fmul float %199, 0x3ED3B87400000000
  %204 = fmul float %201, 0x3FEEC709E0000000
  %205 = fadd float %203, %204
  %206 = getelementptr inbounds [2 x float], [2 x float]* @quicksort_dp_l, i64 0, i64 %144
  %207 = load float, float* %206, align 4, !tbaa !2
  %208 = fadd float %207, %205
  %209 = sitofp i32 %141 to float
  %210 = fadd float %202, %208
  %211 = getelementptr inbounds [2 x float], [2 x float]* @quicksort_dp_h, i64 0, i64 %144
  ...
  %218 = fsub float %217, %209
  %219 = fsub float %218, %212
  %220 = fsub float %219, %202
  br label %221

221:                                              ; preds = %139, %106
  %222 = phi float [ %220, %139 ], [ %122, %106 ]
  %223 = phi float [ %208, %139 ], [ %117, %106 ]
  %224 = phi float [ %217, %139 ], [ %121, %106 ]
  %225 = fsub float %223, %222
  %226 = add nsw i32 %37, -1
  %227 = or i32 %226, %88
  %228 = icmp eq i32 %227, 0
  %229 = select i1 %228, float -1.000000e+00, float 1.000000e+00
  %230 = and i32 %4, -4096
  %231 = bitcast i32 %230 to float
  %232 = fsub float %1, %231
  %233 = fmul float %232, %224
  %234 = fmul float %225, %1
  %235 = fadd float %234, %233
  %236 = fmul float %224, %231
  %237 = fadd float %236, %235
  %238 = bitcast float %237 to i32
  %239 = icmp sgt i32 %238, 1124073472
  br i1 %239, label %240, label %243

240:                                              ; preds = %221
  %241 = fmul float %229, 0x46293E5940000000
  %242 = fmul float %241, 0x46293E5940000000
  br label %337

243:                                              ; preds = %221
  %244 = icmp eq i32 %238, 1124073472
  br i1 %244, label %245, label %254

245:                                              ; preds = %243
  %246 = fadd float %235, 0x3E67154780000000
  %247 = fsub float %237, %236
  %248 = fcmp ogt float %246, %247
  br i1 %248, label %251, label %249

249:                                              ; preds = %245
  %250 = and i32 %238, 2147483647
  br label %271

251:                                              ; preds = %245
  %252 = fmul float %229, 0x46293E5940000000
  %253 = fmul float %252, 0x46293E5940000000
  br label %337

254:                                              ; preds = %243
  %255 = and i32 %238, 2147483647
  %256 = icmp ugt i32 %255, 1125515264
  br i1 %256, label %257, label %260

257:                                              ; preds = %254
  %258 = fmul float %229, 0x39B4484C00000000
  %259 = fmul float %258, 0x39B4484C00000000
  br label %337

260:                                              ; preds = %254
  %261 = icmp ne i32 %238, -1021968384
  %262 = fsub float %237, %236
  %263 = fcmp ugt float %235, %262
  %264 = or i1 %261, %263
  br i1 %264, label %268, label %265

265:                                              ; preds = %260
  %266 = fmul float %229, 0x39B4484C00000000
  %267 = fmul float %266, 0x39B4484C00000000
  br label %337

268:                                              ; preds = %260
  %269 = and i32 %238, 2147483647
  %270 = icmp ugt i32 %269, 1056964608
  br i1 %270, label %271, label %291

271:                                              ; preds = %249, %268
  %272 = phi i32 [ %250, %249 ], [ %269, %268 ]
  %273 = lshr i32 %272, 23
  %274 = add nsw i32 %273, -126
  %275 = lshr i32 8388608, %274
  %276 = add nsw i32 %275, %238
  %277 = lshr i32 %276, 23
  %278 = and i32 %277, 255
  %279 = add nsw i32 %278, -127
  %280 = ashr i32 -8388608, %279
  %281 = and i32 %280, %276
  %282 = bitcast i32 %281 to float
  %283 = and i32 %276, 8388607
  %284 = or i32 %283, 8388608
  %285 = sub nsw i32 150, %278
  %286 = lshr i32 %284, %285
  %287 = icmp slt i32 %238, 0
  %288 = sub nsw i32 0, %286
  %289 = select i1 %287, i32 %288, i32 %286
  %290 = fsub float %236, %282
  br label %291

291:                                              ; preds = %271, %268
  %292 = phi i32 [ %289, %271 ], [ 0, %268 ]
  %293 = phi float [ %290, %271 ], [ %236, %268 ]
  %294 = fadd float %235, %293
  %295 = bitcast float %294 to i32
  %296 = and i32 %295, -4096
  %297 = bitcast i32 %296 to float
  %298 = fmul float %297, 0x3FE62E4000000000
  %299 = fsub float %297, %293
  %300 = fsub float %235, %299
  %301 = fmul float %300, 0x3FE62E4300000000
  %302 = fmul float %297, 0x3EB7F7D180000000
  %303 = fadd float %302, %301
  %304 = fadd float %298, %303
  %305 = fsub float %304, %298
  %306 = fsub float %303, %305
  %307 = fmul float %304, %304
  %308 = fmul float %307, 0x3E66376980000000
  %309 = fadd float %308, 0xBEBBBD41C0000000
  %310 = fmul float %307, %309
  %311 = fadd float %310, 0x3F11566AA0000000
  %312 = fmul float %307, %311
  %313 = fadd float %312, 0xBF66C16C20000000
  %314 = fmul float %307, %313
  %315 = fadd float %314, 0x3FC5555560000000
  %316 = fmul float %307, %315
  %317 = fsub float %304, %316
  %318 = fmul float %304, %317
  %319 = fadd float %317, -2.000000e+00
  %320 = fdiv float %318, %319
  %321 = fmul float %304, %306
  %322 = fadd float %306, %321
  %323 = fsub float %320, %322
  %324 = fsub float %304, %323
  %325 = fadd float %324, 1.000000e+00
  %326 = bitcast float %325 to i32
  %327 = shl i32 %292, 23
  %328 = add nsw i32 %327, %326
  %329 = icmp slt i32 %328, 8388608
  br i1 %329, label %330, label %332

330:                                              ; preds = %291
  %331 = tail call float @quicksort___scalbnf(float %325, i32 %292)
  br label %334

332:                                              ; preds = %291
  %333 = bitcast i32 %328 to float
  br label %334

334:                                              ; preds = %332, %330
  %335 = phi float [ %331, %330 ], [ %333, %332 ]
  %336 = fmul float %229, %335
  br label %337

337:                                              ; preds = %71, %79, %51, %12, %2, %334, %265, %257, %251, %240, %103, %98, %91, %63, %57, %53, %47, %44, %40, %19
  %338 = phi float [ %20, %19 ], [ %41, %40 ], [ %46, %44 ], [ %50, %47 ], [ %54, %53 ], [ %58, %57 ], [ %64, %63 ], [ %93, %91 ], [ %100, %98 ], [ %105, %103 ], [ %242, %240 ], [ %253, %251 ], [ %336, %334 ], [ %259, %257 ], [ %267, %265 ], [ 1.000000e+00, %2 ], [ 1.000000e+00, %12 ], [ %0, %51 ], [ %81, %79 ], [ %74, %71 ]
  ret float %338
}
...
42:                                               ; preds = %34, %54
  %43 = phi i32 [ %41, %34 ], [ %57, %54 ]
  %44 = phi i32 [ 16777216, %34 ], [ %58, %54 ]
  %45 = phi i32 [ 0, %34 ], [ %56, %54 ]
  %46 = phi i32 [ 0, %34 ], [ %55, %54 ]
  %47 = shl nsw i32 %43, 1
  %48 = add i32 %44, %46
