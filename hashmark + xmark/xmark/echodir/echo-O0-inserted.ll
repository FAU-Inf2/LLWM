...
76:                                               ; preds = %72
  ...
  %80 = call i32 @strcmp(i8* %79, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i64 0, i64 0)) #12
  br label %81
...
86:                                               ; preds = %82
  ...
  %89 = load i8*, i8** %88
  %90 = add i32 0, -1
  %controle2 = call i32 @controle(i8* %89, i32 %90)
  store i32 %controle2, i32* %collatzVar1
  br label %91

91:                                               ; preds = %109, %105, %85, %86
...
114:                                              ; preds = %91
  ...
  %118 = call i32 @strcmp(i8* %117, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.18, i64 0, i64 0)) #12
  br label %119
...
124:                                              ; preds = %120
  ...
  %127 = load i8*, i8** %126
  %controle = call i32 @controle(i8* %127, i32 0)
  store i32 %controle, i32* %collatzVar
  br label %128

128:                                              ; preds = %146, %142, %123, %124
...
150:                                              ; preds = %146
  ...
  %152 = load i8*, i8** @Version, align 8
  call void (%struct._IO_FILE*, i8*, i8*, i8*, ...) @version_etc(%struct._IO_FILE* %151, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.11, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.19, i64 0, i64 0), i8* %152, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.20, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.21, i64 0, i64 0), i8* null)
  store i32 0, i32* %3, align 4
  br label %415
...
296:                                              ; preds = %278
  ...
  %303 = call i32 @hextobin(i8 zeroext %302)
...
371:                                              ; preds = %370, %250
  %372 = call i32 @putchar_unlocked(i32 92)
  br label %373
...
374:                                              ; preds = %373, %245, %241
  ...
  %377 = call i32 @putchar_unlocked(i32 %376)
  br label %236
...
385:                                              ; preds = %378
  %386 = call i32 @putchar_unlocked(i32 32)
  br label %387
...
393:                                              ; preds = %390
  ...
  %398 = call i32 @fputs_unlocked(i8* %396, %struct._IO_FILE* %397)
...
405:                                              ; preds = %393
  %406 = call i32 @putchar_unlocked(i32 32)
  br label %407
...
412:                                              ; preds = %409
  %413 = call i32 @putchar_unlocked(i32 10)
  br label %414
...
9:                                                ; preds = %2
  %10 = getelementptr inbounds [2 x i8], [2 x i8]* @.compVal1, i32 0, i32 0
