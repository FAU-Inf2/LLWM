...
define internal void @emit_ancillary_info() unnamed_addr #5 {
  %2 = alloca i8*, align 8
...
298:                                              ; preds = %284
  ...
  %301 = call i16** @__ctype_b_loc() #15, !dbg !407
...
312:                                              ; preds = %298
  ...
  %320 = call i16** @__ctype_b_loc() #15, !dbg !418
...
28:                                               ; preds = %20
  ...
  %31 = call i32 @strncmp(i8* %30, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1.48, i64 0, i64 0), i64 7) #13, !dbg !610
...
33:                                               ; preds = %28
  ...
  %36 = call i32 @strncmp(i8* %35, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.49, i64 0, i64 0), i64 3) #13, !dbg !618
...
; Function Attrs: nounwind uwtable
define internal i8* @quotearg_n_options(i32, i8*, i64, %struct.quoting_options*) unnamed_addr #8 {
...
145:                                              ; preds = %119, %69
  ...
  %147 = call i32* @__errno_location() #15, !dbg !841
...
; Function Attrs: nounwind uwtable
define internal i64 @quotearg_buffer_restyled(i8*, i64, i8*, i64, i32, i32, i32* readonly, i8* readonly, i8* readonly) unnamed_addr #8 {
...
107:                                              ; preds = %106, %79
  ...
  %110 = call i64 @strlen(i8* %109) #13, !dbg !956
...
176:                                              ; preds = %173
  ...
  %178 = call i64 @strlen(i8* %177) #13, !dbg !1026
...
184:                                              ; preds = %181
  ...
  %190 = call i32 @memcmp(i8* %187, i8* %188, i64 %189) #13, !dbg !1036
...
547:                                              ; preds = %544
  ...
  %548 = call i16** @__ctype_b_loc() #15, !dbg !1312
...
563:                                              ; preds = %559
  ...
  %565 = call i64 @strlen(i8* %564) #13, !dbg !1342
...
651:                                              ; preds = %650
  %652 = call i32 @mbsinit(%struct.__mbstate_t* %38) #13, !dbg !1438
...
; Function Attrs: nounwind uwtable
define internal i8* @xrealloc(i8*, i64) #8 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i64, align 8
  store i8* %0, i8** %4, align 8
...
; Function Attrs: nounwind
declare dso_local i8* @realloc(i8* nocapture, i64) local_unnamed_addr #2
