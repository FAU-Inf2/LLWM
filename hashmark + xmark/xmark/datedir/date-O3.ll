...
152:                                              ; preds = %148
  ...
  %156 = tail call i32 @strcmp(i8* nonnull %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.80, i64 0, i64 0)) #18
...
164:                                              ; preds = %161
  %165 = tail call i32* @__errno_location() #21
...
207:                                              ; preds = %203
  %208 = tail call i32* @__errno_location() #21
...
225:                                              ; preds = %222
  %226 = tail call i32* @__errno_location() #21
...
254:                                              ; preds = %251
  %255 = tail call i32* @__errno_location() #21
