; ModuleID = 'dijkstradir/dijkstra-Oz-inserted.ll'
...
.loopexit22:                                      ; preds = %7, %29, %50, %70, %110, %104, %98, %92, %86, %80
...
thread-pre-split:                                 ; preds = %29, %19
  %27 = phi i32 [ %controle6, %19 ], [ %storemerge8, %29 ]
...
39:                                               ; preds = %116, %.loopexit22
  ret void, !dbg !286

40:                                               ; preds = %thread-pre-split
  %41 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 21, i32 0), align 8, !dbg !283, !tbaa !181
  %42 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %43 = add nsw i32 %42, %41, !dbg !284
  store i32 %43, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 2, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 22, metadata !273, metadata !DIExpression()), !dbg !274
  %44 = tail call i32 @dijkstra_find(i32 2, i32 22), !dbg !275
  %45 = load i8**, i8*** @inVal1, align 8
  %46 = getelementptr inbounds i8*, i8** %45, i64 1
  %47 = load i8*, i8** %46, align 8
  %controle = tail call fastcc i32 @controle(i8* %47, i32 -1) #6
  br label %thread-pre-split16

thread-pre-split16:                               ; preds = %50, %40
  %48 = phi i32 [ %controle, %40 ], [ %storemerge7, %50 ]
  %49 = icmp sgt i32 %48, 1
  br i1 %49, label %50, label %60

50:                                               ; preds = %thread-pre-split16
  %51 = and i32 %48, 1
  %52 = icmp eq i32 %51, 0
  %53 = lshr i32 %48, 1
  %54 = mul i32 %48, 3
  %55 = add i32 %54, 1
  %storemerge7 = select i1 %52, i32 %53, i32 %55
  %56 = sub i32 %44, %storemerge7
  %57 = icmp sgt i32 %56, -3
  %58 = add i32 %storemerge7, %44
  %59 = icmp slt i32 %58, 1
  %or.cond13 = and i1 %57, %59
  br i1 %or.cond13, label %.loopexit22, label %thread-pre-split16

60:                                               ; preds = %thread-pre-split16
  %61 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 22, i32 0), align 16, !dbg !283, !tbaa !181
  %62 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %63 = add nsw i32 %62, %61, !dbg !284
  store i32 %63, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 3, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 23, metadata !273, metadata !DIExpression()), !dbg !274
  %64 = tail call i32 @dijkstra_find(i32 3, i32 23), !dbg !275
  %65 = load i8**, i8*** @inVal1, align 8
  %66 = getelementptr inbounds i8*, i8** %65, i64 1
  %67 = load i8*, i8** %66, align 8
  %controle4 = tail call fastcc i32 @controle(i8* %67, i32 4) #6
  br label %thread-pre-split18

thread-pre-split18:                               ; preds = %70, %60
  %68 = phi i32 [ %controle4, %60 ], [ %storemerge, %70 ]
  %69 = icmp sgt i32 %68, 1
  br i1 %69, label %70, label %80

70:                                               ; preds = %thread-pre-split18
  %71 = and i32 %68, 1
  %72 = icmp eq i32 %71, 0
  %73 = lshr i32 %68, 1
  %74 = mul i32 %68, 3
  ...
  %76 = sub i32 %64, %storemerge
  %77 = icmp sgt i32 %76, -3
  %78 = add i32 %storemerge, %64
  %79 = icmp slt i32 %78, 1
  %or.cond15 = and i1 %77, %79
  br i1 %or.cond15, label %.loopexit22, label %thread-pre-split18

80:                                               ; preds = %thread-pre-split18
  %81 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 23, i32 0), align 8, !dbg !283, !tbaa !181
  %82 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %83 = add nsw i32 %82, %81, !dbg !284
  store i32 %83, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 4, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 24, metadata !273, metadata !DIExpression()), !dbg !274
  %84 = tail call i32 @dijkstra_find(i32 4, i32 24), !dbg !275
  %85 = icmp eq i32 %84, -1, !dbg !287
  br i1 %85, label %.loopexit22, label %86, !dbg !288

86:                                               ; preds = %80
  %87 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 24, i32 0), align 16, !dbg !283, !tbaa !181
  %88 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %89 = add nsw i32 %88, %87, !dbg !284
  store i32 %89, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 5, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 25, metadata !273, metadata !DIExpression()), !dbg !274
  %90 = tail call i32 @dijkstra_find(i32 5, i32 25), !dbg !275
  %91 = icmp eq i32 %90, -1, !dbg !287
  br i1 %91, label %.loopexit22, label %92, !dbg !288

92:                                               ; preds = %86
  %93 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 25, i32 0), align 8, !dbg !283, !tbaa !181
  %94 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %95 = add nsw i32 %94, %93, !dbg !284
  store i32 %95, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 6, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 26, metadata !273, metadata !DIExpression()), !dbg !274
  %96 = tail call i32 @dijkstra_find(i32 6, i32 26), !dbg !275
  %97 = icmp eq i32 %96, -1, !dbg !287
  br i1 %97, label %.loopexit22, label %98, !dbg !288

98:                                               ; preds = %92
  %99 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 26, i32 0), align 16, !dbg !283, !tbaa !181
  %100 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %101 = add nsw i32 %100, %99, !dbg !284
  store i32 %101, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 7, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 27, metadata !273, metadata !DIExpression()), !dbg !274
  %102 = tail call i32 @dijkstra_find(i32 7, i32 27), !dbg !275
  %103 = icmp eq i32 %102, -1, !dbg !287
  br i1 %103, label %.loopexit22, label %104, !dbg !288

104:                                              ; preds = %98
  %105 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 27, i32 0), align 8, !dbg !283, !tbaa !181
  %106 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %107 = add nsw i32 %106, %105, !dbg !284
  store i32 %107, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 8, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 28, metadata !273, metadata !DIExpression()), !dbg !274
  %108 = tail call i32 @dijkstra_find(i32 8, i32 28), !dbg !275
  %109 = icmp eq i32 %108, -1, !dbg !287
  br i1 %109, label %.loopexit22, label %110, !dbg !288

110:                                              ; preds = %104
  %111 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 28, i32 0), align 16, !dbg !283, !tbaa !181
  %112 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %113 = add nsw i32 %112, %111, !dbg !284
  store i32 %113, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
  ...
  call void @llvm.dbg.value(metadata i32 9, metadata !270, metadata !DIExpression()), !dbg !274
  call void @llvm.dbg.value(metadata i32 29, metadata !273, metadata !DIExpression()), !dbg !274
  %114 = tail call i32 @dijkstra_find(i32 9, i32 29), !dbg !275
  %115 = icmp eq i32 %114, -1, !dbg !287
  br i1 %115, label %.loopexit22, label %116, !dbg !288

116:                                              ; preds = %110
  %117 = load i32, i32* getelementptr inbounds ([40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 29, i32 0), align 8, !dbg !283, !tbaa !181
  %118 = load i32, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  %119 = add nsw i32 %118, %117, !dbg !284
  store i32 %119, i32* @dijkstra_checksum, align 4, !dbg !284, !tbaa !55
  store i32 0, i32* @dijkstra_queueNext, align 4, !dbg !285, !tbaa !55
...
attributes #4 = { minsize nofree norecurse nounwind optsize uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
