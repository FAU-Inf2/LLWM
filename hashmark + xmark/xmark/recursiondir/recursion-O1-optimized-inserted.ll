; ModuleID = 'recursiondir/recursion-O1-inserted.ll'
...
.preheader13:                                     ; preds = %13
  ...
  %controle = tail call fastcc i32 @controle(i8* %18, i32 0) #7
...
.preheader:                                       ; preds = %._crit_edge18
  ...
  %controle2 = tail call fastcc i32 @controle(i8* %35, i32 1) #7
