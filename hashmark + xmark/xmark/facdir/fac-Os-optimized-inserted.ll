; ModuleID = 'facdir/fac-Os-inserted.ll'
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %controle2 = tail call fastcc i32 @controle(i8* %4, i32 -4) #5
  br label %5
...
.preheader30:                                     ; preds = %17, %156
  ...
  %controle6 = tail call fastcc i32 @controle(i8* %28, i32 -1) #5
...
.loopexit:                                        ; preds = %.loopexit.backedge, %.loopexit.preheader
  ...
  %controle = tail call fastcc i32 @controle(i8* %116, i32 -3) #5
...
129:                                              ; preds = %.lr.ph45
  ...
  %controle4 = tail call fastcc i32 @controle(i8* %132, i32 0) #5
