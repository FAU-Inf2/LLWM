; ModuleID = 'primedir/prime-O2-inserted.ll'
...
8:                                                ; preds = %2
  ...
  tail call void @prime_init(), !dbg !136
  tail call void @prime_swap(i32* nonnull @prime_x, i32* nonnull @prime_y) #7, !dbg !137
  %9 = load i32, i32* @prime_x, align 4, !dbg !139
  %10 = tail call zeroext i8 @prime_prime(i32 %9) #7, !dbg !140
  %11 = icmp eq i8 %10, 0, !dbg !140
  br i1 %11, label %12, label %prime_main.exit, !dbg !141

12:                                               ; preds = %8
  %13 = load i32, i32* @prime_y, align 4, !dbg !142
  %14 = tail call zeroext i8 @prime_prime(i32 %13) #7, !dbg !143
  %15 = icmp ne i8 %14, 0, !dbg !144
  %phitmp.i = zext i1 %15 to i32, !dbg !145
  br label %prime_main.exit, !dbg !145

prime_main.exit:                                  ; preds = %8, %12
  %16 = phi i32 [ 1, %8 ], [ %phitmp.i, %12 ], !dbg !145
  store i32 %16, i32* @prime_result, align 4, !dbg !146
  ret i32 %16, !dbg !147
}
...
!136 = !DILocation(line: 133, column: 3, scope: !128)
!137 = !DILocation(line: 125, column: 3, scope: !118, inlinedAt: !138)
!138 = distinct !DILocation(line: 134, column: 3, scope: !128)
!139 = !DILocation(line: 127, column: 35, scope: !118, inlinedAt: !138)
!140 = !DILocation(line: 127, column: 22, scope: !118, inlinedAt: !138)
!141 = !DILocation(line: 127, column: 45, scope: !118, inlinedAt: !138)
!142 = !DILocation(line: 127, column: 62, scope: !118, inlinedAt: !138)
!143 = !DILocation(line: 127, column: 49, scope: !118, inlinedAt: !138)
!144 = !DILocation(line: 127, column: 48, scope: !118, inlinedAt: !138)
!145 = !DILocation(line: 134, column: 3, scope: !128)
!146 = !DILocation(line: 127, column: 16, scope: !118, inlinedAt: !138)
!147 = !DILocation(line: 136, column: 3, scope: !128)
