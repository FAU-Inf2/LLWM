; ModuleID = 'primedir/prime-Os-inserted.ll'
...
18:                                               ; preds = %8
  call void @llvm.dbg.value(metadata i32 %0, metadata !58, metadata !DIExpression()) #5, !dbg !68
  %19 = tail call zeroext i8 @prime_divides(i32 2, i32 %0) #5, !dbg !71
  %20 = icmp eq i8 %19, 0, !dbg !72
  br i1 %20, label %23, label %21, !dbg !73

21:                                               ; preds = %18
  %22 = icmp eq i32 %0, 2, !dbg !74
  br label %49, !dbg !75

23:                                               ; preds = %18
  call void @llvm.dbg.value(metadata i32 3, metadata !76, metadata !DIExpression()), !dbg !67
  call void @llvm.dbg.value(metadata i32 3, metadata !76, metadata !DIExpression()), !dbg !67
  %24 = add i32 %2, 2
  %25 = shl i32 %24, 1
  %26 = mul i32 %25, %24
...
._crit_edge:                                      ; preds = %thread-pre-split, %23
  %43 = icmp ugt i32 %0, 8, !dbg !77
  br i1 %43, label %44, label %47, !dbg !80

44:                                               ; preds = %._crit_edge
  %45 = tail call zeroext i8 @prime_divides(i32 3, i32 %0), !dbg !81
  %46 = icmp eq i8 %45, 0, !dbg !81
  br i1 %46, label %.loopexit20, label %49, !dbg !84

47:                                               ; preds = %._crit_edge
  %48 = icmp ugt i32 %0, 1, !dbg !85
  br label %49, !dbg !86
...
define dso_local void @prime_swap(i32* nocapture, i32* nocapture) local_unnamed_addr #0 {
  ...
  %3 = load i32, i32* %0, align 4, !dbg !95
...
29:                                               ; preds = %16
  %30 = load i32, i32* %1, align 4, !dbg !97
  store i32 %30, i32* %0, align 4, !dbg !98
  store i32 %3, i32* %1, align 4, !dbg !99
  ret void, !dbg !100
}

; Function Attrs: nofree norecurse nounwind optsize uwtable
define dso_local void @prime_main() local_unnamed_addr #0 {
  tail call void @prime_swap(i32* nonnull @prime_x, i32* nonnull @prime_y), !dbg !101
  %1 = load i32, i32* @prime_x, align 4, !dbg !103
  %2 = tail call zeroext i8 @prime_prime(i32 %1), !dbg !104
  %3 = icmp eq i8 %2, 0, !dbg !104
  br i1 %3, label %4, label %8, !dbg !105

4:                                                ; preds = %0
  %5 = load i32, i32* @prime_y, align 4, !dbg !106
  %6 = tail call zeroext i8 @prime_prime(i32 %5), !dbg !107
  %7 = icmp ne i8 %6, 0, !dbg !108
  %phitmp = zext i1 %7 to i32
  br label %8

8:                                                ; preds = %0, %4
  %9 = phi i32 [ 1, %0 ], [ %phitmp, %4 ]
  store i32 %9, i32* @prime_result, align 4, !dbg !109
  ret void, !dbg !110
}
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  call void @llvm.dbg.value(metadata i32 %0, metadata !111, metadata !DIExpression()), !dbg !118
  %3 = mul i32 %0, 5
  %4 = add i32 %3, 3
  %5 = mul i32 %4, %4
...
8:                                                ; preds = %2
  ...
  store volatile i32 0, i32* @prime_seed, align 4, !dbg !120
  %9 = tail call i32 @prime_randomInteger() #5, !dbg !123
  store i32 %9, i32* @prime_x, align 4, !dbg !124
  %10 = tail call i32 @prime_randomInteger() #5, !dbg !125
  store i32 %10, i32* @prime_y, align 4, !dbg !126
  tail call void @prime_main(), !dbg !127
  %11 = load i32, i32* @prime_result, align 4, !dbg !128
  ret i32 %11, !dbg !130
}
...
!68 = !DILocation(line: 0, scope: !59, inlinedAt: !69)
!69 = distinct !DILocation(line: 100, column: 8, scope: !70)
!70 = distinct !DILexicalBlock(scope: !66, file: !8, line: 100, column: 8)
!71 = !DILocation(line: 93, column: 12, scope: !59, inlinedAt: !69)
!72 = !DILocation(line: 100, column: 8, scope: !70)
!73 = !DILocation(line: 100, column: 8, scope: !66)
!74 = !DILocation(line: 101, column: 16, scope: !70)
!75 = !DILocation(line: 101, column: 5, scope: !70)
!76 = !DILocalVariable(name: "i", scope: !66, file: !8, line: 99, type: !9)
!77 = !DILocation(line: 103, column: 22, scope: !78)
!78 = distinct !DILexicalBlock(scope: !79, file: !8, line: 103, column: 3)
!79 = distinct !DILexicalBlock(scope: !66, file: !8, line: 103, column: 3)
!80 = !DILocation(line: 103, column: 3, scope: !79)
!81 = !DILocation(line: 104, column: 10, scope: !82)
!82 = distinct !DILexicalBlock(scope: !83, file: !8, line: 104, column: 10)
!83 = distinct !DILexicalBlock(scope: !78, file: !8, line: 103, column: 37)
!84 = !DILocation(line: 104, column: 10, scope: !83)
!85 = !DILocation(line: 107, column: 14, scope: !66)
!86 = !DILocation(line: 107, column: 3, scope: !66)
!87 = !DILocation(line: 108, column: 1, scope: !66)
!88 = !DILocalVariable(name: "a", arg: 1, scope: !89, file: !8, line: 111, type: !92)
!89 = distinct !DISubprogram(name: "prime_swap", scope: !8, file: !8, line: 111, type: !90, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!90 = !DISubroutineType(types: !91)
!91 = !{null, !92, !92}
!92 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !9, size: 64)
!93 = !DILocation(line: 0, scope: !89)
!94 = !DILocalVariable(name: "b", arg: 2, scope: !89, file: !8, line: 111, type: !92)
!95 = !DILocation(line: 113, column: 22, scope: !89)
!96 = !DILocalVariable(name: "tmp", scope: !89, file: !8, line: 113, type: !9)
!97 = !DILocation(line: 114, column: 8, scope: !89)
!98 = !DILocation(line: 114, column: 6, scope: !89)
!99 = !DILocation(line: 115, column: 6, scope: !89)
!100 = !DILocation(line: 116, column: 1, scope: !89)
!101 = !DILocation(line: 125, column: 3, scope: !102)
!102 = distinct !DISubprogram(name: "prime_main", scope: !8, file: !8, line: 123, type: !22, scopeLine: 124, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!103 = !DILocation(line: 127, column: 35, scope: !102)
!104 = !DILocation(line: 127, column: 22, scope: !102)
!105 = !DILocation(line: 127, column: 45, scope: !102)
!106 = !DILocation(line: 127, column: 62, scope: !102)
!107 = !DILocation(line: 127, column: 49, scope: !102)
!108 = !DILocation(line: 127, column: 48, scope: !102)
!109 = !DILocation(line: 127, column: 16, scope: !102)
!110 = !DILocation(line: 128, column: 1, scope: !102)
!111 = !DILocalVariable(name: "argc", arg: 1, scope: !112, file: !8, line: 131, type: !14)
!112 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 131, type: !113, scopeLine: 132, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!119 = !DILocalVariable(name: "argv", arg: 2, scope: !112, file: !8, line: 131, type: !115)
!120 = !DILocation(line: 55, column: 14, scope: !21, inlinedAt: !121)
!121 = distinct !DILocation(line: 68, column: 3, scope: !37, inlinedAt: !122)
!122 = distinct !DILocation(line: 133, column: 3, scope: !112)
!123 = !DILocation(line: 70, column: 13, scope: !37, inlinedAt: !122)
!124 = !DILocation(line: 70, column: 11, scope: !37, inlinedAt: !122)
!125 = !DILocation(line: 71, column: 13, scope: !37, inlinedAt: !122)
!126 = !DILocation(line: 71, column: 11, scope: !37, inlinedAt: !122)
!127 = !DILocation(line: 134, column: 3, scope: !112)
!128 = !DILocation(line: 77, column: 10, scope: !43, inlinedAt: !129)
!129 = distinct !DILocation(line: 136, column: 12, scope: !112)
!130 = !DILocation(line: 136, column: 3, scope: !112)
