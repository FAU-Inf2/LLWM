...
311:                                              ; preds = %306, %298
  ...
  %320 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
343:                                              ; preds = %339
  ...
  %345 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
364:                                              ; preds = %360
  ...
  %366 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
385:                                              ; preds = %381
  ...
  %400 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
419:                                              ; preds = %415
  ...
  %435 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
478:                                              ; preds = %470, %454
  ...
  %491 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %99, i64 0, i32 8, i32 0
...
13:                                               ; preds = %74, %8
  %14 = phi %struct.utmpx* [ %6, %8 ], [ %80, %74 ]
  %15 = phi i64 [ 0, %8 ], [ %79, %74 ]
  %16 = phi %struct.utmpx* [ null, %8 ], [ %78, %74 ]
  %17 = phi i8* [ null, %8 ], [ %77, %74 ]
  %18 = phi i8* [ null, %8 ], [ %76, %74 ]
  %19 = phi i64 [ 0, %8 ], [ %75, %74 ]
...
33:                                               ; preds = %30
  %34 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %14, i64 0, i32 1
  %35 = load i32, i32* %34, align 4, !tbaa !21
  %36 = icmp sgt i32 %35, 0
  br i1 %36, label %37, label %44

37:                                               ; preds = %33
  %38 = tail call i32 @kill(i32 %35, i32 0) #17
  %39 = icmp slt i32 %38, 0
  br i1 %39, label %40, label %44

40:                                               ; preds = %37
  %41 = tail call i32* @__errno_location() #21
  %42 = load i32, i32* %41, align 4, !tbaa !11
  %43 = icmp eq i32 %42, 3
  br i1 %43, label %74, label %44

44:                                               ; preds = %40, %37, %33, %30
  %45 = icmp eq i64 %15, %19
  br i1 %45, label %46, label %65

46:                                               ; preds = %44
  %47 = icmp eq i8* %17, null
...
50:                                               ; preds = %48
  %51 = icmp ugt i64 %15, 24019198012642645
...
53:                                               ; preds = %46
  %54 = icmp ult i64 %15, 16012798675095096
...
60:                                               ; preds = %56, %50, %48
  %61 = phi i64 [ %59, %56 ], [ %15, %50 ], [ 1, %48 ]
  %62 = mul i64 %61, 384
  %63 = tail call i8* @xrealloc(i8* %17, i64 %62) #17
  %64 = bitcast i8* %63 to %struct.utmpx*
  br label %65

65:                                               ; preds = %60, %44
  %66 = phi i64 [ %61, %60 ], [ %19, %44 ]
  %67 = phi i8* [ %63, %60 ], [ %18, %44 ]
  %68 = phi i8* [ %63, %60 ], [ %17, %44 ]
  %69 = phi %struct.utmpx* [ %64, %60 ], [ %16, %44 ]
  %70 = add i64 %15, 1
  %71 = getelementptr inbounds %struct.utmpx, %struct.utmpx* %69, i64 %15
  %72 = bitcast %struct.utmpx* %71 to i8*
  %73 = bitcast %struct.utmpx* %14 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %72, i8* nonnull align 4 %73, i64 384, i1 false), !tbaa.struct !59
  br label %74

74:                                               ; preds = %65, %40, %27
  %75 = phi i64 [ %66, %65 ], [ %19, %27 ], [ %19, %40 ]
  %76 = phi i8* [ %67, %65 ], [ %18, %27 ], [ %18, %40 ]
  %77 = phi i8* [ %68, %65 ], [ %17, %27 ], [ %17, %40 ]
  %78 = phi %struct.utmpx* [ %69, %65 ], [ %16, %27 ], [ %16, %40 ]
  %79 = phi i64 [ %70, %65 ], [ %15, %27 ], [ %15, %40 ]
  %80 = tail call %struct.utmpx* @getutxent() #17
  %81 = icmp eq %struct.utmpx* %80, null
  br i1 %81, label %82, label %13

82:                                               ; preds = %74, %4
  %83 = phi i8* [ null, %4 ], [ %76, %74 ]
  %84 = phi i64 [ 0, %4 ], [ %79, %74 ]
  tail call void @endutxent() #17
  store i64 %84, i64* %1, align 8, !tbaa !13
  %85 = bitcast %struct.utmpx** %2 to i8**
  store i8* %83, i8** %85, align 8, !tbaa !4
  ret i32 0
}
...
48:                                               ; preds = %24
  %49 = tail call i32* @__errno_location() #21
...
43:                                               ; preds = %38
  %44 = tail call i32 @rpl_fseeko(%struct._IO_FILE* nonnull %0, i64 0, i32 1) #17
  br label %45
