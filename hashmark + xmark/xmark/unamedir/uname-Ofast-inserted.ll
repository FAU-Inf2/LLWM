...
100:                                              ; preds = %96
  ...
  %103 = load i8*, i8** %102
  %controle = call i32 @controle(i8* %103, i32 0)
...
39:                                               ; preds = %17
  %40 = tail call i32 @fileno(%struct._IO_FILE* nonnull %0) #14
  %41 = tail call i64 @lseek(i32 %40, i64 0, i32 1) #14
  %42 = icmp eq i64 %41, -1
  br i1 %42, label %46, label %43

43:                                               ; preds = %35, %39
  %44 = tail call i32 @rpl_fflush(%struct._IO_FILE* nonnull %0) #14
  %45 = icmp eq i32 %44, 0
...
54:                                               ; preds = %53, %48, %46, %4
  %55 = phi i32 [ %5, %4 ], [ -1, %53 ], [ %51, %48 ], [ %47, %46 ]
  ret i32 %55
}
...
attributes #9 = { noreturn "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
attributes #10 = { nofree nounwind }
attributes #11 = { argmemonly nofree nounwind readonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
