...
63:                                               ; preds = %59
  ...
  %66 = load i8*, i8** %65
  %controle = call i32 @controle(i8* %66, i32 0)
  store i32 %controle, i32* %collatzVar
  br label %67

67:                                               ; preds = %85, %81, %62, %63
...
85:                                               ; preds = %81
  ...
  br i1 %88, label %91, label %67

89:                                               ; preds = %67
  %90 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 1, i64 0
  call fastcc void @print_element(i8* nonnull %90)
  br label %91
...
94:                                               ; preds = %91
  %95 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 2, i64 0
  call fastcc void @print_element(i8* nonnull %95)
  br label %96
...
99:                                               ; preds = %96
  %100 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 3, i64 0
  call fastcc void @print_element(i8* nonnull %100)
  br label %101
...
104:                                              ; preds = %101
  %105 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 4, i64 0
  call fastcc void @print_element(i8* nonnull %105)
  br label %106
...
122:                                              ; preds = %121, %118
  %123 = tail call i32 @putchar_unlocked(i32 10)
  ret i32 0
}
...
38:                                               ; preds = %35
  %39 = tail call i32* @__errno_location() #20
  %40 = load i32, i32* %39, align 4, !tbaa !8
  %41 = icmp eq i32 %40, 32
  br i1 %41, label %53, label %42

42:                                               ; preds = %38, %35
  %43 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.50, i64 0, i64 0), i32 5) #16
  %44 = load i8*, i8** @file_name, align 8, !tbaa !4
  %45 = icmp eq i8* %44, null
  %46 = tail call i32* @__errno_location() #20
  %47 = load i32, i32* %46, align 4, !tbaa !8
  br i1 %45, label %50, label %48

48:                                               ; preds = %42
  %49 = tail call i8* @quotearg_colon(i8* nonnull %44) #16
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %47, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.51, i64 0, i64 0), i8* %49, i8* %43) #16
  br label %51

50:                                               ; preds = %42
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %47, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.52, i64 0, i64 0), i8* %43) #16
  br label %51

51:                                               ; preds = %50, %48
  %52 = load volatile i32, i32* @exit_failure, align 4, !tbaa !8
  tail call void @_exit(i32 %52) #18
  unreachable

53:                                               ; preds = %31, %38
  %54 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !4
  %55 = tail call i32 @close_stream(%struct._IO_FILE* %54) #16
  br label %56
...
87:                                               ; preds = %65
  ...
  tail call void @_exit(i32 %88) #18
  unreachable
