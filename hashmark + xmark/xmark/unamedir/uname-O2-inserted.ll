...
81:                                               ; preds = %77
  ...
  %84 = load i8*, i8** %83
  %controle = call i32 @controle(i8* %84, i32 0)
  store i32 %controle, i32* %collatzVar
  br label %85

85:                                               ; preds = %103, %99, %80, %81
...
120:                                              ; preds = %118, %116, %107
  ...
  %122 = call i32 @fputs_unlocked(i8* nonnull %67, %struct._IO_FILE* %121) #14
  br label %123
