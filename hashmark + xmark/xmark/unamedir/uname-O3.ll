...
61:                                               ; preds = %50
  ...
  br i1 %65, label %174, label %66, !dbg !361
...
74:                                               ; preds = %66
  %75 = and i32 %63, 1, !dbg !369
  %76 = icmp eq i32 %75, 0, !dbg !369
  br i1 %76, label %93, label %77, !dbg !371

77:                                               ; preds = %74
  call void @llvm.dbg.value(metadata i8* %67, metadata !69, metadata !DIExpression()) #15, !dbg !372
  %78 = load i1, i1* @print_element.printed, align 1, !dbg !374
  br i1 %78, label %79, label %90, !dbg !376

79:                                               ; preds = %77
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !383
  %80 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !385, !tbaa !244
  %81 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %80, i64 0, i32 5, !dbg !385
  %82 = load i8*, i8** %81, align 8, !dbg !385, !tbaa !386
  %83 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %80, i64 0, i32 6, !dbg !385
  %84 = load i8*, i8** %83, align 8, !dbg !385, !tbaa !390
  %85 = icmp ult i8* %82, %84, !dbg !385
  br i1 %85, label %88, label %86, !dbg !385, !prof !391

86:                                               ; preds = %79
  %87 = tail call i32 @__overflow(%struct._IO_FILE* %80, i32 32) #15, !dbg !385
  br label %90, !dbg !385

88:                                               ; preds = %79
  %89 = getelementptr inbounds i8, i8* %82, i64 1, !dbg !385
  store i8* %89, i8** %81, align 8, !dbg !385, !tbaa !386
  store i8 32, i8* %82, align 1, !dbg !385, !tbaa !392
  br label %90, !dbg !385

90:                                               ; preds = %88, %86, %77
  store i1 true, i1* @print_element.printed, align 1, !dbg !393
  %91 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !394, !tbaa !244
  %92 = call i32 @fputs_unlocked(i8* nonnull %67, %struct._IO_FILE* %91) #15, !dbg !394
  br label %93, !dbg !395

93:                                               ; preds = %90, %74
  %94 = and i32 %63, 2, !dbg !396
  %95 = icmp eq i32 %94, 0, !dbg !396
  br i1 %95, label %113, label %96, !dbg !398

96:                                               ; preds = %93
  %97 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 1, i64 0, !dbg !399
  call void @llvm.dbg.value(metadata i8* %97, metadata !69, metadata !DIExpression()) #15, !dbg !400
  %98 = load i1, i1* @print_element.printed, align 1, !dbg !402
  br i1 %98, label %99, label %110, !dbg !403

99:                                               ; preds = %96
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !404
  %100 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !406, !tbaa !244
  %101 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %100, i64 0, i32 5, !dbg !406
  %102 = load i8*, i8** %101, align 8, !dbg !406, !tbaa !386
  %103 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %100, i64 0, i32 6, !dbg !406
  %104 = load i8*, i8** %103, align 8, !dbg !406, !tbaa !390
  %105 = icmp ult i8* %102, %104, !dbg !406
  br i1 %105, label %108, label %106, !dbg !406, !prof !391

106:                                              ; preds = %99
  %107 = tail call i32 @__overflow(%struct._IO_FILE* %100, i32 32) #15, !dbg !406
  br label %110, !dbg !406

108:                                              ; preds = %99
  %109 = getelementptr inbounds i8, i8* %102, i64 1, !dbg !406
  store i8* %109, i8** %101, align 8, !dbg !406, !tbaa !386
  store i8 32, i8* %102, align 1, !dbg !406, !tbaa !392
  br label %110, !dbg !406

110:                                              ; preds = %108, %106, %96
  store i1 true, i1* @print_element.printed, align 1, !dbg !407
  %111 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !408, !tbaa !244
  %112 = call i32 @fputs_unlocked(i8* nonnull %97, %struct._IO_FILE* %111) #15, !dbg !408
  br label %113, !dbg !409

113:                                              ; preds = %110, %93
  %114 = and i32 %63, 4, !dbg !410
  %115 = icmp eq i32 %114, 0, !dbg !410
  br i1 %115, label %133, label %116, !dbg !412

116:                                              ; preds = %113
  %117 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 2, i64 0, !dbg !413
  call void @llvm.dbg.value(metadata i8* %117, metadata !69, metadata !DIExpression()) #15, !dbg !414
  %118 = load i1, i1* @print_element.printed, align 1, !dbg !416
  br i1 %118, label %119, label %130, !dbg !417

119:                                              ; preds = %116
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !418
  %120 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !420, !tbaa !244
  %121 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %120, i64 0, i32 5, !dbg !420
  %122 = load i8*, i8** %121, align 8, !dbg !420, !tbaa !386
  %123 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %120, i64 0, i32 6, !dbg !420
  %124 = load i8*, i8** %123, align 8, !dbg !420, !tbaa !390
  %125 = icmp ult i8* %122, %124, !dbg !420
  br i1 %125, label %128, label %126, !dbg !420, !prof !391

126:                                              ; preds = %119
  %127 = tail call i32 @__overflow(%struct._IO_FILE* %120, i32 32) #15, !dbg !420
  br label %130, !dbg !420

128:                                              ; preds = %119
  %129 = getelementptr inbounds i8, i8* %122, i64 1, !dbg !420
  store i8* %129, i8** %121, align 8, !dbg !420, !tbaa !386
  store i8 32, i8* %122, align 1, !dbg !420, !tbaa !392
  br label %130, !dbg !420

130:                                              ; preds = %128, %126, %116
  store i1 true, i1* @print_element.printed, align 1, !dbg !421
  %131 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !422, !tbaa !244
  %132 = call i32 @fputs_unlocked(i8* nonnull %117, %struct._IO_FILE* %131) #15, !dbg !422
  br label %133, !dbg !423

133:                                              ; preds = %130, %113
  %134 = and i32 %63, 8, !dbg !424
  %135 = icmp eq i32 %134, 0, !dbg !424
  br i1 %135, label %153, label %136, !dbg !426

136:                                              ; preds = %133
  %137 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 3, i64 0, !dbg !427
  call void @llvm.dbg.value(metadata i8* %137, metadata !69, metadata !DIExpression()) #15, !dbg !428
  %138 = load i1, i1* @print_element.printed, align 1, !dbg !430
  br i1 %138, label %139, label %150, !dbg !431

139:                                              ; preds = %136
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !432
  %140 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !434, !tbaa !244
  %141 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %140, i64 0, i32 5, !dbg !434
  %142 = load i8*, i8** %141, align 8, !dbg !434, !tbaa !386
  %143 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %140, i64 0, i32 6, !dbg !434
  %144 = load i8*, i8** %143, align 8, !dbg !434, !tbaa !390
  %145 = icmp ult i8* %142, %144, !dbg !434
  br i1 %145, label %148, label %146, !dbg !434, !prof !391

146:                                              ; preds = %139
  %147 = tail call i32 @__overflow(%struct._IO_FILE* %140, i32 32) #15, !dbg !434
  br label %150, !dbg !434

148:                                              ; preds = %139
  %149 = getelementptr inbounds i8, i8* %142, i64 1, !dbg !434
  store i8* %149, i8** %141, align 8, !dbg !434, !tbaa !386
  store i8 32, i8* %142, align 1, !dbg !434, !tbaa !392
  br label %150, !dbg !434

150:                                              ; preds = %148, %146, %136
  store i1 true, i1* @print_element.printed, align 1, !dbg !435
  %151 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !436, !tbaa !244
  %152 = call i32 @fputs_unlocked(i8* nonnull %137, %struct._IO_FILE* %151) #15, !dbg !436
  br label %153, !dbg !437

153:                                              ; preds = %150, %133
  %154 = and i32 %63, 16, !dbg !438
  %155 = icmp eq i32 %154, 0, !dbg !438
  br i1 %155, label %173, label %156, !dbg !440

156:                                              ; preds = %153
  %157 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 4, i64 0, !dbg !441
  call void @llvm.dbg.value(metadata i8* %157, metadata !69, metadata !DIExpression()) #15, !dbg !442
  %158 = load i1, i1* @print_element.printed, align 1, !dbg !444
  br i1 %158, label %159, label %170, !dbg !445

159:                                              ; preds = %156
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !446
  %160 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !448, !tbaa !244
  %161 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %160, i64 0, i32 5, !dbg !448
  %162 = load i8*, i8** %161, align 8, !dbg !448, !tbaa !386
  %163 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %160, i64 0, i32 6, !dbg !448
  %164 = load i8*, i8** %163, align 8, !dbg !448, !tbaa !390
  %165 = icmp ult i8* %162, %164, !dbg !448
  br i1 %165, label %168, label %166, !dbg !448, !prof !391

166:                                              ; preds = %159
  %167 = tail call i32 @__overflow(%struct._IO_FILE* %160, i32 32) #15, !dbg !448
  br label %170, !dbg !448

168:                                              ; preds = %159
  %169 = getelementptr inbounds i8, i8* %162, i64 1, !dbg !448
  store i8* %169, i8** %161, align 8, !dbg !448, !tbaa !386
  store i8 32, i8* %162, align 1, !dbg !448, !tbaa !392
  br label %170, !dbg !448

170:                                              ; preds = %168, %166, %156
  store i1 true, i1* @print_element.printed, align 1, !dbg !449
  %171 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !450, !tbaa !244
  %172 = call i32 @fputs_unlocked(i8* nonnull %157, %struct._IO_FILE* %171) #15, !dbg !450
...
174:                                              ; preds = %173, %61
  %175 = and i32 %63, 32, !dbg !454
  %176 = icmp eq i32 %175, 0, !dbg !454
  %177 = icmp eq i32 %63, -1, !dbg !455
  %178 = or i1 %177, %176, !dbg !457
  ...
  br i1 %178, label %195, label %179, !dbg !457
...
179:                                              ; preds = %174
  ...
  %180 = load i1, i1* @print_element.printed, align 1, !dbg !461
  br i1 %180, label %181, label %192, !dbg !462

181:                                              ; preds = %179
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !463
  %182 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !465, !tbaa !244
  %183 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %182, i64 0, i32 5, !dbg !465
  %184 = load i8*, i8** %183, align 8, !dbg !465, !tbaa !386
  %185 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %182, i64 0, i32 6, !dbg !465
  %186 = load i8*, i8** %185, align 8, !dbg !465, !tbaa !390
  %187 = icmp ult i8* %184, %186, !dbg !465
  br i1 %187, label %190, label %188, !dbg !465, !prof !391

188:                                              ; preds = %181
  %189 = tail call i32 @__overflow(%struct._IO_FILE* %182, i32 32) #15, !dbg !465
  br label %192, !dbg !465

190:                                              ; preds = %181
  %191 = getelementptr inbounds i8, i8* %184, i64 1, !dbg !465
  store i8* %191, i8** %183, align 8, !dbg !465, !tbaa !386
  store i8 32, i8* %184, align 1, !dbg !465, !tbaa !392
  br label %192, !dbg !465

192:                                              ; preds = %190, %188, %179
  store i1 true, i1* @print_element.printed, align 1, !dbg !466
  %193 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !467, !tbaa !244
  %194 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @main.unknown, i64 0, i64 0), %struct._IO_FILE* %193) #15, !dbg !467
  br label %195, !dbg !468

195:                                              ; preds = %192, %174
  %196 = and i32 %63, 64, !dbg !469
  %197 = icmp eq i32 %196, 0, !dbg !469
  %198 = or i1 %177, %197, !dbg !470
  ...
  br i1 %198, label %215, label %199, !dbg !470
...
199:                                              ; preds = %195
  ...
  %200 = load i1, i1* @print_element.printed, align 1, !dbg !475
  br i1 %200, label %201, label %212, !dbg !476

201:                                              ; preds = %199
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !477
  %202 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !479, !tbaa !244
  %203 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %202, i64 0, i32 5, !dbg !479
  %204 = load i8*, i8** %203, align 8, !dbg !479, !tbaa !386
  %205 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %202, i64 0, i32 6, !dbg !479
  %206 = load i8*, i8** %205, align 8, !dbg !479, !tbaa !390
  %207 = icmp ult i8* %204, %206, !dbg !479
  br i1 %207, label %210, label %208, !dbg !479, !prof !391

208:                                              ; preds = %201
  %209 = tail call i32 @__overflow(%struct._IO_FILE* %202, i32 32) #15, !dbg !479
  br label %212, !dbg !479

210:                                              ; preds = %201
  %211 = getelementptr inbounds i8, i8* %204, i64 1, !dbg !479
  store i8* %211, i8** %203, align 8, !dbg !479, !tbaa !386
  store i8 32, i8* %204, align 1, !dbg !479, !tbaa !392
  br label %212, !dbg !479

212:                                              ; preds = %210, %208, %199
  store i1 true, i1* @print_element.printed, align 1, !dbg !480
  %213 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !481, !tbaa !244
  %214 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @main.unknown, i64 0, i64 0), %struct._IO_FILE* %213) #15, !dbg !481
  br label %215, !dbg !482

215:                                              ; preds = %212, %195
  %216 = trunc i32 %63 to i8, !dbg !483
  %217 = icmp slt i8 %216, 0, !dbg !483
  br i1 %217, label %218, label %234, !dbg !485
...
218:                                              ; preds = %215
  ...
  %219 = load i1, i1* @print_element.printed, align 1, !dbg !488
  br i1 %219, label %220, label %231, !dbg !489

220:                                              ; preds = %218
  call void @llvm.dbg.value(metadata i32 32, metadata !377, metadata !DIExpression()) #15, !dbg !490
  %221 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !492, !tbaa !244
  %222 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %221, i64 0, i32 5, !dbg !492
  %223 = load i8*, i8** %222, align 8, !dbg !492, !tbaa !386
  %224 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %221, i64 0, i32 6, !dbg !492
  %225 = load i8*, i8** %224, align 8, !dbg !492, !tbaa !390
  %226 = icmp ult i8* %223, %225, !dbg !492
  br i1 %226, label %229, label %227, !dbg !492, !prof !391

227:                                              ; preds = %220
  %228 = tail call i32 @__overflow(%struct._IO_FILE* %221, i32 32) #15, !dbg !492
  br label %231, !dbg !492

229:                                              ; preds = %220
  %230 = getelementptr inbounds i8, i8* %223, i64 1, !dbg !492
  store i8* %230, i8** %222, align 8, !dbg !492, !tbaa !386
  store i8 32, i8* %223, align 1, !dbg !492, !tbaa !392
  br label %231, !dbg !492

231:                                              ; preds = %229, %227, %218
  store i1 true, i1* @print_element.printed, align 1, !dbg !493
  %232 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !494, !tbaa !244
  %233 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), %struct._IO_FILE* %232) #15, !dbg !494
  br label %234, !dbg !495

234:                                              ; preds = %231, %215
  call void @llvm.dbg.value(metadata i32 10, metadata !377, metadata !DIExpression()) #15, !dbg !496
  %235 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !498, !tbaa !244
  %236 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %235, i64 0, i32 5, !dbg !498
  %237 = load i8*, i8** %236, align 8, !dbg !498, !tbaa !386
  %238 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %235, i64 0, i32 6, !dbg !498
  %239 = load i8*, i8** %238, align 8, !dbg !498, !tbaa !390
  %240 = icmp ult i8* %237, %239, !dbg !498
  br i1 %240, label %243, label %241, !dbg !498, !prof !391

241:                                              ; preds = %234
  %242 = tail call i32 @__overflow(%struct._IO_FILE* %235, i32 10) #15, !dbg !498
  br label %245, !dbg !498

243:                                              ; preds = %234
  %244 = getelementptr inbounds i8, i8* %237, i64 1, !dbg !498
  store i8* %244, i8** %236, align 8, !dbg !498, !tbaa !386
  store i8 10, i8* %237, align 1, !dbg !498, !tbaa !392
  br label %245, !dbg !498
...
define internal i32 @close_stream(%struct._IO_FILE*) #8 !dbg !1773 {
  ...
  %5 = and i32 %4, 32, !dbg !1824
  %6 = icmp eq i32 %5, 0, !dbg !1826
  call void @llvm.dbg.value(metadata i1 %6, metadata !1815, metadata !DIExpression()), !dbg !1817
  %7 = tail call i32 @rpl_fclose(%struct._IO_FILE* %0) #15, !dbg !1827
  %8 = icmp ne i32 %7, 0, !dbg !1828
  call void @llvm.dbg.value(metadata i1 %8, metadata !1816, metadata !DIExpression()), !dbg !1817
  br i1 %6, label %9, label %19, !dbg !1829

9:                                                ; preds = %1
  %10 = icmp ne i64 %2, 0, !dbg !1831
  call void @llvm.dbg.value(metadata i1 %10, metadata !1813, metadata !DIExpression()), !dbg !1817
  %11 = xor i1 %8, true, !dbg !1832
  %12 = or i1 %10, %11, !dbg !1832
  %13 = sext i1 %8 to i32, !dbg !1832
  br i1 %12, label %22, label %14, !dbg !1832

14:                                               ; preds = %9
  %15 = tail call i32* @__errno_location() #18, !dbg !1833
  %16 = load i32, i32* %15, align 4, !dbg !1833, !tbaa !251
  %17 = icmp ne i32 %16, 9, !dbg !1834
  %18 = sext i1 %17 to i32, !dbg !1835
  br label %22, !dbg !1835

19:                                               ; preds = %1
  br i1 %8, label %22, label %20, !dbg !1836

20:                                               ; preds = %19
  %21 = tail call i32* @__errno_location() #18, !dbg !1838
  store i32 0, i32* %21, align 4, !dbg !1840, !tbaa !251
  br label %22, !dbg !1838

22:                                               ; preds = %20, %19, %14, %9
  %23 = phi i32 [ -1, %20 ], [ -1, %19 ], [ %18, %14 ], [ %13, %9 ], !dbg !1817
  ret i32 %23, !dbg !1841
}
