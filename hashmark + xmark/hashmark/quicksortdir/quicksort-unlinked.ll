...
86:                                               ; preds = %82, %73
  ...
  %92 = call i32 @_Z10computeFuniiiii(i32 -1095627082, i32 25, i32 -320995319, i32 11, i32 557393857)
...
138:                                              ; preds = %137, %119
  ...
  %140 = ashr i32 %139, 1
  %141 = add nsw i32 %140, 1056964608
  ...
  %147 = bitcast %union.quicksort_ieee_float_shape_type* %14 to i32*
  store i32 %146, i32* %147, align 4
  %148 = bitcast %union.quicksort_ieee_float_shape_type* %14 to float*
  %149 = load float, float* %148, align 4
  store float %149, float* %4, align 4
  %150 = load float, float* %4, align 4
  store float %150, float* %2, align 4
  br label %151

151:                                              ; preds = %138, %42, %37, %22
...
24:                                               ; preds = %21
  %25 = call i32 @_Z10computeFuniiiii(i32 171486135, i32 12, i32 1788981854, i32 478, i32 179125660)
...
76:                                               ; preds = %71
  ...
  %78 = call i32 @_Z10computeFuniiiii(i32 1693236049, i32 48, i32 -40886831, i32 1, i32 308348788)
  %79 = add i32 %77, %78
  store i32 %79, i32* %1, align 4
  br label %21

80:                                               ; preds = %21
  %81 = call i32 @_Z10computeFuniiiii(i32 -1926368240, i32 8, i32 -2099943186, i32 956, i32 179125660)
...
85:                                               ; preds = %82
  ...
  %105 = call i32 @_Z10computeFuniiiii(i32 -1873779167, i32 31, i32 1262115049, i32 464274101, i32 308348788)
  %106 = add i32 %104, %105
  store i32 %106, i32* %6, align 4
  %107 = zext i32 %104 to i64
  %108 = getelementptr inbounds [3000 x i32], [3000 x i32]* @quicksort_input_vector, i64 0, i64 %107
  %109 = load i32, i32* %108, align 4
  %110 = load i32, i32* %1, align 4
  %111 = zext i32 %110 to i64
  %112 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %111
  %113 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %112, i32 0, i32 2
  store i32 %109, i32* %113, align 8
  store i32 %109, i32* %5, align 4
  %114 = load i32, i32* %3, align 4
  %115 = uitofp i32 %114 to float
  %116 = call float @quicksort___ieee754_powf(float %115, float 2.000000e+00)
  %117 = load i32, i32* %4, align 4
  %118 = uitofp i32 %117 to float
  %119 = call float @quicksort___ieee754_powf(float %118, float 2.000000e+00)
  %120 = fadd float %116, %119
  %121 = load i32, i32* %5, align 4
  %122 = uitofp i32 %121 to float
  %123 = call float @quicksort___ieee754_powf(float %122, float 2.000000e+00)
  %124 = fadd float %120, %123
  %125 = call float @quicksort___ieee754_sqrtf(float %124)
  %126 = fpext float %125 to double
  %127 = load i32, i32* %1, align 4
  %128 = zext i32 %127 to i64
  %129 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %128
  %130 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %129, i32 0, i32 3
...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  %4 = alloca i32, align 4
  %5 = alloca i8**, align 8
  %6 = call i32 @_Z10computeFuniiiii(i32 626425965, i32 27, i32 499713061, i32 121, i32 540616641)
  store i32 %6, i32* %3, align 4
  store i32 %0, i32* %4, align 4
  store i8** %1, i8*** %5, align 8
  call void @quicksort_init()
  call void @quicksort_main()
  %7 = call i32 @quicksort_return()
  %8 = sub nsw i32 %7, 1527923179
  %9 = icmp ne i32 %8, 0
  %10 = zext i1 %9 to i32
  ret i32 %10
}
