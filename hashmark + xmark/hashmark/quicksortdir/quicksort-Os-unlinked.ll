...
81:                                               ; preds = %79, %77, %68
  ...
  %83 = fadd float %70, %82
  %84 = tail call float @quicksort___ieee754_sqrtf(float %83) #6
...
11:                                               ; preds = %7
  %12 = tail call i8* @quicksort_pivot_strings(i8* %8, i64 %9, i64 %2) #6
  br label %17
...
19:                                               ; preds = %19, %17
  ...
  %23 = load i8, i8* %20, align 1, !tbaa !8
  %24 = load i8, i8* %21, align 1, !tbaa !8
  %25 = getelementptr inbounds i8, i8* %20, i64 1
  store i8 %24, i8* %20, align 1, !tbaa !8
  %26 = getelementptr inbounds i8, i8* %21, i64 1
  store i8 %23, i8* %21, align 1, !tbaa !8
  %27 = add i64 %22, -1
  %28 = icmp eq i64 %27, 0
...
39:                                               ; preds = %35
  %40 = load i8, i8* %37, align 1, !tbaa !8
  %41 = icmp eq i8 %40, 0
...
53:                                               ; preds = %42
  %54 = load i8, i8* %44, align 1, !tbaa !8
...
61:                                               ; preds = %57
  %62 = load i8, i8* %59, align 1, !tbaa !8
  %63 = icmp eq i8 %62, 0
...
82:                                               ; preds = %82, %80
  ...
  %86 = load i8, i8* %83, align 1, !tbaa !8
  %87 = load i8, i8* %84, align 1, !tbaa !8
  %88 = getelementptr inbounds i8, i8* %83, i64 1
  store i8 %87, i8* %83, align 1, !tbaa !8
  %89 = getelementptr inbounds i8, i8* %84, i64 1
  store i8 %86, i8* %84, align 1, !tbaa !8
  %90 = add i64 %85, -1
  %91 = icmp eq i64 %90, 0
...
110:                                              ; preds = %102
  tail call void @quicksort_str(i8* %8, i64 %106, i64 %2) #6
  %111 = add i64 %106, 1
  %112 = mul i64 %111, %2
...
114:                                              ; preds = %102
  ...
  tail call void @quicksort_str(i8* %117, i64 %108, i64 %2) #6
  br label %118
...
66:                                               ; preds = %62
  ...
  %70 = load double, double* %58, align 8, !tbaa !9
...
85:                                               ; preds = %85, %83
  ...
  %89 = load i8, i8* %86, align 1, !tbaa !8
  %90 = load i8, i8* %87, align 1, !tbaa !8
  %91 = getelementptr inbounds i8, i8* %86, i64 1
  store i8 %90, i8* %86, align 1, !tbaa !8
  %92 = getelementptr inbounds i8, i8* %87, i64 1
  store i8 %89, i8* %87, align 1, !tbaa !8
  %93 = add i64 %88, -1
  %94 = icmp eq i64 %93, 0
...
95:                                               ; preds = %95, %83
  ...
  %99 = load i8, i8* %96, align 1, !tbaa !8
  %100 = load i8, i8* %97, align 1, !tbaa !8
  %101 = getelementptr inbounds i8, i8* %96, i64 1
  store i8 %100, i8* %96, align 1, !tbaa !8
  %102 = getelementptr inbounds i8, i8* %97, i64 1
  store i8 %99, i8* %97, align 1, !tbaa !8
  %103 = add i64 %98, -1
...
113:                                              ; preds = %105
  tail call void @quicksort_vec(i8* %8, i64 %109, i64 %2) #6
  %114 = add i64 %109, 1
  %115 = mul i64 %114, %2
...
117:                                              ; preds = %105
  ...
  tail call void @quicksort_vec(i8* %120, i64 %111, i64 %2) #6
  br label %121
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #5 {
  ...
  tail call void @quicksort_str(i8* getelementptr inbounds ([681 x [20 x i8]], [681 x [20 x i8]]* @quicksort_strings, i64 0, i64 0, i64 0), i64 681, i64 20) #8
  %3 = load i8, i8* getelementptr inbounds ([681 x [20 x i8]], [681 x [20 x i8]]* @quicksort_strings, i64 0, i64 42, i64 1), align 1, !tbaa !8
  %4 = sext i8 %3 to i32
  %5 = load i32, i32* getelementptr inbounds ([1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 42, i32 0), align 16, !tbaa !14
  %6 = add i32 %5, %4
  %7 = load i32, i32* getelementptr inbounds ([1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 42, i32 1), align 4, !tbaa !15
  %8 = add i32 %6, %7
  %9 = load i32, i32* getelementptr inbounds ([1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 42, i32 2), align 8, !tbaa !16
  %10 = add i32 %8, %9
...
attributes #2 = { nofree norecurse nounwind optsize uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
