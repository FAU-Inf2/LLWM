...
29:                                               ; preds = %79, %25
  %30 = phi i64 [ %85, %79 ], [ 0, %25 ]
  %31 = phi i64 [ %40, %79 ], [ 0, %25 ]
...
46:                                               ; preds = %29
  ...
  %49 = icmp ugt i32 %48, 2139095040
  br i1 %49, label %50, label %52

50:                                               ; preds = %46
  %51 = fadd float %44, 2.000000e+00
  br label %54
...
54:                                               ; preds = %52, %50, %29
  %55 = phi float [ %51, %50 ], [ %53, %52 ], [ 1.000000e+00, %29 ]
  %56 = uitofp i32 %38 to float
  %57 = icmp eq i32 %38, 1
...
58:                                               ; preds = %54
  ...
  %61 = icmp ugt i32 %60, 2139095040
  br i1 %61, label %62, label %64

62:                                               ; preds = %58
  %63 = fadd float %56, 2.000000e+00
  br label %66
...
66:                                               ; preds = %64, %62, %54
  %67 = phi float [ %63, %62 ], [ %65, %64 ], [ 1.000000e+00, %54 ]
  %68 = fadd float %55, %67
  %69 = uitofp i32 %42 to float
  %70 = icmp eq i32 %42, 1
...
71:                                               ; preds = %66
  ...
  %74 = icmp ugt i32 %73, 2139095040
  br i1 %74, label %75, label %77

75:                                               ; preds = %71
  %76 = fadd float %69, 2.000000e+00
  br label %79
...
79:                                               ; preds = %77, %75, %66
  %80 = phi float [ %76, %75 ], [ %78, %77 ], [ 1.000000e+00, %66 ]
  %81 = fadd float %68, %80
  %82 = tail call float @quicksort___ieee754_sqrtf(float %81) #6
  %83 = fpext float %82 to double
  %84 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %30, i32 3
...
attributes #1 = { nofree norecurse nounwind optsize uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
