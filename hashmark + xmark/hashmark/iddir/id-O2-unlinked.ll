...
101:                                              ; preds = %99, %97
  ...
  %104 = tail call i32 @geteuid() #15
  store i32 %104, i32* @euid, align 4, !tbaa !11
  %105 = icmp eq i32 %104, -1
  br i1 %105, label %106, label %111

106:                                              ; preds = %101
  %107 = load i32, i32* %102, align 4, !tbaa !11
  %108 = icmp eq i32 %107, 0
  br i1 %108, label %111, label %109

109:                                              ; preds = %106
  %110 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.23, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %107, i8* %110) #15
  unreachable
...
117:                                              ; preds = %115
  %118 = tail call i32* @__errno_location() #19
  br label %131

119:                                              ; preds = %115, %113
  %120 = tail call i32* @__errno_location() #19
  ...
  %122 = tail call i32 @getuid() #15
  store i32 %122, i32* @ruid, align 4, !tbaa !11
  %123 = icmp eq i32 %122, -1
  br i1 %123, label %124, label %129

124:                                              ; preds = %119
  %125 = load i32, i32* %120, align 4, !tbaa !11
  %126 = icmp eq i32 %125, 0
  br i1 %126, label %129, label %127

127:                                              ; preds = %124
  %128 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %125, i8* %128) #15
  unreachable
...
131:                                              ; preds = %129, %117
  ...
  store i32 %133, i32* %132, align 4, !tbaa !11
  %134 = tail call i32 @getegid() #15
  store i32 %134, i32* @egid, align 4, !tbaa !11
  %135 = icmp eq i32 %134, -1
  br i1 %135, label %136, label %141

136:                                              ; preds = %131
  %137 = load i32, i32* %132, align 4, !tbaa !11
  %138 = icmp eq i32 %137, 0
  br i1 %138, label %141, label %139

139:                                              ; preds = %136
  %140 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %137, i8* %140) #15
  unreachable

141:                                              ; preds = %136, %131
  %142 = call i32 @_Z10computeFuniiiii(i32 1177541372, i32 2, i32 235012663, i32 -787351, i32 -108049333)
  store i32 %142, i32* %132, align 4, !tbaa !11
  %143 = tail call i32 @getgid() #15
  store i32 %143, i32* @rgid, align 4, !tbaa !11
  %144 = icmp eq i32 %143, -1
  br i1 %144, label %145, label %150

145:                                              ; preds = %141
  %146 = load i32, i32* %132, align 4, !tbaa !11
  %147 = icmp eq i32 %146, 0
  br i1 %147, label %150, label %148

148:                                              ; preds = %145
  %149 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %146, i8* %149) #15
  unreachable
...
151:                                              ; preds = %150, %91, %55
  %152 = load i8, i8* @ok, align 1, !tbaa !13, !range !20
  %153 = xor i8 %152, 1
...
11:                                               ; preds = %7, %4
  %12 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.63, i64 0, i64 0), i32 5) #15
...
17:                                               ; preds = %11
  ...
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %16, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.64, i64 0, i64 0), i8* %18, i8* %12) #15
  br label %20

19:                                               ; preds = %11
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %16, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.65, i64 0, i64 0), i8* %12) #15
  br label %20

20:                                               ; preds = %19, %17
  %21 = load volatile i32, i32* @exit_failure, align 4, !tbaa !11
  tail call void @_exit(i32 %21) #17
  unreachable
...
26:                                               ; preds = %22
  ...
  tail call void @_exit(i32 %27) #17
  unreachable
...
66:                                               ; preds = %62
  %67 = tail call i32* @__errno_location() #19
  store i32 12, i32* %67, align 4, !tbaa !11
  br label %148
...
75:                                               ; preds = %68
  ...
  %81 = tail call i32 @getgroups(i32 %78, i32* nonnull %80) #15
  %82 = icmp slt i32 %81, 0
  br i1 %82, label %83, label %86

83:                                               ; preds = %75
  %84 = tail call i32* @__errno_location() #19
  %85 = load i32, i32* %84, align 4, !tbaa !11
  tail call void @free(i8* nonnull %72) #15
  store i32 %85, i32* %84, align 4, !tbaa !11
  br label %148
...
93:                                               ; preds = %89
  %94 = load i32, i32* %73, align 4, !tbaa !11
...
105:                                              ; preds = %100
  %106 = load i32, i32* %98, align 4, !tbaa !11
...
108:                                              ; preds = %105
  ...
  store i32 %106, i32* %110, align 4, !tbaa !11
  br label %113
...
150:                                              ; preds = %139
  ...
  store i32 %144, i32* %151, align 4, !tbaa !11
  br label %154
