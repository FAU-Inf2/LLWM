...
101:                                              ; preds = %99, %97
  ...
  %103 = call i32 @_Z10computeFuniiiii(i32 116776269, i32 27, i32 -348830802, i32 95, i32 -34518040)
...
119:                                              ; preds = %115, %113
  ...
  %121 = tail call i32 @getuid() #15
  store i32 %121, i32* @ruid, align 4, !tbaa !11
  %122 = icmp eq i32 %121, -1
  br i1 %122, label %123, label %128

123:                                              ; preds = %119
  %124 = load i32, i32* %120, align 4, !tbaa !11
  %125 = icmp eq i32 %124, 0
  br i1 %125, label %128, label %126

126:                                              ; preds = %123
  %127 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %124, i8* %127) #15
  unreachable
...
130:                                              ; preds = %128, %117
  ...
  %132 = call i32 @_Z10computeFuniiiii(i32 -199867071, i32 13, i32 294486768, i32 -1, i32 -34518040)
  store i32 %132, i32* %131, align 4, !tbaa !11
  %133 = tail call i32 @getegid() #15
  store i32 %133, i32* @egid, align 4, !tbaa !11
...
138:                                              ; preds = %135
  %139 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %136, i8* %139) #15
  unreachable

140:                                              ; preds = %135, %130
  %141 = call i32 @_Z10computeFuniiiii(i32 -188901820, i32 47, i32 -196108934, i32 -169006931, i32 65906076)
  store i32 %141, i32* %131, align 4, !tbaa !11
  %142 = tail call i32 @getgid() #15
  store i32 %142, i32* @rgid, align 4, !tbaa !11
  %143 = icmp eq i32 %142, -1
  br i1 %143, label %144, label %149

144:                                              ; preds = %140
  %145 = load i32, i32* %131, align 4, !tbaa !11
  %146 = icmp eq i32 %145, 0
  br i1 %146, label %149, label %147

147:                                              ; preds = %144
  %148 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0), i32 5) #15
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %145, i8* %148) #15
  unreachable
...
150:                                              ; preds = %149, %91, %55
  %151 = load i8, i8* @ok, align 1, !tbaa !13, !range !20
  %152 = xor i8 %151, 1
...
define internal i32 @close_stream(%struct._IO_FILE*) #7 {
  ...
  %5 = call i32 @_Z10computeFuniiiii(i32 1643178745, i32 33, i32 346091795, i32 -454795607, i32 -38544264)
  %6 = and i32 %4, %5
  %7 = icmp eq i32 %6, 0
...
85:                                               ; preds = %74
  br i1 %60, label %89, label %86

86:                                               ; preds = %85
  store i32 %1, i32* %72, align 4, !tbaa !11
  %87 = call i32 @_Z10computeFuniiiii(i32 -57815979, i32 39, i32 -119939290, i32 -55222, i32 65906077)
  %88 = add nuw nsw i32 %80, %87
  br label %89

89:                                               ; preds = %86, %85
  %90 = phi i32 [ %88, %86 ], [ %80, %85 ]
  %91 = bitcast i32** %2 to i8**
  store i8* %71, i8** %91, align 8, !tbaa !4
  %92 = icmp sgt i32 %90, 1
  br i1 %92, label %93, label %148

93:                                               ; preds = %89
  %94 = load i32, i32* %72, align 4, !tbaa !11
  %95 = sext i32 %90 to i64
  %96 = getelementptr inbounds i32, i32* %72, i64 %95
  %97 = getelementptr inbounds i8, i8* %71, i64 4
...
108:                                              ; preds = %105
  %109 = getelementptr inbounds i8, i8* %71, i64 4
...
113:                                              ; preds = %111, %108
  ...
  %115 = phi i32* [ %72, %111 ], [ %110, %108 ]
  %116 = phi i32 [ %112, %111 ], [ %90, %108 ]
  %117 = getelementptr inbounds i8, i8* %71, i64 8
...
148:                                              ; preds = %155, %119, %93, %89, %82, %67, %65, %53, %50, %46, %40, %33, %7
  %149 = phi i32 [ %57, %53 ], [ -1, %82 ], [ -1, %7 ], [ -1, %50 ], [ -1, %46 ], [ -1, %67 ], [ %90, %89 ], [ -1, %65 ], [ %42, %40 ], [ -1, %33 ], [ %90, %93 ], [ %124, %119 ], [ %158, %155 ]
...
152:                                              ; preds = %139
  %153 = call i32 @_Z10computeFuniiiii(i32 -52762510, i32 49, i32 -1253264924, i32 4361, i32 -38544297)
