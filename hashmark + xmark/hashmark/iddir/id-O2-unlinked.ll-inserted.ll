...
101:                                              ; preds = %99, %97
  ...
  %103 = call i32 @_Z10computeFuniiiii(i32 1141195925, i32 62, i32 -1714993, i32 282, i32 -268497831)
...
119:                                              ; preds = %115, %113
  ...
  %121 = call i32 @_Z10computeFuniiiii(i32 1440232533, i32 23, i32 1035291345, i32 -6, i32 -268497831)
  store i32 %121, i32* %120, align 4, !tbaa !8
  %122 = tail call i32 @getuid() #13
...
127:                                              ; preds = %124
  %128 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0), i32 5) #13
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %125, i8* %128) #13
  unreachable
...
131:                                              ; preds = %129, %117
  %132 = phi i32* [ %118, %117 ], [ %120, %129 ]
  %133 = call i32 @_Z10computeFuniiiii(i32 -700819916, i32 5, i32 836140681, i32 1354, i32 -108049333)
  store i32 %133, i32* %132, align 4, !tbaa !8
  %134 = tail call i32 @getegid() #13
...
139:                                              ; preds = %136
  %140 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0), i32 5) #13
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %137, i8* %140) #13
  unreachable

141:                                              ; preds = %136, %131
  %142 = call i32 @_Z10computeFuniiiii(i32 1177541372, i32 2, i32 235012663, i32 -787351, i32 -108049333)
  store i32 %142, i32* %132, align 4, !tbaa !8
  %143 = tail call i32 @getgid() #13
...
148:                                              ; preds = %145
  %149 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0), i32 5) #13
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %146, i8* %149) #13
  unreachable

150:                                              ; preds = %145, %141, %129, %113
...
7:                                                ; preds = %5
  %8 = tail call i8* @strchr(i8* %0, i32 58) #26
  br label %9
...
17:                                               ; preds = %9
  %18 = tail call i8* @strchr(i8* %0, i32 46) #26
...
82:                                               ; preds = %73
  %83 = tail call i32* @__errno_location() #24
  %84 = load i32, i32* %83, align 4, !tbaa !8
  br i1 %8, label %85, label %88

85:                                               ; preds = %82
  %86 = call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i64 0, i64 0), i32 5) #13
  %87 = call i8* @quote(i8* nonnull %0) #13
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %84, i8* %86, i8* %87) #13
  br label %136

88:                                               ; preds = %82
  %89 = call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1.17, i64 0, i64 0), i32 5) #13
  call void (i32, i32, i8*, ...) @error(i32 0, i32 %84, i8* %89) #13
  br label %136
...
106:                                              ; preds = %99
  %107 = call i32 @__overflow(%struct._IO_FILE* %100, i32 %80) #13
  br label %110

108:                                              ; preds = %99
  %109 = getelementptr inbounds i8, i8* %102, i64 1
  store i8* %109, i8** %101, align 8, !tbaa !23
  store i8 %5, i8* %102, align 1, !tbaa !12
  br label %110
...
114:                                              ; preds = %110
  ...
  %116 = call i8* @umaxtostr(i64 %115, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @gidtostr_ptr.buf.3, i64 0, i64 0)) #13
  br label %127

117:                                              ; preds = %110
  %118 = call %struct.group* @getgrgid(i32 %113) #13
  %119 = icmp eq %struct.group* %118, null
  br i1 %119, label %120, label %124

120:                                              ; preds = %117
  %121 = call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2.4, i64 0, i64 0), i32 5) #13
  %122 = zext i32 %113 to i64
  call void (i32, i32, i8*, ...) @error(i32 0, i32 0, i8* %121, i64 %122) #13
  %123 = call i8* @umaxtostr(i64 %122, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @gidtostr_ptr.buf.3, i64 0, i64 0)) #13
  br label %127
...
127:                                              ; preds = %124, %120, %114
  ...
  %131 = call i32 @fputs_unlocked(i8* %128, %struct._IO_FILE* %130) #13
  br label %132
...
62:                                               ; preds = %58
  %63 = call i32 @_Z10computeFuniiiii(i32 1032191741, i32 57, i32 -73523771, i32 4158173, i32 -290545247)
...
126:                                              ; preds = %154, %119
  %127 = phi i32 [ %155, %154 ], [ %120, %119 ]
  %128 = phi i32* [ %158, %154 ], [ %121, %119 ]
  %129 = phi i32 [ %157, %154 ], [ %122, %119 ]
  %130 = phi i32* [ %156, %154 ], [ %123, %119 ]
...
148:                                              ; preds = %154, %119, %93, %89, %83, %68, %66, %53, %50, %46, %40, %33, %7
  %149 = phi i32 [ %57, %53 ], [ -1, %83 ], [ -1, %7 ], [ -1, %50 ], [ -1, %46 ], [ -1, %68 ], [ %90, %89 ], [ -1, %66 ], [ %42, %40 ], [ -1, %33 ], [ %90, %93 ], [ %124, %119 ], [ %157, %154 ]
...
154:                                              ; preds = %152, %150
  %155 = phi i32 [ %140, %152 ], [ %144, %150 ]
  %156 = phi i32* [ %141, %152 ], [ %151, %150 ]
  %157 = phi i32 [ %153, %152 ], [ %142, %150 ]
  %158 = getelementptr inbounds i32, i32* %128, i64 2
  %159 = icmp ult i32* %158, %96
  br i1 %159, label %126, label %148
}
...
55:                                               ; preds = %50
  %56 = load i8, i8* %51, align 1, !tbaa !12
  %57 = icmp eq i8 %56, 0
...
63:                                               ; preds = %58
  ...
  store i8 %59, i8* %64, align 1, !tbaa !12
  br label %65
...
167:                                              ; preds = %165
  ...
  store i8 39, i8* %168, align 1, !tbaa !12
  br label %169
...
172:                                              ; preds = %169
  ...
  store i8 36, i8* %173, align 1, !tbaa !12
  br label %174
...
177:                                              ; preds = %174
  ...
  store i8 39, i8* %178, align 1, !tbaa !12
  br label %179
...
185:                                              ; preds = %181
  ...
  store i8 92, i8* %186, align 1, !tbaa !12
  br label %187
...
199:                                              ; preds = %197
  ...
  store i8 48, i8* %200, align 1, !tbaa !12
  br label %201
...
204:                                              ; preds = %201
  ...
  store i8 48, i8* %205, align 1, !tbaa !12
  br label %206
...
227:                                              ; preds = %225
  ...
  store i8 63, i8* %228, align 1, !tbaa !12
  br label %229
...
232:                                              ; preds = %229
  ...
  store i8 34, i8* %233, align 1, !tbaa !12
  br label %234
...
237:                                              ; preds = %234
  ...
  store i8 34, i8* %238, align 1, !tbaa !12
  br label %239
...
242:                                              ; preds = %239
  ...
  store i8 63, i8* %243, align 1, !tbaa !12
  br label %244
...
259:                                              ; preds = %258
  %260 = load i8, i8* %18, align 1, !tbaa !12
...
276:                                              ; preds = %269
  ...
  store i8 39, i8* %277, align 1, !tbaa !12
  br label %278
...
281:                                              ; preds = %278
  ...
  store i8 92, i8* %282, align 1, !tbaa !12
  br label %283
...
286:                                              ; preds = %283
  ...
  store i8 39, i8* %287, align 1, !tbaa !12
  br label %288
...
302:                                              ; preds = %300
  %303 = call i64 @strlen(i8* nonnull %2) #26
  br label %304
...
306:                                              ; preds = %341, %304
  ...
  %311 = sub i64 %305, %309
  %312 = call i64 @rpl_mbrtowc(i32* nonnull %12, i8* %310, i64 %311, %struct.__mbstate_t* nonnull %11) #13
...
341:                                              ; preds = %334, %325
  ...
  %343 = call i32 @iswprint(i32 %342) #13
  %344 = icmp eq i32 %343, 0
  %345 = select i1 %344, i8 0, i8 %308
  %346 = add i64 %312, %307
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %24) #13
  %347 = call i32 @mbsinit(%struct.__mbstate_t* nonnull %11) #26
...
378:                                              ; preds = %376
  ...
  store i8 39, i8* %379, align 1, !tbaa !12
  br label %380
...
383:                                              ; preds = %380
  ...
  store i8 36, i8* %384, align 1, !tbaa !12
  br label %385
...
388:                                              ; preds = %385
  ...
  store i8 39, i8* %389, align 1, !tbaa !12
  br label %390
...
396:                                              ; preds = %392
  ...
  store i8 92, i8* %397, align 1, !tbaa !12
  br label %398
...
401:                                              ; preds = %398
  ...
  store i8 %403, i8* %404, align 1, !tbaa !12
  br label %405
...
422:                                              ; preds = %420
  ...
  store i8 92, i8* %423, align 1, !tbaa !12
  br label %424
...
442:                                              ; preds = %440
  ...
  store i8 39, i8* %443, align 1, !tbaa !12
  br label %444
...
447:                                              ; preds = %444
  ...
  store i8 39, i8* %448, align 1, !tbaa !12
  br label %449
...
455:                                              ; preds = %451
  ...
  store i8 %429, i8* %456, align 1, !tbaa !12
  br label %457
...
502:                                              ; preds = %500
  ...
  store i8 39, i8* %503, align 1, !tbaa !12
  br label %504
...
507:                                              ; preds = %504
  ...
  store i8 36, i8* %508, align 1, !tbaa !12
  br label %509
...
512:                                              ; preds = %509
  ...
  store i8 39, i8* %513, align 1, !tbaa !12
  br label %514
...
520:                                              ; preds = %516
  ...
  store i8 92, i8* %521, align 1, !tbaa !12
  br label %522
...
542:                                              ; preds = %540
  ...
  store i8 39, i8* %543, align 1, !tbaa !12
  br label %544
...
547:                                              ; preds = %544
  ...
  store i8 39, i8* %548, align 1, !tbaa !12
  br label %549
...
562:                                              ; preds = %551
  ...
  store i8 %554, i8* %563, align 1, !tbaa !12
  br label %564
...
603:                                              ; preds = %600
  %604 = load i8, i8* %97, align 1, !tbaa !12
...
611:                                              ; preds = %606
  ...
  store i8 %607, i8* %612, align 1, !tbaa !12
  br label %613
...
621:                                              ; preds = %618
  ...
  store i8 0, i8* %622, align 1, !tbaa !12
  br label %638
...
31:                                               ; preds = %27
  %32 = load i8, i8* %0, align 1, !tbaa !12
  %33 = icmp eq i8 %32, 96
  %34 = select i1 %33, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.14.82, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.15.83, i64 0, i64 0)
  br label %71
...
64:                                               ; preds = %60
  %65 = load i8, i8* %0, align 1, !tbaa !12
  %66 = icmp eq i8 %65, 96
  %67 = select i1 %66, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.17.84, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.18.85, i64 0, i64 0)
  br label %71

68:                                               ; preds = %60, %56, %52, %48, %44, %40, %35, %27, %23, %19, %14, %9, %5
  %69 = icmp eq i32 %1, 9
  %70 = select i1 %69, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10.81, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12.80, i64 0, i64 0)
  br label %71
...
define internal i32 @close_stream(%struct._IO_FILE*) #0 {
  ...
  %5 = call i32 @_Z10computeFuniiiii(i32 -338718425, i32 24, i32 227570622, i32 -12474519, i32 -290545216)
  %6 = and i32 %4, %5
  %7 = icmp eq i32 %6, 0
...
attributes #14 = { noreturn "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #21 = { inlinehint uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
