...
103:                                              ; preds = %101, %99
  ...
  %106 = tail call i32 @geteuid() #17
  store i32 %106, i32* @euid, align 4, !tbaa !11
  %107 = icmp eq i32 %106, -1
  br i1 %107, label %108, label %113

108:                                              ; preds = %103
  %109 = load i32, i32* %104, align 4, !tbaa !11
  %110 = icmp eq i32 %109, 0
  br i1 %110, label %113, label %111

111:                                              ; preds = %108
  %112 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.23, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %109, i8* %112) #17
  unreachable
...
119:                                              ; preds = %117, %115
  %120 = tail call i32* @__errno_location() #22
...
127:                                              ; preds = %124
  %128 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.24, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %125, i8* %128) #17
  unreachable
...
131:                                              ; preds = %129, %117
  %132 = tail call i32* @__errno_location() #22
...
139:                                              ; preds = %136
  %140 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.25, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %137, i8* %140) #17
  unreachable
...
148:                                              ; preds = %145
  %149 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.26, i64 0, i64 0), i32 5) #17
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %146, i8* %149) #17
  unreachable
...
77:                                               ; preds = %74
  %78 = load i32, i32* %55, align 4, !tbaa !11
...
82:                                               ; preds = %96, %77
  ...
  %86 = load i32, i32* %83, align 4, !tbaa !11
  %87 = icmp eq i32 %86, %78
  br i1 %87, label %91, label %88

88:                                               ; preds = %82
  %89 = load i32, i32* %85, align 4, !tbaa !11
...
94:                                               ; preds = %88
  ...
  store i32 %86, i32* %95, align 4, !tbaa !11
  br label %96
