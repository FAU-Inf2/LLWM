...
define dso_local i32 @recursion_fib(i32) local_unnamed_addr #3 !dbg !28 {
  ...
  br i1 %2, label %33, label %3, !dbg !34

3:                                                ; preds = %31, %1
  %4 = phi i32 [ %9, %31 ], [ %0, %1 ]
  %5 = phi i32 [ %10, %31 ], [ 1, %1 ]
  call void @llvm.dbg.value(metadata i32 %4, metadata !32, metadata !DIExpression()), !dbg !33
  %6 = call i32 @_Z10computeFuniiiii(i32 -1054973969, i32 3, i32 2010915689, i32 1085704401, i32 210922040)
  %7 = add nsw i32 %4, %6, !dbg !35
  %8 = tail call i32 @recursion_fib(i32 %7), !dbg !36
  %9 = add nsw i32 %4, -2, !dbg !37
  %10 = add nsw i32 %8, %5, !dbg !38
  %11 = mul i32 %4, -4
  %12 = add i32 %11, -5
  %13 = call i32 @_Z10computeFuniiiii(i32 1085964805, i32 4, i32 1573096527, i32 6821286, i32 -163128764)
  %14 = mul i32 %4, %13
  %15 = call i32 @_Z10computeFuniiiii(i32 -857031441, i32 50, i32 532878183, i32 2625459, i32 -163128761)
  %16 = add i32 %14, %15
  %17 = mul i32 %8, -5
  %18 = call i32 @_Z10computeFuniiiii(i32 -1025854435, i32 10, i32 -1976305549, i32 361901467, i32 210922039)
  %19 = add i32 %17, %18
  %20 = mul i32 %12, %12
  %21 = mul i32 %20, %20
  %22 = mul i32 %16, %16
...
31:                                               ; preds = %3
  ...
  %32 = icmp ult i32 %9, 2, !dbg !34
  br i1 %32, label %33, label %3, !dbg !34

33:                                               ; preds = %31, %1
  %34 = phi i32 [ 1, %1 ], [ %10, %31 ]
  ret i32 %34, !dbg !39
}
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 !dbg !51 {
  ...
  %5 = call i32 @_Z10computeFuniiiii(i32 -1002455170, i32 5, i32 1047349563, i32 356, i32 -17765404)
  %6 = mul i32 %5, 5
  %7 = add i32 %6, 2
  %8 = mul i32 %7, %7
  %9 = sub i32 %8, %7
  %10 = srem i32 %9, 2
  %11 = call i32 @_Z10computeFuniiiii(i32 -218921463, i32 50, i32 1748350628, i32 461514, i32 -17765425)
  %12 = mul i32 %10, %11
  %13 = add i32 %12, 1
  %14 = icmp ne i32 %13, 1
...
16:                                               ; preds = %2
  %17 = load volatile i32, i32* %3, align 4, !dbg !64, !tbaa !21
  store i32 %17, i32* @recursion_input, align 4, !dbg !65, !tbaa !21
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4), !dbg !66
  %18 = tail call i32 @recursion_fib(i32 %17) #17, !dbg !67
