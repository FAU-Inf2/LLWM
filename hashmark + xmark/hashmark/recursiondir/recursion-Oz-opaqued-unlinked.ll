...
2:                                                ; preds = %19, %1
  ...
  br i1 %5, label %21, label %6, !dbg !35
...
define dso_local void @recursion_main() local_unnamed_addr #5 !dbg !47 {
  ...
  %3 = call i32 @_Z10computeFuniiiii(i32 -542809162, i32 29, i32 2003673516, i32 178898639, i32 -667227686)
  %4 = mul i32 %1, %3
  %5 = add i32 %4, -5
  %6 = add i32 %2, -5
  %7 = mul i32 %5, %5
  %8 = mul i32 %7, 7
  %9 = call i32 @_Z10computeFuniiiii(i32 -455358855, i32 9, i32 1189031555, i32 3798979, i32 -500765865)
  %10 = sub i32 %8, %9
  %11 = mul i32 %6, %6
  %12 = sub i32 %10, %11
  %13 = mul i32 %12, 2
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 !dbg !52 {
  ...
  %7 = call i32 @_Z10computeFuniiiii(i32 -1498883416, i32 34, i32 -595052200, i32 45601795, i32 -569006992)
  %8 = add i32 %7, 5
  %9 = mul i32 %6, -3
  %10 = add i32 %9, -4
  %11 = mul i32 %8, %8
  ...
  %13 = add i32 %11, %12
  %14 = mul i32 %8, %10
  %15 = call i32 @_Z10computeFuniiiii(i32 385177059, i32 16, i32 70075257, i32 426185, i32 -569007016)
  %16 = mul i32 %14, %15
  %17 = sub i32 %13, %16
  %18 = call i32 @_Z10computeFuniiiii(i32 1163694129, i32 7, i32 1446109278, i32 -178898639, i32 -667227692)
  %19 = mul i32 %17, %18
  %20 = call i32 @_Z10computeFuniiiii(i32 -1449349121, i32 45, i32 -842524093, i32 -495519, i32 -500765863)
  %21 = add i32 %19, %20
  %22 = icmp eq i32 %21, 5
...
24:                                               ; preds = %2
  %25 = icmp ne i32 %6, 89, !dbg !71
  %26 = zext i1 %25 to i32, !dbg !71
  ret i32 %26, !dbg !72
}
