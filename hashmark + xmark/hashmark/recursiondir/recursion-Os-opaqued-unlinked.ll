...
3:                                                ; preds = %24, %1
  ...
  %11 = add i32 %10, -3
  %12 = mul i32 %7, 4
  %13 = call i32 @_Z10computeFuniiiii(i32 1751768538, i32 6, i32 1190998328, i32 565570358, i32 382981251)
  %14 = add i32 %12, %13
  %15 = mul i32 %11, %11
  %16 = mul i32 %15, 7
  %17 = sub i32 %16, 1
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 !dbg !51 {
  ...
  %5 = call i32 @_Z10computeFuniiiii(i32 -1368646831, i32 15, i32 244087308, i32 1665772, i32 -91845273)
  store volatile i32 %5, i32* %3, align 4, !dbg !60, !tbaa !21
  %6 = load volatile i32, i32* %3, align 4, !dbg !64, !tbaa !21
  store i32 %6, i32* @recursion_input, align 4, !dbg !65, !tbaa !21
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4), !dbg !66
  %7 = tail call i32 @recursion_fib(i32 %6) #7, !dbg !67
  store i32 %7, i32* @recursion_result, align 4, !dbg !69, !tbaa !21
  %8 = call i32 @_Z10computeFuniiiii(i32 2034222338, i32 43, i32 1188461588, i32 -164078542, i32 -91845297)
  %9 = mul i32 %6, %8
  %10 = add i32 %9, -5
  %11 = mul i32 %7, -4
  %12 = call i32 @_Z10computeFuniiiii(i32 -1879688253, i32 55, i32 -1609273551, i32 1, i32 -471372989)
  %13 = add i32 %11, %12
  %14 = mul i32 %10, %10
  %15 = mul i32 %13, %13
  %16 = add i32 %14, %15
  %17 = mul i32 %10, %13
  %18 = call i32 @_Z10computeFuniiiii(i32 -1566814642, i32 17, i32 547486939, i32 1039, i32 -471372982)
  %19 = mul i32 %17, %18
  %20 = sub i32 %16, %19
  %21 = call i32 @_Z10computeFuniiiii(i32 434878757, i32 6, i32 1173588598, i32 2, i32 382981252)
  %22 = mul i32 %20, %21
  %23 = add i32 %22, -4
  %24 = icmp ne i32 %23, -7
