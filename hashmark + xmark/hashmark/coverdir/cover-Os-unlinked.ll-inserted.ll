...
6:                                                ; preds = %5, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2
  ...
  %8 = add nsw i32 %4, %7
  %9 = call i32 @_Z10computeFuniiiii(i32 -1455918489, i32 45, i32 -274281746, i32 569590789, i32 49377779)
  %10 = add nuw nsw i32 %3, %9
  br label %2

11:                                               ; preds = %2
  %12 = call i32 @_Z10computeFuniiiii(i32 1414454191, i32 14, i32 -1441743105, i32 544981539, i32 73987029)
  %13 = add nsw i32 %4, %12
  ret i32 %13
}
...
6:                                                ; preds = %5, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2, %2
  ...
  %8 = add nsw i32 %4, %7
  %9 = call i32 @_Z10computeFuniiiii(i32 -1411865400, i32 18, i32 -1391786137, i32 1, i32 -9371471)
  %10 = add nuw nsw i32 %3, %9
  br label %2
...
define dso_local void @cover_main() local_unnamed_addr #0 {
  %1 = load volatile i32, i32* @cover_cnt, align 4, !tbaa !2
  %2 = call i32 @_Z10computeFuniiiii(i32 -367270926, i32 5, i32 -1030794367, i32 1847, i32 49377788)
  %3 = add i32 %1, %2
  store volatile i32 %3, i32* @cover_cnt, align 4, !tbaa !2
  %4 = load volatile i32, i32* @cover_cnt, align 4, !tbaa !2
  %5 = tail call i32 @cover_swi50(i32 %4) #16
  store volatile i32 %5, i32* @cover_cnt, align 4, !tbaa !2
  %6 = load volatile i32, i32* @cover_cnt, align 4, !tbaa !2
  %7 = tail call i32 @cover_swi120(i32 %6) #16
  store volatile i32 %7, i32* @cover_cnt, align 4, !tbaa !2
  ret void
}

; Function Attrs: nofree norecurse nounwind optsize uwtable
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  %3 = call i32 @_Z10computeFuniiiii(i32 -331720742, i32 49, i32 -495088837, i32 628340039, i32 -9371472)
  store volatile i32 %3, i32* @cover_cnt, align 4, !tbaa !2
  tail call void @cover_main() #16
  %4 = load volatile i32, i32* @cover_cnt, align 4, !tbaa !2
  %5 = call i32 @_Z10computeFuniiiii(i32 512563612, i32 59, i32 -442077, i32 6249, i32 73986848)
  %6 = add nsw i32 %4, %5
  ret i32 %6
}
