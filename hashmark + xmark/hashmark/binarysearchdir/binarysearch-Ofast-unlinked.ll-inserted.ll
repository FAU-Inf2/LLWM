...
3:                                                ; preds = %3, %2
  %4 = phi i64 [ 0, %2 ], [ %21, %3 ]
  %5 = load volatile i32, i32* @binarysearch_seed, align 4, !tbaa !2
  %6 = call i32 @_Z10computeFuniiiii(i32 -2013101111, i32 21, i32 1021089747, i32 13066028, i32 631035067)
  %7 = mul nsw i32 %5, %6
  %8 = add nsw i32 %7, 81
  %9 = call i32 @_Z10computeFuniiiii(i32 -696434440, i32 42, i32 -2000924566, i32 1852199332, i32 -763845323)
  %10 = srem i32 %8, %9
  ...
  %13 = load volatile i32, i32* @binarysearch_seed, align 4, !tbaa !2
  %14 = call i32 @_Z10computeFuniiiii(i32 771900785, i32 11, i32 459765512, i32 2, i32 -763853285)
  %15 = mul nsw i32 %13, %14
  %16 = call i32 @_Z10computeFuniiiii(i32 -400232199, i32 16, i32 -1586846662, i32 6533014, i32 631035015)
...
23:                                               ; preds = %35, %3
  %24 = phi i32 [ %42, %35 ], [ 0, %3 ]
  %25 = phi i32 [ %41, %35 ], [ 14, %3 ]
  %26 = add nsw i32 %25, %24
  %27 = ashr i32 %26, 1
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds [15 x %struct.binarysearch_DATA], [15 x %struct.binarysearch_DATA]* @binarysearch_data, i64 0, i64 %28, i32 0
  %30 = load i32, i32* %29, align 8, !tbaa !6
  %31 = icmp eq i32 %30, 8
  br i1 %31, label %32, label %35

32:                                               ; preds = %23
  %33 = getelementptr inbounds [15 x %struct.binarysearch_DATA], [15 x %struct.binarysearch_DATA]* @binarysearch_data, i64 0, i64 %28, i32 1
  %34 = load i32, i32* %33, align 4, !tbaa !8
  br label %44

35:                                               ; preds = %23
  %36 = icmp sgt i32 %30, 8
  %37 = call i32 @_Z10computeFuniiiii(i32 467415903, i32 39, i32 -719263670, i32 19688002, i32 -722950271)
  %38 = add nsw i32 %27, %37
  %39 = call i32 @_Z10computeFuniiiii(i32 -735919646, i32 60, i32 39359104, i32 46, i32 -722950269)
  %40 = add nsw i32 %27, %39
  %41 = select i1 %36, i32 %38, i32 %25
  %42 = select i1 %36, i32 %24, i32 %40
  %43 = icmp sgt i32 %42, %41
  br i1 %43, label %44, label %23

44:                                               ; preds = %35, %32
  %45 = phi i32 [ %34, %32 ], [ -1, %35 ]
...
64:                                               ; preds = %61, %33
  ...
  %69 = add i32 %68, %67
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %20) #15
  %70 = load i8*, i8** %15, align 8, !tbaa !12
...
76:                                               ; preds = %57, %53
  ...
  %79 = load i8*, i8** %15, align 8, !tbaa !12
...
22:                                               ; preds = %1
  %23 = landingpad { i8*, i32 }
          cleanup
  %24 = load i8*, i8** %19, align 8, !tbaa !35
  %25 = load i64, i64* %12, align 8, !tbaa !31
  %26 = icmp eq i8* %18, %24
...
30:                                               ; preds = %27
  %31 = load i8, i8* %11, align 1, !tbaa !34, !range !36
  %32 = icmp eq i8 %31, 0
...
35:                                               ; preds = %30
  ...
  %36 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %25, i32* nonnull %20) #15, !srcloc !37
  ...
  %40 = load i64, i64* %6, align 8, !tbaa !24
...
46:                                               ; preds = %43
  %47 = load i8, i8* %5, align 1, !tbaa !29, !range !36
  %48 = icmp eq i8 %47, 0
...
51:                                               ; preds = %46
  ...
  %53 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %40, i32* %52) #15, !srcloc !37
  resume { i8*, i32 } %23
}
...
define linkonce_odr dso_local void @_ZN9__gnu_cxx12__to_xstringINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEcEET_PFiPT0_mPKS8_P13__va_list_tagEmSB_z(%"class.std::__cxx11::basic_string"* noalias sret, i32 (i8*, i64, i8*, %struct.__va_list_tag*)*, i64, i8*, ...) local_unnamed_addr #2 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store %union.anon* %12, %union.anon** %13, align 8, !tbaa !38
...
26:                                               ; preds = %23
  %27 = load i8, i8* %7, align 16, !tbaa !19
...
29:                                               ; preds = %28, %26, %23
  %30 = load i64, i64* %5, align 8, !tbaa !39
...
define linkonce_odr dso_local void @_ZN8CryptoPP31IteratedHashWithStaticTransformIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ELj32ENS_6SHA256ELj32ELb1EED2Ev(%"class.CryptoPP::IteratedHashWithStaticTransform"*) unnamed_addr #7 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
...
18:                                               ; preds = %15
  ...
  %20 = load i8, i8* %19, align 1, !tbaa !34, !range !36
  %21 = icmp eq i8 %20, 0
...
24:                                               ; preds = %18
  store i8 0, i8* %19, align 1, !tbaa !34
  %25 = bitcast i8* %6 to i32*
  %26 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %8, i32* %25) #15, !srcloc !37
...
38:                                               ; preds = %35
  ...
  %40 = load i8, i8* %39, align 1, !tbaa !29, !range !36
  %41 = icmp eq i8 %40, 0
...
44:                                               ; preds = %38
  ...
  %46 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %32, i32* %45) #15, !srcloc !37
  ret void
}
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP12IteratedHashIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ENS_18HashTransformationEED2Ev(%"class.CryptoPP::IteratedHash"*) unnamed_addr #7 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
...
14:                                               ; preds = %11
  ...
  %16 = load i8, i8* %15, align 1, !tbaa !29, !range !36
  %17 = icmp eq i8 %16, 0
...
20:                                               ; preds = %14
  store i8 0, i8* %15, align 1, !tbaa !29
  %21 = bitcast i8* %6 to i32*
  %22 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %8, i32* %21) #15, !srcloc !37
  ret void
}
...
define linkonce_odr dso_local %"class.CryptoPP::Clonable"* @_ZNK8CryptoPP8Clonable5CloneEv(%"class.CryptoPP::Clonable"*) unnamed_addr #2 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store i64 31, i64* %3, align 8, !tbaa !39
...
12:                                               ; preds = %1
  ...
  %14 = load i64, i64* %3, align 8, !tbaa !39
  ...
  %17 = load i8*, i8** %13, align 8, !tbaa !12
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTVN8CryptoPP9ExceptionE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %20, align 8, !tbaa !9
  %21 = getelementptr inbounds i8, i8* %5, i64 8
  %22 = bitcast i8* %21 to i32*
  store i32 0, i32* %22, align 8, !tbaa !40
  ...
  %28 = load i64, i64* %16, align 8, !tbaa !18
...
34:                                               ; preds = %12
  ...
  store i64 %28, i64* %2, align 8, !tbaa !39
...
39:                                               ; preds = %37
  store i8* %38, i8** %26, align 8, !tbaa !12
  %40 = load i64, i64* %2, align 8, !tbaa !39
...
44:                                               ; preds = %42
  %45 = load i8, i8* %27, align 1, !tbaa !19
...
49:                                               ; preds = %46, %44, %42
  %50 = load i64, i64* %2, align 8, !tbaa !39
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTVN8CryptoPP14NotImplementedE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %20, align 8, !tbaa !9
...
61:                                               ; preds = %59, %47
  ...
  %66 = load i8*, i8** %13, align 8, !tbaa !12
  %67 = icmp eq i8* %66, %9
...
define linkonce_odr dso_local i32 @_ZNK8CryptoPP12IteratedHashIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ENS_18HashTransformationEE9BlockSizeEv(%"class.CryptoPP::IteratedHash"*) unnamed_addr #9 comdat align 2 {
  ret i32 64
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local i32 @_ZNK8CryptoPP16IteratedHashBaseIjNS_18HashTransformationEE20OptimalDataAlignmentEv(%"class.CryptoPP::IteratedHashBase"*) unnamed_addr #9 comdat align 2 {
  ret i32 1
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP9ExceptionD2Ev(%"class.CryptoPP::Exception"*) unnamed_addr #9 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP14NotImplementedD0Ev(%"class.CryptoPP::NotImplemented"*) unnamed_addr #7 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local i8* @_ZNK8CryptoPP9Exception4whatEv(%"class.CryptoPP::Exception"*) unnamed_addr #9 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP9ExceptionD0Ev(%"class.CryptoPP::Exception"*) unnamed_addr #9 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
  %2 = getelementptr inbounds %"class.CryptoPP::Exception", %"class.CryptoPP::Exception"* %0, i64 0, i32 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTVN8CryptoPP9ExceptionE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %2, align 8, !tbaa !9
  %3 = getelementptr inbounds %"class.CryptoPP::Exception", %"class.CryptoPP::Exception"* %0, i64 0, i32 2, i32 0, i32 0
  %4 = load i8*, i8** %3, align 8, !tbaa !12
...
5:                                                ; preds = %1
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [27 x i8*] }, { [27 x i8*] }* @_ZTVN8CryptoPP6SHA256E, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %6, align 8, !tbaa !9
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local i32 @_ZNK8CryptoPP31IteratedHashWithStaticTransformIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ELj32ENS_6SHA256ELj32ELb1EE10DigestSizeEv(%"class.CryptoPP::IteratedHashWithStaticTransform"*) unnamed_addr #9 comdat align 2 {
  ret i32 32
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local i32* @_ZN8CryptoPP31IteratedHashWithStaticTransformIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ELj32ENS_6SHA256ELj32ELb1EE8StateBufEv(%"class.CryptoPP::IteratedHashWithStaticTransform"*) unnamed_addr #9 comdat align 2 {
  %2 = getelementptr inbounds %"class.CryptoPP::IteratedHashWithStaticTransform", %"class.CryptoPP::IteratedHashWithStaticTransform"* %0, i64 0, i32 1, i32 0, i32 0, i32 2
  %3 = load i32*, i32** %2, align 8, !tbaa !35
  ret i32* %3
}
...
39:                                               ; preds = %35
  ...
  %44 = load i64, i64* %11, align 8, !tbaa !24
...
50:                                               ; preds = %47
  %51 = load i8, i8* %10, align 1, !tbaa !29, !range !36
  %52 = icmp eq i8 %51, 0
...
55:                                               ; preds = %50
  ...
  %57 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %44, i32* %56) #15, !srcloc !37
  resume { i8*, i32 } %40
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP8ClonableD2Ev(%"class.CryptoPP::Clonable"*) unnamed_addr #9 comdat align 2 {
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local i32 @_ZNK8CryptoPP18HashTransformation9BlockSizeEv(%"class.CryptoPP::HashTransformation"*) unnamed_addr #9 comdat align 2 {
  ret i32 0
}
...
attributes #2 = { uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-jump-tables"="false" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
...
attributes #6 = { nobuiltin nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
attributes #7 = { inlinehint nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-jump-tables"="false" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
attributes #8 = { noreturn nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
