...
24:                                               ; preds = %18
  ...
  %26 = tail call i32 @strncmp(i8* %16, i8* nonnull %25, i64 32) #24
  %27 = icmp eq i32 %26, 0
...
41:                                               ; preds = %39
  ...
  %43 = load i16, i16* %42, align 4, !tbaa !16
  %44 = icmp eq i16 %43, 1
...
48:                                               ; preds = %46
  ...
  %50 = load i16, i16* %49, align 4, !tbaa !16
  %51 = icmp eq i16 %50, 2
...
55:                                               ; preds = %53
  ...
  %57 = load i16, i16* %56, align 4, !tbaa !16
  %58 = icmp eq i16 %57, 3
...
62:                                               ; preds = %60
  ...
  %64 = load i16, i16* %63, align 4, !tbaa !16
  %65 = icmp eq i16 %64, 5
...
81:                                               ; preds = %80, %76, %74, %73, %66, %59, %52, %45, %38, %24
  ...
  %83 = load i16, i16* %82, align 4, !tbaa !16
  %84 = icmp eq i16 %83, 2
...
8:                                                ; preds = %1
  %9 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.84, i64 0, i64 0), i32 5) #22
  %10 = tail call i64 @strlen(i8* %9) #24
  %11 = add i64 %10, 3
  %12 = tail call noalias i8* @xmalloc(i64 %11) #22
...
13:                                               ; preds = %8, %1
  ...
  %16 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.84, i64 0, i64 0), i32 5) #22
  %17 = call i32 @_Z10computeFuniiiii(i32 -19949637, i32 40, i32 -1451648453, i32 471190, i32 -604519482)
  %18 = and i32 %3, %17
  %19 = tail call i32 (i8*, i32, i64, i8*, ...) @__sprintf_chk(i8* %14, i32 1, i64 %15, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.85, i64 0, i64 0), i8* %16, i32 %18) #22
  %20 = load i8*, i8** @print_runlevel.comment, align 8, !tbaa !4
  %21 = icmp eq i8* %20, null
  br i1 %21, label %22, label %27

22:                                               ; preds = %13
  %23 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.86, i64 0, i64 0), i32 5) #22
  %24 = tail call i64 @strlen(i8* %23) #24
  %25 = add i64 %24, 2
  %26 = tail call noalias i8* @xmalloc(i64 %25) #22
...
27:                                               ; preds = %22, %13
  ...
  %30 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.86, i64 0, i64 0), i32 5) #22
  ...
  %35 = tail call i32 (i8*, i32, i64, i8*, ...) @__sprintf_chk(i8* %28, i32 1, i64 %29, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.87, i64 0, i64 0), i8* %30, i32 %34) #22
...
4:                                                ; preds = %0
  %5 = load i8, i8* @ignore_EPIPE, align 1, !tbaa !32, !range !34
  %6 = icmp eq i8 %5, 0
...
11:                                               ; preds = %7, %4
  %12 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.102, i64 0, i64 0), i32 5) #22
...
17:                                               ; preds = %11
  %18 = tail call i8* @quotearg_colon(i8* nonnull %13) #22
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %16, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.103, i64 0, i64 0), i8* %18, i8* %12) #22
  br label %20

19:                                               ; preds = %11
  tail call void (i32, i32, i8*, ...) @error(i32 0, i32 %16, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2.104, i64 0, i64 0), i8* %12) #22
  br label %20
...
22:                                               ; preds = %7, %0
  ...
  %24 = tail call i32 @close_stream(%struct._IO_FILE* %23) #22
  %25 = icmp eq i32 %24, 0
...
26:                                               ; preds = %22
  %27 = tail call i32 @kill(i32 %24, i32 0) #22
  %28 = icmp slt i32 %27, 0
  br i1 %28, label %29, label %33

29:                                               ; preds = %26
  %30 = tail call i32* @__errno_location() #26
