...
61:                                               ; preds = %50
  ...
  %64 = call i32 @_Z10computeFuniiiii(i32 1008412962, i32 20, i32 188055650, i32 -866371, i32 487335249)
  %65 = and i32 %63, %64
  %66 = icmp eq i32 %65, 0
...
67:                                               ; preds = %61
  ...
  call void @llvm.lifetime.start.p0i8(i64 390, i8* nonnull %68) #14
  %69 = call i32 @uname(%struct.utsname* nonnull %3) #14
  %70 = icmp eq i32 %69, -1
...
71:                                               ; preds = %67
  ...
  %74 = tail call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.12, i64 0, i64 0), i32 5) #14
  tail call void (i32, i32, i8*, ...) @error(i32 1, i32 %73, i8* %74) #14
  unreachable
...
80:                                               ; preds = %78
  %81 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  ...
  br i1 %86, label %89, label %87, !prof !18

87:                                               ; preds = %80
  %88 = tail call i32 @__overflow(%struct._IO_FILE* %81, i32 32) #14
  br label %91

89:                                               ; preds = %80
  %90 = getelementptr inbounds i8, i8* %83, i64 1
  store i8* %90, i8** %82, align 8, !tbaa !13
  store i8 32, i8* %83, align 1, !tbaa !19
  br label %91

91:                                               ; preds = %89, %87, %78
  store i1 true, i1* @print_element.printed, align 1
  %92 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %93 = call i32 @fputs_unlocked(i8* nonnull %68, %struct._IO_FILE* %92) #14
  br label %94

94:                                               ; preds = %91, %75
  %95 = call i32 @_Z10computeFuniiiii(i32 792983287, i32 13, i32 790642348, i32 2277, i32 487335220)
  %96 = and i32 %63, %95
  %97 = icmp eq i32 %96, 0
...
108:                                              ; preds = %101
  %109 = tail call i32 @__overflow(%struct._IO_FILE* %102, i32 32) #14
  br label %112

110:                                              ; preds = %101
  %111 = getelementptr inbounds i8, i8* %104, i64 1
  store i8* %111, i8** %103, align 8, !tbaa !13
  store i8 32, i8* %104, align 1, !tbaa !19
  br label %112

112:                                              ; preds = %110, %108, %98
  store i1 true, i1* @print_element.printed, align 1
  %113 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %114 = call i32 @fputs_unlocked(i8* nonnull %99, %struct._IO_FILE* %113) #14
  br label %115
...
121:                                              ; preds = %118
  ...
  br i1 %127, label %130, label %128, !prof !18

128:                                              ; preds = %121
  %129 = tail call i32 @__overflow(%struct._IO_FILE* %122, i32 32) #14
  br label %132

130:                                              ; preds = %121
  %131 = getelementptr inbounds i8, i8* %124, i64 1
  store i8* %131, i8** %123, align 8, !tbaa !13
  store i8 32, i8* %124, align 1, !tbaa !19
  br label %132

132:                                              ; preds = %130, %128, %118
  store i1 true, i1* @print_element.printed, align 1
  %133 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %134 = call i32 @fputs_unlocked(i8* nonnull %119, %struct._IO_FILE* %133) #14
  br label %135

135:                                              ; preds = %132, %115
  %136 = call i32 @_Z10computeFuniiiii(i32 908961130, i32 52, i32 1063572368, i32 3, i32 -376421780)
  %137 = and i32 %63, %136
...
142:                                              ; preds = %139
  ...
  br i1 %148, label %151, label %149, !prof !18

149:                                              ; preds = %142
  %150 = tail call i32 @__overflow(%struct._IO_FILE* %143, i32 32) #14
  br label %153

151:                                              ; preds = %142
  %152 = getelementptr inbounds i8, i8* %145, i64 1
  store i8* %152, i8** %144, align 8, !tbaa !13
  store i8 32, i8* %145, align 1, !tbaa !19
  br label %153

153:                                              ; preds = %151, %149, %139
  store i1 true, i1* @print_element.printed, align 1
  %154 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %155 = call i32 @fputs_unlocked(i8* nonnull %140, %struct._IO_FILE* %154) #14
  br label %156

156:                                              ; preds = %153, %135
  %157 = call i32 @_Z10computeFuniiiii(i32 -1882477655, i32 24, i32 2090459447, i32 748829, i32 -376421772)
  %158 = and i32 %63, %157
  %159 = icmp eq i32 %158, 0
  br i1 %159, label %177, label %160

160:                                              ; preds = %156
  %161 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 4, i64 0
  %162 = load i1, i1* @print_element.printed, align 1
  br i1 %162, label %163, label %174

163:                                              ; preds = %160
  %164 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  ...
  br i1 %169, label %172, label %170, !prof !18

170:                                              ; preds = %163
  %171 = tail call i32 @__overflow(%struct._IO_FILE* %164, i32 32) #14
  br label %174

172:                                              ; preds = %163
  %173 = getelementptr inbounds i8, i8* %166, i64 1
  store i8* %173, i8** %165, align 8, !tbaa !13
  store i8 32, i8* %166, align 1, !tbaa !19
  br label %174

174:                                              ; preds = %172, %170, %160
  store i1 true, i1* @print_element.printed, align 1
  %175 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %176 = call i32 @fputs_unlocked(i8* nonnull %161, %struct._IO_FILE* %175) #14
  br label %177

177:                                              ; preds = %174, %156
  call void @llvm.lifetime.end.p0i8(i64 390, i8* nonnull %68) #14
  br label %178
...
185:                                              ; preds = %183
  ...
  br i1 %191, label %194, label %192, !prof !18

192:                                              ; preds = %185
  %193 = tail call i32 @__overflow(%struct._IO_FILE* %186, i32 32) #14
  br label %196

194:                                              ; preds = %185
  %195 = getelementptr inbounds i8, i8* %188, i64 1
  store i8* %195, i8** %187, align 8, !tbaa !13
  store i8 32, i8* %188, align 1, !tbaa !19
  br label %196

196:                                              ; preds = %194, %192, %183
  store i1 true, i1* @print_element.printed, align 1
  %197 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %198 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @main.unknown, i64 0, i64 0), %struct._IO_FILE* %197) #14
  br label %199

199:                                              ; preds = %196, %178
  %200 = call i32 @_Z10computeFuniiiii(i32 1983269484, i32 36, i32 1876785734, i32 294634783, i32 -345315892)
  %201 = and i32 %63, %200
...
206:                                              ; preds = %204
  ...
  br i1 %212, label %215, label %213, !prof !18

213:                                              ; preds = %206
  %214 = tail call i32 @__overflow(%struct._IO_FILE* %207, i32 32) #14
  br label %217

215:                                              ; preds = %206
  %216 = getelementptr inbounds i8, i8* %209, i64 1
  store i8* %216, i8** %208, align 8, !tbaa !13
  store i8 32, i8* %209, align 1, !tbaa !19
  br label %217

217:                                              ; preds = %215, %213, %204
  store i1 true, i1* @print_element.printed, align 1
  %218 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %219 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @main.unknown, i64 0, i64 0), %struct._IO_FILE* %218) #14
  br label %220
...
225:                                              ; preds = %223
  ...
  br i1 %231, label %234, label %232, !prof !18

232:                                              ; preds = %225
  %233 = tail call i32 @__overflow(%struct._IO_FILE* %226, i32 32) #14
  br label %236

234:                                              ; preds = %225
  %235 = getelementptr inbounds i8, i8* %228, i64 1
  store i8* %235, i8** %227, align 8, !tbaa !13
  store i8 32, i8* %228, align 1, !tbaa !19
  br label %236

236:                                              ; preds = %234, %232, %223
  store i1 true, i1* @print_element.printed, align 1
  %237 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %238 = tail call i32 @fputs_unlocked(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), %struct._IO_FILE* %237) #14
  br label %239
...
239:                                              ; preds = %236, %220
  ...
  br i1 %245, label %248, label %246, !prof !18

246:                                              ; preds = %239
  %247 = tail call i32 @__overflow(%struct._IO_FILE* %240, i32 10) #14
  br label %250

248:                                              ; preds = %239
  %249 = getelementptr inbounds i8, i8* %242, i64 1
  store i8* %249, i8** %241, align 8, !tbaa !13
  store i8 10, i8* %242, align 1, !tbaa !19
  br label %250
...
define internal i32 @close_stream(%struct._IO_FILE*) #7 {
  ...
  %5 = call i32 @_Z10computeFuniiiii(i32 -1967961535, i32 37, i32 522841689, i32 1, i32 -345315924)
  %6 = and i32 %4, %5
  %7 = icmp eq i32 %6, 0
