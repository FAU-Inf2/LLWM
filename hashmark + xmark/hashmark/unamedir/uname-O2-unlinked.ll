...
169:                                              ; preds = %162
  %170 = tail call i32 @__overflow(%struct._IO_FILE* %163, i32 32) #14
  br label %173

171:                                              ; preds = %162
  %172 = getelementptr inbounds i8, i8* %165, i64 1
  store i8* %172, i8** %164, align 8, !tbaa !13
  store i8 32, i8* %165, align 1, !tbaa !19
  br label %173

173:                                              ; preds = %171, %169, %159
  store i1 true, i1* @print_element.printed, align 1
  %174 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %175 = call i32 @fputs_unlocked(i8* nonnull %160, %struct._IO_FILE* %174) #14
  br label %176
