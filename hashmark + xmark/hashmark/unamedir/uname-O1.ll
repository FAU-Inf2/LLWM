...
29:                                               ; preds = %26
  %30 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 1, i64 0
  call fastcc void @print_element(i8* nonnull %30)
  br label %31
...
34:                                               ; preds = %31
  %35 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 2, i64 0
  call fastcc void @print_element(i8* nonnull %35)
  br label %36
...
39:                                               ; preds = %36
  %40 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 3, i64 0
  call fastcc void @print_element(i8* nonnull %40)
  br label %41
...
44:                                               ; preds = %41
  %45 = getelementptr inbounds %struct.utsname, %struct.utsname* %3, i64 0, i32 4, i64 0
  call fastcc void @print_element(i8* nonnull %45)
  br label %46
...
62:                                               ; preds = %61, %58
  %63 = tail call i32 @putchar_unlocked(i32 10)
  ret i32 0
}
