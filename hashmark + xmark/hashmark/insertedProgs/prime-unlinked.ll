...
define dso_local i32 @prime_randomInteger() #0 {
  ...
  %2 = call i32 @_Z10computeFuniiiii(i32 401831361, i32 8, i32 -1705763822, i32 179968135, i32 117897624)
  %3 = mul nsw i32 %1, %2
  %4 = call i32 @_Z10computeFuniiiii(i32 -242997585, i32 24, i32 425764779, i32 77453931, i32 -144070718)
  %5 = add nsw i32 %3, %4
  %6 = call i32 @_Z10computeFuniiiii(i32 978919633, i32 13, i32 -593094986, i32 21662605, i32 -130371804)
  %7 = srem i32 %5, %6
...
13:                                               ; preds = %1
  %14 = call i32 @_Z10computeFuniiiii(i32 835702343, i32 18, i32 -934919, i32 265, i32 -130379896)
...
28:                                               ; preds = %27
  ...
  %30 = call i32 @_Z10computeFuniiiii(i32 203463327, i32 6, i32 -250901941, i32 3, i32 -144070797)
  %31 = add i32 %29, %30
...
define dso_local i32 @main(i32, i8**) #0 {
  ...
  %4 = alloca i32, align 4
  %5 = alloca i8**, align 8
  %6 = call i32 @_Z10computeFuniiiii(i32 -1656699874, i32 33, i32 1790663952, i32 25, i32 117897491)
