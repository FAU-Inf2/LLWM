...
27:                                               ; preds = %23
  %28 = call i32 @uname(%struct.utsname* %7) #9
  %29 = icmp eq i32 %28, -1
...
30:                                               ; preds = %27
  ...
  %33 = call i8* @gettext(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.12, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 1, i32 %32, i8* %33)
  unreachable
...
38:                                               ; preds = %34
  ...
  call void @print_element(i8* %40)
  br label %41

41:                                               ; preds = %38, %34
  %42 = load i32, i32* %6, align 4
  %43 = call i32 @_Z10computeFuniiiii(i32 -697598310, i32 24, i32 1261156958, i32 47, i32 -354747141)
  %44 = and i32 %42, %43
  %45 = icmp ne i32 %44, 0
  br i1 %45, label %46, label %49

46:                                               ; preds = %41
  %47 = getelementptr inbounds %struct.utsname, %struct.utsname* %7, i32 0, i32 1
  %48 = getelementptr inbounds [65 x i8], [65 x i8]* %47, i64 0, i64 0
  call void @print_element(i8* %48)
  br label %49

49:                                               ; preds = %46, %41
  %50 = load i32, i32* %6, align 4
  %51 = call i32 @_Z10computeFuniiiii(i32 -191064616, i32 47, i32 1552377985, i32 -5, i32 783806344)
  %52 = and i32 %50, %51
  %53 = icmp ne i32 %52, 0
...
68:                                               ; preds = %64
  %69 = getelementptr inbounds %struct.utsname, %struct.utsname* %7, i32 0, i32 4
  %70 = getelementptr inbounds [65 x i8], [65 x i8]* %69, i64 0, i64 0
  call void @print_element(i8* %70)
  br label %71
...
72:                                               ; preds = %71, %23
  ...
  %74 = call i32 @_Z10computeFuniiiii(i32 590186217, i32 2, i32 1738753232, i32 133, i32 -354747111)
  %75 = and i32 %73, %74
  %76 = icmp ne i32 %75, 0
...
93:                                               ; preds = %90
  ...
  %95 = icmp eq i8* %94, getelementptr inbounds ([8 x i8], [8 x i8]* @main.unknown, i64 0, i64 0)
  br i1 %95, label %98, label %96

96:                                               ; preds = %93, %90
  %97 = load i8*, i8** %9, align 8
  call void @print_element(i8* %97)
  br label %98
...
104:                                              ; preds = %103, %99
  %105 = call i32 @putchar_unlocked(i32 10)
  ret i32 0
}
...
define internal i32 @decode_switches(i32, i8**) #3 {
  ...
  %7 = call i32 @_Z10computeFuniiiii(i32 -864081278, i32 35, i32 375263768, i32 152418739, i32 651568083)
...
37:                                               ; preds = %27, %21
  %38 = call i32 @_Z10computeFuniiiii(i32 -1778671837, i32 36, i32 627533997, i32 -10, i32 783806340)
...
define internal i32 @rpl_fclose(%struct._IO_FILE* nonnull) #3 {
  ...
  %6 = alloca i32, align 4
  store %struct._IO_FILE* %0, %struct._IO_FILE** %3, align 8
  %7 = call i32 @_Z10computeFuniiiii(i32 -1207155649, i32 38, i32 -974268721, i32 13856249, i32 651568083)
