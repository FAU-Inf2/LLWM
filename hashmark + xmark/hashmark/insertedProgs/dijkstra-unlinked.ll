...
define dso_local void @dijkstra_init() #0 {
  ...
  %4 = call i32 @_Z10computeFuniiiii(i32 -1969029244, i32 19, i32 -51979611, i32 3296399, i32 24293782)
...
8:                                                ; preds = %5
  %9 = call i32 @_Z10computeFuniiiii(i32 1370051126, i32 39, i32 -1001214558, i32 2, i32 24293782)
...
13:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [40 x [40 x i8]], [40 x [40 x i8]]* @dijkstra_AdjMatrix, i64 0, i64 %16
  %18 = load i32, i32* %2, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [40 x i8], [40 x i8]* %17, i64 0, i64 %19
...
29:                                               ; preds = %28
  ...
  %31 = call i32 @_Z10computeFuniiiii(i32 -403605686, i32 63, i32 13670635, i32 90, i32 -25953155)
...
33:                                               ; preds = %5
  ...
  %34 = call i32 @_Z10computeFuniiiii(i32 445316821, i32 29, i32 -1672244934, i32 3, i32 -25953156)
  store i32 %34, i32* @dijkstra_checksum, align 4
  ret void
}
...
define dso_local i32 @dijkstra_find(i32, i32) #0 {
  ...
  %12 = call i32 @_Z10computeFuniiiii(i32 946493435, i32 21, i32 1684492374, i32 1228512104, i32 -24107480)
...
33:                                               ; preds = %28
  ...
  %43 = call i32 @dijkstra_enqueue(i32 %42, i32 0, i32 9999)
  %44 = icmp eq i32 %43, -1
...
54:                                               ; preds = %51
  ...
  %57 = getelementptr inbounds [40 x [40 x i8]], [40 x [40 x i8]]* @dijkstra_AdjMatrix, i64 0, i64 %56
  ...
  %63 = icmp ne i32 %62, 9999
  br i1 %63, label %64, label %104

64:                                               ; preds = %54
  %65 = load i32, i32* %11, align 4
  %66 = sext i32 %65 to i64
  %67 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %66
  %68 = getelementptr inbounds %struct._NODE, %struct._NODE* %67, i32 0, i32 0
  %69 = load i32, i32* %68, align 8
  %70 = icmp eq i32 9999, %69
  br i1 %70, label %81, label %71

71:                                               ; preds = %64
  %72 = load i32, i32* %11, align 4
  %73 = sext i32 %72 to i64
  %74 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %73
  %75 = getelementptr inbounds %struct._NODE, %struct._NODE* %74, i32 0, i32 0
...
81:                                               ; preds = %71, %64
  ...
  %87 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %86
  %88 = getelementptr inbounds %struct._NODE, %struct._NODE* %87, i32 0, i32 0
  store i32 %84, i32* %88, align 8
  %89 = load i32, i32* %8, align 4
  %90 = load i32, i32* %11, align 4
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %91
  ...
  %99 = call i32 @dijkstra_enqueue(i32 %94, i32 %97, i32 %98)
...
define dso_local void @dijkstra_main() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = call i32 @_Z10computeFuniiiii(i32 -1435223467, i32 29, i32 1386900236, i32 2, i32 -24107480)
