...
86:                                               ; preds = %82, %73
  ...
  %88 = call i32 @_Z10computeFuniiiii(i32 643430591, i32 30, i32 1145667648, i32 -327796334, i32 293405809)
  %89 = ashr i32 %87, %88
...
122:                                              ; preds = %119
  ...
  %124 = fcmp oge float %123, 1.000000e+00
...
131:                                              ; preds = %125
  ...
  %133 = call i32 @_Z10computeFuniiiii(i32 1677432663, i32 18, i32 1050517343, i32 -4, i32 293405809)
  %134 = and i32 %132, %133
...
139:                                              ; preds = %138, %119
  ...
  %141 = ashr i32 %140, 1
  %142 = call i32 @_Z10computeFuniiiii(i32 214676918, i32 56, i32 -787493798, i32 -223, i32 1509549726)
  ...
  %149 = bitcast %union.quicksort_ieee_float_shape_type* %14 to i32*
  store i32 %148, i32* %149, align 4
  %150 = bitcast %union.quicksort_ieee_float_shape_type* %14 to float*
  %151 = load float, float* %150, align 4
  store float %151, float* %4, align 4
  %152 = load float, float* %4, align 4
  store float %152, float* %2, align 4
  br label %153

153:                                              ; preds = %139, %42, %37, %22
...
define dso_local void @quicksort_init() #0 {
  ...
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = call i32 @_Z10computeFuniiiii(i32 994579206, i32 12, i32 -880378604, i32 77738, i32 452585118)
...
8:                                                ; preds = %18, %0
  ...
  %10 = icmp ult i32 %9, 3000
  br i1 %10, label %11, label %21

11:                                               ; preds = %8
  %12 = load volatile i32, i32* @quicksort_const_prop_border_i, align 4
  %13 = load i32, i32* %1, align 4
  %14 = zext i32 %13 to i64
  %15 = getelementptr inbounds [3000 x i32], [3000 x i32]* @quicksort_input_vector, i64 0, i64 %14
  %16 = load i32, i32* %15, align 4
  %17 = add i32 %16, %12
...
21:                                               ; preds = %8
  %22 = call i32 @_Z10computeFuniiiii(i32 1057466032, i32 61, i32 74086018, i32 2, i32 -510360702)
  store i32 %22, i32* %1, align 4
  br label %23

23:                                               ; preds = %77, %21
  %24 = load i32, i32* %1, align 4
  %25 = icmp ult i32 %24, 681
...
30:                                               ; preds = %27
  ...
  %33 = getelementptr inbounds [681 x i8*], [681 x i8*]* @quicksort_input_string, i64 0, i64 %32
  ...
  %41 = getelementptr inbounds [681 x [20 x i8]], [681 x [20 x i8]]* @quicksort_strings, i64 0, i64 %40
  %42 = load i32, i32* %2, align 4
  %43 = zext i32 %42 to i64
  %44 = getelementptr inbounds [20 x i8], [20 x i8]* %41, i64 0, i64 %43
  store i8 %38, i8* %44, align 1
  %45 = load volatile i8, i8* @quicksort_const_prop_border_c, align 1
  %46 = sext i8 %45 to i32
  %47 = load i32, i32* %1, align 4
  %48 = zext i32 %47 to i64
  %49 = getelementptr inbounds [681 x [20 x i8]], [681 x [20 x i8]]* @quicksort_strings, i64 0, i64 %48
  ...
  %59 = getelementptr inbounds [681 x i8*], [681 x i8*]* @quicksort_input_string, i64 0, i64 %58
...
72:                                               ; preds = %67, %27
  ...
  %75 = getelementptr inbounds [681 x [20 x i8]], [681 x [20 x i8]]* @quicksort_strings, i64 0, i64 %74
  %76 = getelementptr inbounds [20 x i8], [20 x i8]* %75, i64 0, i64 19
...
80:                                               ; preds = %23
  %81 = call i32 @_Z10computeFuniiiii(i32 612627731, i32 58, i32 135936546, i32 1, i32 -510360702)
...
85:                                               ; preds = %82
  ...
  %89 = getelementptr inbounds [3000 x i32], [3000 x i32]* @quicksort_input_vector, i64 0, i64 %88
  %90 = load i32, i32* %89, align 4
  %91 = load i32, i32* %1, align 4
  %92 = zext i32 %91 to i64
  %93 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %92
  %94 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %93, i32 0, i32 0
  ...
  %98 = getelementptr inbounds [3000 x i32], [3000 x i32]* @quicksort_input_vector, i64 0, i64 %97
  %99 = load i32, i32* %98, align 4
  %100 = load i32, i32* %1, align 4
  %101 = zext i32 %100 to i64
  %102 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %101
  %103 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %102, i32 0, i32 1
  ...
  %107 = getelementptr inbounds [3000 x i32], [3000 x i32]* @quicksort_input_vector, i64 0, i64 %106
  %108 = load i32, i32* %107, align 4
  %109 = load i32, i32* %1, align 4
  %110 = zext i32 %109 to i64
  %111 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %110
  %112 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %111, i32 0, i32 2
  store i32 %108, i32* %112, align 8
  store i32 %108, i32* %5, align 4
  %113 = load i32, i32* %3, align 4
  %114 = uitofp i32 %113 to float
  %115 = call float @quicksort___ieee754_powf(float %114, float 2.000000e+00)
  %116 = load i32, i32* %4, align 4
  %117 = uitofp i32 %116 to float
  %118 = call float @quicksort___ieee754_powf(float %117, float 2.000000e+00)
  %119 = fadd float %115, %118
  %120 = load i32, i32* %5, align 4
  %121 = uitofp i32 %120 to float
  %122 = call float @quicksort___ieee754_powf(float %121, float 2.000000e+00)
  %123 = fadd float %119, %122
  %124 = call float @quicksort___ieee754_sqrtf(float %123)
  %125 = fpext float %124 to double
  %126 = load i32, i32* %1, align 4
  %127 = zext i32 %126 to i64
  %128 = getelementptr inbounds [1000 x %struct.quicksort_3DVertexStruct], [1000 x %struct.quicksort_3DVertexStruct]* @quicksort_vectors, i64 0, i64 %127
  %129 = getelementptr inbounds %struct.quicksort_3DVertexStruct, %struct.quicksort_3DVertexStruct* %128, i32 0, i32 3
