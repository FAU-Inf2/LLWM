...
define dso_local i32 @main(i32, i8**) #3 {
  ...
  %7 = alloca i8, align 1
  %8 = call i32 @_Z10computeFuniiiii(i32 350127178, i32 54, i32 -222074662, i32 7, i32 979576158)
...
61:                                               ; preds = %55
  ...
  call void @who(i8* %66, i32 0)
  br label %76

67:                                               ; preds = %55
  %68 = call i8* @gettext(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.24, i64 0, i64 0)) #9
  ...
  call void (i32, i32, i8*, ...) @error(i32 0, i32 0, i8* %68, i8* %75)
  call void @usage(i32 1) #13
  unreachable
...
define internal void @print_runlevel(%struct.utmpx*) #3 {
  ...
  %8 = call i32 @_Z10computeFuniiiii(i32 802600740, i32 46, i32 -250455799, i32 1595, i32 148785766)
  %9 = sdiv i32 %7, %8
  ...
  %13 = load i32, i32* %12, align 4
  %14 = call i32 @_Z10computeFuniiiii(i32 1261823326, i32 8, i32 1158098469, i32 7027, i32 -58774358)
  %15 = srem i32 %13, %14
  %16 = trunc i32 %15 to i8
  store i8 %16, i8* %4, align 1
  %17 = load i8*, i8** @print_runlevel.runlevline, align 8
  %18 = icmp ne i8* %17, null
  br i1 %18, label %24, label %19

19:                                               ; preds = %1
  %20 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.84, i64 0, i64 0)) #9
  %21 = call i64 @strlen(i8* %20) #12
  %22 = add i64 %21, 3
  %23 = call noalias i8* @xmalloc(i64 %22)
  store i8* %23, i8** @print_runlevel.runlevline, align 8
  br label %24

24:                                               ; preds = %19, %1
  %25 = load i8*, i8** @print_runlevel.runlevline, align 8
  %26 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.84, i64 0, i64 0)) #9
  %27 = load i8, i8* %4, align 1
  %28 = zext i8 %27 to i32
  %29 = call i32 (i8*, i8*, ...) @sprintf(i8* %25, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.85, i64 0, i64 0), i8* %26, i32 %28) #9
  %30 = load i8*, i8** @print_runlevel.comment, align 8
  %31 = icmp ne i8* %30, null
  br i1 %31, label %37, label %32

32:                                               ; preds = %24
  %33 = call i8* @gettext(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.86, i64 0, i64 0)) #9
  %34 = call i64 @strlen(i8* %33) #12
  %35 = add i64 %34, 2
  %36 = call noalias i8* @xmalloc(i64 %35)
  store i8* %36, i8** @print_runlevel.comment, align 8
  br label %37

37:                                               ; preds = %32, %24
  %38 = load i8*, i8** @print_runlevel.comment, align 8
  %39 = call i8* @gettext(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.86, i64 0, i64 0)) #9
...
47:                                               ; preds = %44, %43
  %48 = phi i32 [ 83, %43 ], [ %46, %44 ]
  %49 = call i32 (i8*, i8*, ...) @sprintf(i8* %38, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.87, i64 0, i64 0), i8* %39, i32 %48) #9
  %50 = load i8*, i8** @print_runlevel.runlevline, align 8
  %51 = load %struct.utmpx*, %struct.utmpx** %2, align 8
  %52 = call i8* @time_string(%struct.utmpx* %51)
  %53 = load i8, i8* %3, align 1
  %54 = zext i8 %53 to i32
  %55 = call zeroext i1 @c_isprint(i32 %54)
  br i1 %55, label %56, label %58

56:                                               ; preds = %47
  %57 = load i8*, i8** @print_runlevel.comment, align 8
  br label %59
...
59:                                               ; preds = %58, %56
  %60 = phi i8* [ %57, %56 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.14, i64 0, i64 0), %58 ]
  call void @print_line(i32 -1, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.14, i64 0, i64 0), i8 signext 32, i32 -1, i8* %50, i8* %52, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.14, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.14, i64 0, i64 0), i8* %60, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.14, i64 0, i64 0))
  ret void
}
...
27:                                               ; preds = %21
  ...
  %32 = call i32 @_Z10computeFuniiiii(i32 -1047114571, i32 7, i32 -2100957333, i32 61226381, i32 979576158)
...
define internal i32 @rpl_fclose(%struct._IO_FILE* nonnull) #3 {
  ...
  %6 = alloca i32, align 4
  store %struct._IO_FILE* %0, %struct._IO_FILE** %3, align 8
  %7 = call i32 @_Z10computeFuniiiii(i32 1518488599, i32 27, i32 -1476325161, i32 8685347, i32 148785510)
  store i32 %7, i32* %4, align 4
  %8 = call i32 @_Z10computeFuniiiii(i32 494000182, i32 31, i32 1084223803, i32 1466935439, i32 -58774614)
  store i32 %8, i32* %6, align 4
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8
  %10 = call i32 @fileno(%struct._IO_FILE* %9) #9
...
16:                                               ; preds = %1
  ...
  %18 = call i32 @__freading(%struct._IO_FILE* %17) #9
  %19 = icmp ne i32 %18, 0
  br i1 %19, label %20, label %25

20:                                               ; preds = %16
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8
  %22 = call i32 @fileno(%struct._IO_FILE* %21) #9
  %23 = call i64 @lseek(i32 %22, i64 0, i32 1) #9
  %24 = icmp ne i64 %23, -1
  br i1 %24, label %25, label %32

25:                                               ; preds = %20, %16
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8
  %27 = call i32 @rpl_fflush(%struct._IO_FILE* %26)
  %28 = icmp ne i32 %27, 0
