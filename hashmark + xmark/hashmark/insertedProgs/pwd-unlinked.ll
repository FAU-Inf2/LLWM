...
define dso_local i32 @main(i32, i8**) #3 {
  ...
  %10 = call i32 @_Z10computeFuniiiii(i32 1561537871, i32 57, i32 828984761, i32 2, i32 -42)
...
33:                                               ; preds = %28
  ...
  call void (%struct._IO_FILE*, i8*, i8*, i8*, ...) @version_etc(%struct._IO_FILE* %34, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.14, i64 0, i64 0), i8* %35, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.15, i64 0, i64 0), i8* null)
...
42:                                               ; preds = %38
  %43 = call i8* @gettext(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.16, i64 0, i64 0)) #9
  call void (i32, i32, i8*, ...) @error(i32 0, i32 0, i8* %43)
  br label %44
...
51:                                               ; preds = %47
  ...
  %54 = call i32 @_Z10computeFuniiiii(i32 -1616974194, i32 45, i32 -73028475, i32 1, i32 -42)
...
64:                                               ; preds = %56
  ...
  store %struct.file_name* %65, %struct.file_name** %9, align 8
  %66 = load %struct.file_name*, %struct.file_name** %9, align 8
  call void @robust_getcwd(%struct.file_name* %66)
  %67 = load %struct.file_name*, %struct.file_name** %9, align 8
  %68 = getelementptr inbounds %struct.file_name, %struct.file_name* %67, i32 0, i32 2
  %69 = load i8*, i8** %68, align 8
  %70 = call i32 @puts(i8* %69)
  %71 = load %struct.file_name*, %struct.file_name** %9, align 8
  call void @file_name_free(%struct.file_name* %71)
  br label %72
...
define internal i32 @rpl_fclose(%struct._IO_FILE* nonnull) #3 {
  ...
  %6 = alloca i32, align 4
  store %struct._IO_FILE* %0, %struct._IO_FILE** %3, align 8
  %7 = call i32 @_Z10computeFuniiiii(i32 132678085, i32 5, i32 371947687, i32 453537842, i32 -42)
  store i32 %7, i32* %4, align 4
  %8 = call i32 @_Z10computeFuniiiii(i32 -23133997, i32 39, i32 -734888922, i32 8, i32 -42)
