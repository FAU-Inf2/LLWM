...
93:                                               ; preds = %93, %91
  ...
  %98 = srem i32 %97, 8095
  store volatile i32 %98, i32* @test3_seed, align 4, !tbaa !2
  %99 = load volatile i32, i32* @test3_seed, align 4, !tbaa !2
  %100 = getelementptr inbounds [32 x [32 x i32]], [32 x [32 x i32]]* @test3_array7, i64 0, i64 %92, i64 %94
  store i32 %99, i32* %100, align 4, !tbaa !2
...
106:                                              ; preds = %103, %118
  %107 = phi i64 [ %119, %118 ], [ 0, %103 ]
  br label %108

108:                                              ; preds = %108, %106
  %109 = phi i64 [ 0, %106 ], [ %116, %108 ]
  %110 = load volatile i32, i32* @test3_seed, align 4, !tbaa !2
  %111 = mul nsw i32 %110, 133
  %112 = add nsw i32 %111, 81
  %113 = srem i32 %112, 8095
  store volatile i32 %113, i32* @test3_seed, align 4, !tbaa !2
  %114 = load volatile i32, i32* @test3_seed, align 4, !tbaa !2
  %115 = getelementptr inbounds [32 x [32 x i32]], [32 x [32 x i32]]* @test3_array8, i64 0, i64 %107, i64 %109
  store i32 %114, i32* %115, align 4, !tbaa !2
