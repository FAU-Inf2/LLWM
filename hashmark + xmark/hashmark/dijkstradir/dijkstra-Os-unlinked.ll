...
17:                                               ; preds = %14
  %18 = call i32 @_Z10computeFuniiiii(i32 1390268476, i32 58, i32 -11451001, i32 489, i32 459601140)
...
3:                                                ; preds = %3, %2
  ...
  %6 = call i32 @_Z10computeFuniiiii(i32 1893823489, i32 16, i32 -1158883462, i32 638694724, i32 -704266162)
  store i32 %6, i32* %5, align 8, !tbaa !14
  %7 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %4, i32 1
...
12:                                               ; preds = %10
  ...
  %16 = call i32 @_Z10computeFuniiiii(i32 -198892570, i32 6, i32 2064581714, i32 29, i32 -704266162)
  store i32 %16, i32* %15, align 4, !tbaa !16
  %17 = tail call i32 @dijkstra_enqueue(i32 %0, i32 0, i32 9999) #4
  %18 = icmp eq i32 %17, -1
  br i1 %18, label %63, label %19

19:                                               ; preds = %12
  %20 = load i32, i32* @dijkstra_queueCount, align 4, !tbaa !2
  %21 = icmp sgt i32 %20, 0
  br i1 %21, label %25, label %63

22:                                               ; preds = %60
  %23 = load i32, i32* @dijkstra_queueCount, align 4, !tbaa !2
  %24 = icmp sgt i32 %23, 0
  br i1 %24, label %25, label %63

25:                                               ; preds = %22, %19
  %26 = phi i32 [ %23, %22 ], [ %20, %19 ]
  %27 = phi i32 [ %42, %22 ], [ 0, %19 ]
  %28 = phi i32 [ %41, %22 ], [ 0, %19 ]
  %29 = load %struct._QITEM*, %struct._QITEM** @dijkstra_queueHead, align 8, !tbaa !7
  %30 = icmp eq %struct._QITEM* %29, null
  br i1 %30, label %40, label %31

31:                                               ; preds = %25
  %32 = getelementptr inbounds %struct._QITEM, %struct._QITEM* %29, i64 0, i32 0
  %33 = load i32, i32* %32, align 8, !tbaa !9
  %34 = getelementptr inbounds %struct._QITEM, %struct._QITEM* %29, i64 0, i32 1
  %35 = load i32, i32* %34, align 4, !tbaa !11
  %36 = getelementptr inbounds %struct._QITEM, %struct._QITEM* %29, i64 0, i32 3
  %37 = bitcast %struct._QITEM** %36 to i64*
  %38 = load i64, i64* %37, align 8, !tbaa !13
  store i64 %38, i64* bitcast (%struct._QITEM** @dijkstra_queueHead to i64*), align 8, !tbaa !7
  %39 = add nsw i32 %26, -1
  store i32 %39, i32* @dijkstra_queueCount, align 4, !tbaa !2
  br label %40

40:                                               ; preds = %31, %25
  %41 = phi i32 [ %28, %25 ], [ %33, %31 ]
  %42 = phi i32 [ %27, %25 ], [ %35, %31 ]
  %43 = sext i32 %41 to i64
  br label %44

44:                                               ; preds = %60, %40
  %45 = phi i64 [ 0, %40 ], [ %61, %60 ]
  %46 = getelementptr inbounds [40 x [40 x i8]], [40 x [40 x i8]]* @dijkstra_AdjMatrix, i64 0, i64 %43, i64 %45
  %47 = load i8, i8* %46, align 1, !tbaa !6
  %48 = zext i8 %47 to i32
  %49 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %45, i32 0
...
55:                                               ; preds = %44
  store i32 %52, i32* %49, align 8, !tbaa !14
  %56 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %45, i32 1
  store i32 %41, i32* %56, align 4, !tbaa !16
  %57 = trunc i64 %45 to i32
  %58 = tail call i32 @dijkstra_enqueue(i32 %57, i32 %52, i32 %41) #4
  %59 = icmp eq i32 %58, -1
...
60:                                               ; preds = %55, %44
  ...
  br i1 %62, label %22, label %44

63:                                               ; preds = %55, %22, %19, %12, %10
  %64 = phi i32 [ -1, %12 ], [ 0, %10 ], [ 0, %19 ], [ -1, %55 ], [ 0, %22 ]
  ret i32 %64
}
...
10:                                               ; preds = %1
  ...
  %16 = call i32 @_Z10computeFuniiiii(i32 1274262295, i32 51, i32 958865541, i32 727, i32 789843840)
  store i32 %16, i32* @dijkstra_queueNext, align 4, !tbaa !2
  %17 = call i32 @_Z10computeFuniiiii(i32 1066548850, i32 19, i32 -541931037, i32 -57, i32 789843841)
  %18 = add nuw nsw i32 %3, %17
  %19 = call i32 @_Z10computeFuniiiii(i32 -854742662, i32 5, i32 -795239880, i32 -3221979, i32 459601141)
  %20 = add nsw i32 %4, %19
