...
20:                                               ; preds = %18
  ...
  %26 = tail call i32 @dijkstra_enqueue(i32 %0, i32 0, i32 9999) #5
  %27 = icmp eq i32 %26, -1
...
31:                                               ; preds = %28
  call void @dijkstra_dequeue(i32* nonnull %4, i32* nonnull %5, i32* nonnull %3) #5
...
48:                                               ; preds = %38
  ...
  %51 = tail call i32 @dijkstra_enqueue(i32 %50, i32 %45, i32 %32) #5
  %52 = icmp eq i32 %51, -1
...
5:                                                ; preds = %1
  %6 = srem i32 %3, 40
  %7 = tail call i32 @dijkstra_find(i32 %2, i32 %6) #5
  %8 = icmp eq i32 %7, -1
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  tail call void @dijkstra_init() #5
  tail call void @dijkstra_main() #5
