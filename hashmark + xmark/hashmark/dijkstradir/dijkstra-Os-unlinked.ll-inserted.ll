...
12:                                               ; preds = %10
  ...
  %17 = tail call i32 @dijkstra_enqueue(i32 %0, i32 0, i32 9999) #16
  %18 = icmp eq i32 %17, -1
...
55:                                               ; preds = %44
  ...
  %58 = tail call i32 @dijkstra_enqueue(i32 %57, i32 %52, i32 %41) #16
  %59 = icmp eq i32 %58, -1
...
1:                                                ; preds = %10, %0
  ...
  %3 = phi i32 [ 0, %0 ], [ %18, %10 ]
  %4 = srem i32 %2, 40
  %5 = tail call i32 @dijkstra_find(i32 %3, i32 %4) #16
  %6 = icmp eq i32 %5, -1
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  tail call void @dijkstra_init() #16
  tail call void @dijkstra_main() #16
...
71:                                               ; preds = %69, %33
  ...
  %76 = add i32 %75, %74
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %20) #15
  %77 = load i8*, i8** %15, align 8, !tbaa !20
...
82:                                               ; preds = %81, %71
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [27 x i8*] }, { [27 x i8*] }* @_ZTVN8CryptoPP31IteratedHashWithStaticTransformIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ELj32ENS_6SHA256ELj32ELb1EEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %11, align 8, !tbaa !17
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [27 x i8*] }, { [27 x i8*] }* @_ZTVN8CryptoPP12IteratedHashIjNS_10EnumToTypeINS_9ByteOrderELi1EEELj64ENS_18HashTransformationEEE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %11, align 8, !tbaa !17
...
85:                                               ; preds = %65, %61
  ...
  %88 = load i8*, i8** %15, align 8, !tbaa !20
...
9:                                                ; preds = %6
  ...
  %11 = load i8, i8* %10, align 1, !tbaa !37, !range !45
  %12 = icmp eq i8 %11, 0
...
14:                                               ; preds = %9
  ...
  %16 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %2, i32* %15) #15, !srcloc !46
  ret void
...
9:                                                ; preds = %7
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTVN8CryptoPP14NotImplementedE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %10, align 8, !tbaa !17
...
define linkonce_odr dso_local void @_ZNK8CryptoPP9Algorithm13AlgorithmNameB5cxx11Ev(%"class.std::__cxx11::basic_string"* noalias sret, %"class.CryptoPP::Algorithm"*) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store %union.anon* %3, %union.anon** %4, align 8, !tbaa !44
...
9:                                                ; preds = %3
  ...
  %13 = sub i64 %11, %12
  store i64 %13, i64* %4, align 8, !tbaa !47
...
18:                                               ; preds = %9
  ...
  %21 = load i64, i64* %4, align 8, !tbaa !47
...
26:                                               ; preds = %23
  %27 = load i8, i8* %1, align 1, !tbaa !27
...
29:                                               ; preds = %28, %26, %23
  %30 = load i64, i64* %4, align 8, !tbaa !47
...
define linkonce_odr dso_local void @_ZN8CryptoPP9ExceptionC2ENS0_9ErrorTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.CryptoPP::Exception"*, i32, %"class.std::__cxx11::basic_string"* dereferenceable(32)) unnamed_addr #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* @_ZTVN8CryptoPP9ExceptionE, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %4, align 8, !tbaa !17
...
13:                                               ; preds = %10
  ...
  %15 = load i8, i8* %14, align 1, !tbaa !42, !range !45
  %16 = icmp eq i8 %15, 0
...
18:                                               ; preds = %13
  ...
  %20 = tail call { i64, i32* } asm sideeffect "rep stosl", "={cx},={di},{ax},0,1,~{memory},~{dirflag},~{fpsr},~{flags}"(i32 0, i64 %2, i32* %19) #15, !srcloc !46
  ret void
...
19:                                               ; preds = %12
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [27 x i8*] }, { [27 x i8*] }* @_ZTVN8CryptoPP6SHA256E, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !tbaa !17
...
; Function Attrs: optsize uwtable
define linkonce_odr dso_local void @_ZN8CryptoPP8SecBlockIjNS_29FixedSizeAllocatorWithCleanupIjLm16ENS_13NullAllocatorIjEELb0EEEEC2ERKS5_(%"class.CryptoPP::SecBlock"*, %"class.CryptoPP::SecBlock"* dereferenceable(88)) unnamed_addr #4 comdat align 2 personality i32 (...)* @__gxx_personality_v0 {
  %3 = getelementptr inbounds %"class.CryptoPP::SecBlock", %"class.CryptoPP::SecBlock"* %0, i64 0, i32 0, i32 2
  store i8 0, i8* %3, align 1, !tbaa !37
...
attributes #4 = { optsize uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
