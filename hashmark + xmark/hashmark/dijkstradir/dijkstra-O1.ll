...
17:                                               ; preds = %15
  ...
  %19 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %18, i32 0
  store i32 0, i32* %19, align 8, !tbaa !14
  %20 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %18, i32 1
  store i32 9999, i32* %20, align 4, !tbaa !16
  %21 = tail call i32 @dijkstra_enqueue(i32 %0, i32 0, i32 9999)
  %22 = icmp eq i32 %21, -1
  br i1 %22, label %53, label %23

23:                                               ; preds = %17
  %24 = tail call i32 @dijkstra_qcount()
...
29:                                               ; preds = %23, %26
  ...
  %30 = load i32, i32* %4, align 4, !tbaa !2
...
33:                                               ; preds = %50, %29
  ...
  %35 = getelementptr inbounds [40 x [40 x i8]], [40 x [40 x i8]]* @dijkstra_AdjMatrix, i64 0, i64 %31, i64 %34
  %36 = load i8, i8* %35, align 1, !tbaa !6
  %37 = zext i8 %36 to i32
  %38 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %34, i32 0
...
44:                                               ; preds = %33
  ...
  store i32 %45, i32* %38, align 8, !tbaa !14
  %46 = getelementptr inbounds [40 x %struct._NODE], [40 x %struct._NODE]* @dijkstra_rgnNodes, i64 0, i64 %34, i32 1
  store i32 %30, i32* %46, align 4, !tbaa !16
  %47 = trunc i64 %34 to i32
  %48 = tail call i32 @dijkstra_enqueue(i32 %47, i32 %45, i32 %30)
  %49 = icmp eq i32 %48, -1
...
50:                                               ; preds = %33, %44
  ...
  br i1 %52, label %26, label %33

53:                                               ; preds = %26, %44, %23, %15, %17
  %54 = phi i32 [ -1, %17 ], [ 0, %15 ], [ 0, %23 ], [ -1, %44 ], [ 0, %26 ]
