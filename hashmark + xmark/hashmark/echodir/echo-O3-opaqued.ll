...
93:                                               ; preds = %92
  ...
  br i1 %98, label %279, label %311

99:                                               ; preds = %83
  br i1 %91, label %100, label %311

100:                                              ; preds = %278, %99
  %101 = phi i32 [ %264, %278 ], [ %86, %99 ]
  %102 = phi i8** [ %265, %278 ], [ %84, %99 ]
  %103 = load i8*, i8** %102, align 8, !tbaa !4
  br label %104

104:                                              ; preds = %260, %100
  %105 = phi i8* [ %103, %100 ], [ %249, %260 ]
  %106 = getelementptr inbounds i8, i8* %105, i64 1
  %107 = load i8, i8* %105, align 1, !tbaa !11
  switch i8 %107, label %248 [
    i8 0, label %263
    i8 92, label %108
  ]
...
108:                                              ; preds = %104
  ...
  br i1 %110, label %248, label %111

111:                                              ; preds = %108
  %112 = getelementptr inbounds i8, i8* %105, i64 2
  switch i8 %109, label %237 [
    i8 97, label %113
    i8 98, label %114
    i8 99, label %325
    i8 101, label %115
...
156:                                              ; preds = %140
  %157 = icmp eq i16 %146, 0
  br i1 %157, label %203, label %158

158:                                              ; preds = %156
  %159 = getelementptr inbounds i8, i8* %105, i64 4
  %160 = shl i32 %141, 4
...
187:                                              ; preds = %186, %185, %184, %183, %182, %180, %158, %158
  %188 = phi i32 [ %181, %180 ], [ 15, %186 ], [ 14, %185 ], [ 13, %184 ], [ 12, %183 ], [ 11, %182 ], [ 10, %158 ], [ 10, %158 ]
  %189 = mul i32 %160, 2
  %190 = add i32 %189, 4
  %191 = mul i32 %160, -2
  %192 = add i32 %191, -3
...
203:                                              ; preds = %201, %156
  %204 = phi i8* [ %159, %201 ], [ %131, %156 ]
  %205 = phi i32 [ %202, %201 ], [ %141, %156 ]
  %206 = trunc i32 %205 to i8
  br label %248

207:                                              ; preds = %111
  %208 = load i8, i8* %112, align 1, !tbaa !11
  %209 = and i8 %208, -8
  %210 = icmp eq i8 %209, 48
  br i1 %210, label %211, label %248

211:                                              ; preds = %207
  %212 = getelementptr inbounds i8, i8* %105, i64 3
  br label %213

213:                                              ; preds = %211, %111, %111, %111, %111, %111, %111, %111
  %214 = phi i8* [ %112, %111 ], [ %112, %111 ], [ %112, %111 ], [ %112, %111 ], [ %112, %111 ], [ %112, %111 ], [ %112, %111 ], [ %212, %211 ]
  %215 = phi i8 [ %109, %111 ], [ %109, %111 ], [ %109, %111 ], [ %109, %111 ], [ %109, %111 ], [ %109, %111 ], [ %109, %111 ], [ %208, %211 ]
  %216 = add nsw i8 %215, -48
  %217 = load i8, i8* %214, align 1, !tbaa !11
  %218 = and i8 %217, -8
...
220:                                              ; preds = %213
  ...
  %223 = add nsw i8 %217, -48
  %224 = add nuw nsw i8 %223, %221
  %225 = load i8, i8* %222, align 1, !tbaa !11
  br label %226

226:                                              ; preds = %220, %213
  %227 = phi i8 [ %225, %220 ], [ %217, %213 ]
  %228 = phi i8* [ %222, %220 ], [ %214, %213 ]
  %229 = phi i8 [ %224, %220 ], [ %216, %213 ]
  %230 = and i8 %227, -8
...
232:                                              ; preds = %226
  ...
  %235 = add nsw i8 %227, -48
  %236 = add i8 %235, %233
  br label %248

237:                                              ; preds = %121, %111
  %238 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %239 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %238, i64 0, i32 5
  %240 = load i8*, i8** %239, align 8, !tbaa !14
  %241 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %238, i64 0, i32 6
  %242 = load i8*, i8** %241, align 8, !tbaa !18
  %243 = icmp ult i8* %240, %242
  br i1 %243, label %246, label %244, !prof !19

244:                                              ; preds = %237
  %245 = tail call i32 @__overflow(%struct._IO_FILE* %238, i32 92) #15
  br label %248

246:                                              ; preds = %237
  %247 = getelementptr inbounds i8, i8* %240, i64 1
  store i8* %247, i8** %239, align 8, !tbaa !14
  store i8 92, i8* %240, align 1, !tbaa !11
  br label %248

248:                                              ; preds = %246, %244, %232, %226, %207, %203, %120, %119, %118, %117, %116, %115, %114, %113, %111, %108, %104
  %249 = phi i8* [ %112, %111 ], [ %234, %232 ], [ %228, %226 ], [ %112, %207 ], [ %112, %120 ], [ %112, %119 ], [ %112, %118 ], [ %112, %117 ], [ %112, %116 ], [ %112, %115 ], [ %112, %114 ], [ %112, %113 ], [ %106, %108 ], [ %106, %104 ], [ %204, %203 ], [ %112, %244 ], [ %112, %246 ]
  %250 = phi i8 [ %109, %111 ], [ %236, %232 ], [ %229, %226 ], [ 0, %207 ], [ 11, %120 ], [ 9, %119 ], [ 13, %118 ], [ 10, %117 ], [ 12, %116 ], [ 27, %115 ], [ 8, %114 ], [ 7, %113 ], [ 92, %108 ], [ %107, %104 ], [ %206, %203 ], [ %109, %244 ], [ %109, %246 ]
  ...
  br i1 %256, label %261, label %257, !prof !19

257:                                              ; preds = %248
  %258 = zext i8 %250 to i32
  %259 = tail call i32 @__overflow(%struct._IO_FILE* %251, i32 %258) #15
  br label %260
...
261:                                              ; preds = %248
  ...
  store i8* %262, i8** %252, align 8, !tbaa !14
  store i8 %250, i8* %253, align 1, !tbaa !11
  br label %260

263:                                              ; preds = %104
  %264 = add nsw i32 %101, -1
  %265 = getelementptr inbounds i8*, i8** %102, i64 1
  %266 = icmp sgt i32 %264, 0
  br i1 %266, label %267, label %311

267:                                              ; preds = %263
  %268 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %269 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %268, i64 0, i32 5
  %270 = load i8*, i8** %269, align 8, !tbaa !14
  %271 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %268, i64 0, i32 6
  %272 = load i8*, i8** %271, align 8, !tbaa !18
  %273 = icmp ult i8* %270, %272
  br i1 %273, label %276, label %274, !prof !19

274:                                              ; preds = %267
  %275 = tail call i32 @__overflow(%struct._IO_FILE* %268, i32 32) #15
  br label %278

276:                                              ; preds = %267
  %277 = getelementptr inbounds i8, i8* %270, i64 1
  store i8* %277, i8** %269, align 8, !tbaa !14
  store i8 32, i8* %270, align 1, !tbaa !11
  br label %278
...
279:                                              ; preds = %309, %93
  %280 = phi i8** [ %282, %309 ], [ %84, %93 ]
  %281 = phi i32 [ %297, %309 ], [ %97, %93 ]
  %282 = getelementptr inbounds i8*, i8** %280, i64 1
  %283 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %284 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %283, i64 0, i32 5
  %285 = load i8*, i8** %284, align 8, !tbaa !14
  %286 = getelementptr inbounds %struct._IO_FILE, %struct._IO_FILE* %283, i64 0, i32 6
  %287 = load i8*, i8** %286, align 8, !tbaa !18
  %288 = icmp ult i8* %285, %287
  br i1 %288, label %291, label %289, !prof !19

289:                                              ; preds = %279
  %290 = tail call i32 @__overflow(%struct._IO_FILE* %283, i32 32) #15
  br label %293

291:                                              ; preds = %279
  %292 = getelementptr inbounds i8, i8* %285, i64 1
  store i8* %292, i8** %284, align 8, !tbaa !14
  store i8 32, i8* %285, align 1, !tbaa !11
  br label %293

293:                                              ; preds = %291, %289
  %294 = load i8*, i8** %282, align 8, !tbaa !4
  %295 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !tbaa !4
  %296 = tail call i32 @fputs_unlocked(i8* %294, %struct._IO_FILE* %295)
...
309:                                              ; preds = %293
  %310 = icmp sgt i32 %297, 0
  br i1 %310, label %279, label %311

311:                                              ; preds = %309, %263, %99, %93, %92
  %312 = and i8 %85, 1
...
314:                                              ; preds = %311
  ...
  br i1 %320, label %323, label %321, !prof !19

321:                                              ; preds = %314
  %322 = tail call i32 @__overflow(%struct._IO_FILE* %315, i32 10) #15
  br label %325

323:                                              ; preds = %314
  %324 = getelementptr inbounds i8, i8* %317, i64 1
  store i8* %324, i8** %316, align 8, !tbaa !14
  store i8 10, i8* %317, align 1, !tbaa !11
  br label %325

325:                                              ; preds = %323, %321, %311, %111, %30
  ret i32 0
}
