...
91:                                               ; preds = %90, %89, %88, %81
  ...
  %94 = load i8, i8* %86, align 1, !tbaa !11
  %95 = icmp eq i8 %94, 0
...
123:                                              ; preds = %281, %119
  ...
  %126 = load i8, i8* %124, align 1, !tbaa !11
...
127:                                              ; preds = %123
  %128 = load i8, i8* %125, align 1, !tbaa !11
...
140:                                              ; preds = %130
  %141 = load i8, i8* %131, align 1, !tbaa !11
  %142 = tail call i16** @__ctype_b_loc() #19
...
176:                                              ; preds = %175, %174, %173, %172, %171, %168, %166, %166
  ...
  %178 = load i8, i8* %167, align 1, !tbaa !11
  %179 = zext i8 %178 to i64
  %180 = getelementptr inbounds i16, i16* %143, i64 %179
  %181 = load i16, i16* %180, align 2, !tbaa !12
...
228:                                              ; preds = %130
  %229 = load i8, i8* %131, align 1, !tbaa !11
  %230 = and i8 %229, -8
...
234:                                              ; preds = %232, %130, %130, %130, %130, %130, %130, %130
  ...
  %238 = load i8, i8* %235, align 1, !tbaa !11
  %239 = and i8 %238, -8
...
241:                                              ; preds = %234
  ...
  %246 = load i8, i8* %243, align 1, !tbaa !11
  br label %247
...
258:                                              ; preds = %164, %130
  ...
  br i1 %264, label %267, label %265, !prof !19

265:                                              ; preds = %258
  %266 = tail call i32 @__overflow(%struct._IO_FILE* %259, i32 92) #15
  br label %269

267:                                              ; preds = %258
  %268 = getelementptr inbounds i8, i8* %261, i64 1
  store i8* %268, i8** %260, align 8, !tbaa !14
  store i8 92, i8* %261, align 1, !tbaa !11
  br label %269
...
269:                                              ; preds = %267, %265, %253, %247, %228, %224, %139, %138, %137, %136, %135, %134, %133, %132, %130, %127, %123
  ...
  br i1 %277, label %282, label %278, !prof !19

278:                                              ; preds = %269
  %279 = zext i8 %271 to i32
  %280 = tail call i32 @__overflow(%struct._IO_FILE* %272, i32 %279) #15
  br label %281
...
282:                                              ; preds = %269
  ...
  store i8* %283, i8** %273, align 8, !tbaa !14
  store i8 %271, i8* %274, align 1, !tbaa !11
  br label %281
...
288:                                              ; preds = %284
  ...
  br i1 %294, label %297, label %295, !prof !19

295:                                              ; preds = %288
  %296 = tail call i32 @__overflow(%struct._IO_FILE* %289, i32 32) #15
  br label %299

297:                                              ; preds = %288
  %298 = getelementptr inbounds i8, i8* %291, i64 1
  store i8* %298, i8** %290, align 8, !tbaa !14
  store i8 32, i8* %291, align 1, !tbaa !11
  br label %299
...
300:                                              ; preds = %314, %112
  ...
  br i1 %309, label %312, label %310, !prof !19

310:                                              ; preds = %300
  %311 = tail call i32 @__overflow(%struct._IO_FILE* %304, i32 32) #15
  br label %314

312:                                              ; preds = %300
  %313 = getelementptr inbounds i8, i8* %306, i64 1
  store i8* %313, i8** %305, align 8, !tbaa !14
  store i8 32, i8* %306, align 1, !tbaa !11
  br label %314
...
323:                                              ; preds = %320
  ...
  %328 = load i8*, i8** %327, align 8, !tbaa !18
  %329 = icmp ult i8* %326, %328
  br i1 %329, label %332, label %330, !prof !19

330:                                              ; preds = %323
  %331 = tail call i32 @__overflow(%struct._IO_FILE* %324, i32 10) #15
  br label %334

332:                                              ; preds = %323
  %333 = getelementptr inbounds i8, i8* %326, i64 1
  store i8* %333, i8** %325, align 8, !tbaa !14
  store i8 10, i8* %326, align 1, !tbaa !11
  br label %334
