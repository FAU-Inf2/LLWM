...
110:                                              ; preds = %109, %108, %107, %100
  ...
  %113 = load i8, i8* %105, align 1, !tbaa !8
...
156:                                              ; preds = %324, %152
  ...
  %159 = load i8, i8* %157, align 1, !tbaa !8
...
160:                                              ; preds = %156
  %161 = load i8, i8* %158, align 1, !tbaa !8
...
200:                                              ; preds = %199, %198, %197, %196, %195, %192, %190, %190
  ...
  %202 = load i8, i8* %191, align 1, !tbaa !8
  %203 = zext i8 %202 to i64
  %204 = getelementptr inbounds i16, i16* %176, i64 %203
  %205 = load i16, i16* %204, align 2, !tbaa !9
...
271:                                              ; preds = %163
  %272 = load i8, i8* %164, align 1, !tbaa !8
  %273 = and i8 %272, -8
...
277:                                              ; preds = %275, %163, %163, %163, %163, %163, %163, %163
  ...
  %281 = load i8, i8* %278, align 1, !tbaa !8
  %282 = and i8 %281, -8
...
284:                                              ; preds = %277
  ...
  %289 = load i8, i8* %286, align 1, !tbaa !8
  br label %290
...
301:                                              ; preds = %188, %163
  ...
  %304 = load i8*, i8** %303, align 8, !tbaa !11
...
308:                                              ; preds = %301
  %309 = tail call i32 @__overflow(%struct._IO_FILE* %302, i32 92) #8
  br label %312

310:                                              ; preds = %301
  %311 = getelementptr inbounds i8, i8* %304, i64 1
  store i8* %311, i8** %303, align 8, !tbaa !11
  store i8 92, i8* %304, align 1, !tbaa !8
  br label %312
...
312:                                              ; preds = %310, %308, %296, %290, %271, %267, %172, %171, %170, %169, %168, %167, %166, %165, %163, %160, %156
  ...
  %317 = load i8*, i8** %316, align 8, !tbaa !11
  ...
  br i1 %320, label %325, label %321, !prof !16

321:                                              ; preds = %312
  %322 = zext i8 %314 to i32
  %323 = tail call i32 @__overflow(%struct._IO_FILE* %315, i32 %322) #8
  br label %324
...
325:                                              ; preds = %312
  ...
  store i8* %326, i8** %316, align 8, !tbaa !11
  store i8 %314, i8* %317, align 1, !tbaa !8
  br label %324
...
331:                                              ; preds = %327
  ...
  %334 = load i8*, i8** %333, align 8, !tbaa !11
  ...
  br i1 %337, label %340, label %338, !prof !16

338:                                              ; preds = %331
  %339 = tail call i32 @__overflow(%struct._IO_FILE* %332, i32 32) #8
  br label %342

340:                                              ; preds = %331
  %341 = getelementptr inbounds i8, i8* %334, i64 1
  store i8* %341, i8** %333, align 8, !tbaa !11
  store i8 32, i8* %334, align 1, !tbaa !8
  br label %342
...
343:                                              ; preds = %357, %145
  ...
  br i1 %352, label %355, label %353, !prof !16

353:                                              ; preds = %343
  %354 = tail call i32 @__overflow(%struct._IO_FILE* %347, i32 32) #8
  br label %357

355:                                              ; preds = %343
  %356 = getelementptr inbounds i8, i8* %349, i64 1
  store i8* %356, i8** %348, align 8, !tbaa !11
  store i8 32, i8* %349, align 1, !tbaa !8
  br label %357
...
366:                                              ; preds = %363
  ...
  br i1 %372, label %375, label %373, !prof !16

373:                                              ; preds = %366
  %374 = tail call i32 @__overflow(%struct._IO_FILE* %367, i32 10) #8
  br label %377

375:                                              ; preds = %366
  %376 = getelementptr inbounds i8, i8* %369, i64 1
  store i8* %376, i8** %368, align 8, !tbaa !11
  store i8 10, i8* %369, align 1, !tbaa !8
  br label %377
...
20:                                               ; preds = %1
  %21 = call fastcc i8* @quotearg_n_options(i32 0, i8* %0, i64 -1, %struct.quoting_options* nonnull %2) #8
...
56:                                               ; preds = %34
  ...
  %58 = load i32, i32* %57, align 8, !tbaa !33
...
66:                                               ; preds = %56
  %67 = add i64 %64, 1
  store i64 %67, i64* %37, align 8, !tbaa !28
...
70:                                               ; preds = %69, %66
  %71 = tail call noalias i8* @xmalloc(i64 %67) #8
  store i8* %71, i8** %39, align 8, !tbaa !30
  %72 = load i32, i32* %57, align 8, !tbaa !33
  %73 = load i8*, i8** %60, align 8, !tbaa !34
  %74 = load i8*, i8** %62, align 8, !tbaa !35
...
47:                                               ; preds = %26, %26
  %48 = call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11.54, i64 0, i64 0), i32 5) #8
  %49 = icmp eq i8* %48, getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11.54, i64 0, i64 0)
  br i1 %49, label %50, label %108

50:                                               ; preds = %47
  %51 = call i8* @locale_charset() #8
...
108:                                              ; preds = %105, %101, %72, %47
  ...
  %110 = call i8* @dcgettext(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12.56, i64 0, i64 0), i32 5) #8
  %111 = icmp eq i8* %110, getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12.56, i64 0, i64 0)
  br i1 %111, label %112, label %170

112:                                              ; preds = %108
  %113 = call i8* @locale_charset() #8
...
155:                                              ; preds = %151
  ...
  %157 = load i8, i8* %156, align 1, !tbaa !8
...
163:                                              ; preds = %159
  ...
  %165 = load i8, i8* %164, align 1, !tbaa !8
...
175:                                              ; preds = %170
  %176 = load i8, i8* %171, align 1, !tbaa !8
...
252:                                              ; preds = %242
  ...
  %254 = load i8, i8* %253, align 1, !tbaa !8
...
287:                                              ; preds = %285
  ...
  store i8 39, i8* %288, align 1, !tbaa !8
  br label %289
...
292:                                              ; preds = %289
  ...
  store i8 36, i8* %293, align 1, !tbaa !8
  br label %294
...
312:                                              ; preds = %310
  ...
  store i8 39, i8* %313, align 1, !tbaa !8
  br label %314
...
320:                                              ; preds = %316
  ...
  store i8 92, i8* %321, align 1, !tbaa !8
  br label %322
...
343:                                              ; preds = %341
  ...
  %345 = load i8, i8* %344, align 1, !tbaa !8
  %346 = add i8 %345, -48
...
350:                                              ; preds = %348
  ...
  store i8 48, i8* %351, align 1, !tbaa !8
  br label %352
...
368:                                              ; preds = %366
  ...
  store i8 48, i8* %369, align 1, !tbaa !8
  br label %370
...
438:                                              ; preds = %436
  ...
  store i8 63, i8* %439, align 1, !tbaa !8
  br label %440
...
443:                                              ; preds = %440
  ...
  store i8 34, i8* %444, align 1, !tbaa !8
  br label %445
...
464:                                              ; preds = %462
  ...
  store i8 34, i8* %465, align 1, !tbaa !8
  br label %466
...
485:                                              ; preds = %483
  ...
  store i8 63, i8* %486, align 1, !tbaa !8
  br label %487
...
502:                                              ; preds = %501
  %503 = load i8, i8* %18, align 1, !tbaa !8
...
519:                                              ; preds = %512
  ...
  store i8 39, i8* %520, align 1, !tbaa !8
  br label %521
...
534:                                              ; preds = %532
  ...
  store i8 92, i8* %535, align 1, !tbaa !8
  br label %536
...
539:                                              ; preds = %536
  ...
  store i8 39, i8* %540, align 1, !tbaa !8
  br label %541
...
555:                                              ; preds = %553
  %556 = call i64 @strlen(i8* nonnull %2) #21
  br label %557
...
559:                                              ; preds = %577, %557
  ...
  %564 = sub i64 %558, %562
  %565 = call i64 @rpl_mbrtowc(i32* nonnull %12, i8* %563, i64 %564, %struct.__mbstate_t* nonnull %11) #8
...
577:                                              ; preds = %575, %572
  %578 = load i32, i32* %12, align 4, !tbaa !20
  %579 = call i32 @iswprint(i32 %578) #8
  %580 = icmp eq i32 %579, 0
  %581 = select i1 %580, i8 0, i8 %561
  %582 = add i64 %565, %560
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %24) #8
  %583 = call i32 @mbsinit(%struct.__mbstate_t* nonnull %11) #21
...
586:                                              ; preds = %637, %557
  ...
  %591 = sub i64 %558, %589
  %592 = call i64 @rpl_mbrtowc(i32* nonnull %12, i8* %590, i64 %591, %struct.__mbstate_t* nonnull %11) #8
...
597:                                              ; preds = %603, %593
  ...
  %601 = load i8, i8* %600, align 1, !tbaa !8
...
612:                                              ; preds = %586
  %613 = load i32, i32* %12, align 4, !tbaa !20
  %614 = call i32 @iswprint(i32 %613) #8
...
637:                                              ; preds = %612
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %24) #8
  %638 = call i32 @mbsinit(%struct.__mbstate_t* nonnull %11) #21
...
668:                                              ; preds = %666
  ...
  store i8 39, i8* %669, align 1, !tbaa !8
  br label %670
...
693:                                              ; preds = %691
  ...
  store i8 36, i8* %694, align 1, !tbaa !8
  br label %695
...
698:                                              ; preds = %695
  ...
  store i8 39, i8* %699, align 1, !tbaa !8
  br label %700
...
706:                                              ; preds = %702
  ...
  store i8 92, i8* %707, align 1, !tbaa !8
  br label %708
...
711:                                              ; preds = %708
  ...
  store i8 %713, i8* %714, align 1, !tbaa !8
  br label %715
...
733:                                              ; preds = %731
  ...
  store i8 %736, i8* %737, align 1, !tbaa !8
  br label %738
...
747:                                              ; preds = %745
  ...
  store i8 92, i8* %748, align 1, !tbaa !8
  br label %749
...
767:                                              ; preds = %765
  ...
  store i8 39, i8* %768, align 1, !tbaa !8
  br label %769
...
772:                                              ; preds = %769
  ...
  store i8 39, i8* %773, align 1, !tbaa !8
  br label %774
...
780:                                              ; preds = %776
  ...
  store i8 %754, i8* %781, align 1, !tbaa !8
  br label %782
...
797:                                              ; preds = %782
  ...
  %799 = load i8, i8* %798, align 1, !tbaa !8
  br label %654
...
841:                                              ; preds = %839
  ...
  store i8 39, i8* %842, align 1, !tbaa !8
  br label %843
...
860:                                              ; preds = %858
  ...
  store i8 36, i8* %861, align 1, !tbaa !8
  br label %862
...
865:                                              ; preds = %862
  ...
  store i8 39, i8* %866, align 1, !tbaa !8
  br label %867
...
873:                                              ; preds = %869
  ...
  store i8 92, i8* %874, align 1, !tbaa !8
  br label %875
...
900:                                              ; preds = %897
  ...
  store i8 39, i8* %901, align 1, !tbaa !8
  br label %902
...
931:                                              ; preds = %920
  ...
  store i8 %923, i8* %932, align 1, !tbaa !8
  br label %933
...
972:                                              ; preds = %969
  %973 = load i8, i8* %217, align 1, !tbaa !8
...
980:                                              ; preds = %975
  ...
  store i8 %976, i8* %981, align 1, !tbaa !8
  br label %982

982:                                              ; preds = %980, %975
  %983 = add i64 %978, 1
  %984 = getelementptr inbounds i8, i8* %977, i64 1
  %985 = load i8, i8* %984, align 1, !tbaa !8
...
990:                                              ; preds = %987
  ...
  store i8 0, i8* %991, align 1, !tbaa !8
  br label %1015
...
16:                                               ; preds = %14
  %17 = add i64 %2, -1
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 %1, i8* nonnull align 1 %4, i64 %17, i1 false) #8
