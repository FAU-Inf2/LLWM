...
64:                                               ; preds = %36
  %65 = icmp eq i64 %38, %40
  br i1 %65, label %67, label %66

66:                                               ; preds = %64, %30, %27, %24
  br label %67

67:                                               ; preds = %66, %64, %17, %17, %13, %13, %7, %0
  %68 = phi i8* [ null, %66 ], [ null, %7 ], [ null, %0 ], [ %5, %64 ], [ null, %17 ], [ null, %17 ], [ null, %13 ], [ null, %13 ]
...
28:                                               ; preds = %26
  ...
  store i8* %39, i8** %4, align 8, !tbaa !13
...
42:                                               ; preds = %28, %26
  %43 = load i8*, i8** %4, align 8, !tbaa !13
  %44 = xor i64 %2, -1
...
55:                                               ; preds = %42
  ...
  store i8* %56, i8** %4, align 8, !tbaa !13
  store i8 47, i8* %56, align 1, !tbaa !16
  %57 = load i8*, i8** %4, align 8, !tbaa !13
...
68:                                               ; preds = %57
  %69 = add i64 %66, 1
  store i64 %69, i64* %37, align 8, !tbaa !37
...
72:                                               ; preds = %71, %68
  ...
  store i8* %73, i8** %39, align 8, !tbaa !39
  %74 = load i32, i32* %59, align 8, !tbaa !34
  %75 = load i8*, i8** %62, align 8, !tbaa !41
  %76 = load i8*, i8** %64, align 8, !tbaa !42
...
402:                                              ; preds = %400
  %403 = call i64 @strlen(i8* nonnull %2) #20
  br label %404
...
406:                                              ; preds = %457, %404
  ...
  %411 = sub i64 %405, %409
  %412 = call i64 @rpl_mbrtowc(i32* nonnull %12, i8* %410, i64 %411, %struct.__mbstate_t* nonnull %11) #17
...
453:                                              ; preds = %452, %436, %430, %428, %406
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %454) #17
  br label %465

457:                                              ; preds = %449, %440
  %458 = load i32, i32* %12, align 4, !tbaa !11
  %459 = call i32 @iswprint(i32 %458) #17
  %460 = icmp eq i32 %459, 0
  %461 = select i1 %460, i8 0, i8 %408
  %462 = add i64 %412, %407
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %24) #17
  %463 = call i32 @mbsinit(%struct.__mbstate_t* nonnull %11) #20
