...
43:                                               ; preds = %41, %37
  ...
  br i1 %45, label %46, label %55, !dbg !313
...
46:                                               ; preds = %43
  ...
  br i1 %49, label %50, label %54, !dbg !319

50:                                               ; preds = %46
  %51 = load i8*, i8** %6, align 8, !dbg !320
  %52 = call i32 @puts(i8* %51), !dbg !322
  %53 = call i32 @_Z10computeFuniiiii(i32 -884559290, i32 37, i32 -1913256353, i32 319, i32 -14982932)
  store i32 %53, i32* %3, align 4, !dbg !323
  br label %72, !dbg !323
...
55:                                               ; preds = %54, %43
  %56 = call i8* @xgetcwd(), !dbg !325
  store i8* %56, i8** %6, align 8, !dbg !326
  %57 = load i8*, i8** %6, align 8, !dbg !327
  %58 = icmp ne i8* %57, null, !dbg !329
  br i1 %58, label %59, label %63, !dbg !330

59:                                               ; preds = %55
  %60 = load i8*, i8** %6, align 8, !dbg !331
  %61 = call i32 @puts(i8* %60), !dbg !333
  %62 = load i8*, i8** %6, align 8, !dbg !334
  call void @free(i8* %62) #10, !dbg !335
  br label %71, !dbg !336

63:                                               ; preds = %55
  call void @llvm.dbg.declare(metadata %struct.file_name** %9, metadata !337, metadata !DIExpression()), !dbg !345
  %64 = call %struct.file_name* @file_name_init(), !dbg !346
  store %struct.file_name* %64, %struct.file_name** %9, align 8, !dbg !345
  %65 = load %struct.file_name*, %struct.file_name** %9, align 8, !dbg !347
  call void @robust_getcwd(%struct.file_name* %65), !dbg !348
  %66 = load %struct.file_name*, %struct.file_name** %9, align 8, !dbg !349
  %67 = getelementptr inbounds %struct.file_name, %struct.file_name* %66, i32 0, i32 2, !dbg !350
  %68 = load i8*, i8** %67, align 8, !dbg !350
  %69 = call i32 @puts(i8* %68), !dbg !351
  %70 = load %struct.file_name*, %struct.file_name** %9, align 8, !dbg !352
  call void @file_name_free(%struct.file_name* %70), !dbg !353
  br label %71
...
72:                                               ; preds = %71, %50
  %73 = load i32, i32* %3, align 4, !dbg !355
  ret i32 %73, !dbg !355
}
...
37:                                               ; preds = %27, %21
  %38 = call i32 @_Z10computeFuniiiii(i32 -2082907604, i32 51, i32 1888224602, i32 11, i32 -14982932)
  store i32 %38, i32* %2, align 4, !dbg !2786
  br label %39, !dbg !2786

39:                                               ; preds = %37, %36
  %40 = load i32, i32* %2, align 4, !dbg !2787
  ret i32 %40, !dbg !2787
}
...
define internal i32 @rpl_fclose(%struct._IO_FILE* nonnull) #4 !dbg !2923 {
  ...
  %7 = call i32 @_Z10computeFuniiiii(i32 -1434592811, i32 16, i32 -104396938, i32 1, i32 26440528)
  store i32 %7, i32* %4, align 4, !dbg !2964
  ...
  %8 = call i32 @_Z10computeFuniiiii(i32 -1240053244, i32 25, i32 -1579735536, i32 97382629, i32 26440528)
  store i32 %8, i32* %6, align 4, !dbg !2968
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2969
  %10 = call i32 @fileno(%struct._IO_FILE* %9) #10, !dbg !2970
  store i32 %10, i32* %5, align 4, !dbg !2971
  %11 = load i32, i32* %5, align 4, !dbg !2972
  %12 = icmp slt i32 %11, 0, !dbg !2974
  br i1 %12, label %13, label %16, !dbg !2975

13:                                               ; preds = %1
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2976
  %15 = call i32 @fclose(%struct._IO_FILE* %14), !dbg !2977
  store i32 %15, i32* %2, align 4, !dbg !2978
  br label %64, !dbg !2978

16:                                               ; preds = %1
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2979
  %18 = call i32 @__freading(%struct._IO_FILE* %17) #10, !dbg !2979
  %19 = icmp ne i32 %18, 0, !dbg !2979
  br i1 %19, label %20, label %25, !dbg !2981

20:                                               ; preds = %16
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2982
  %22 = call i32 @fileno(%struct._IO_FILE* %21) #10, !dbg !2983
  %23 = call i64 @lseek(i32 %22, i64 0, i32 1) #10, !dbg !2984
  %24 = icmp ne i64 %23, -1, !dbg !2985
  br i1 %24, label %25, label %32, !dbg !2986

25:                                               ; preds = %20, %16
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2987
  %27 = call i32 @rpl_fflush(%struct._IO_FILE* %26), !dbg !2988
  %28 = icmp ne i32 %27, 0, !dbg !2988
  br i1 %28, label %29, label %32, !dbg !2989

29:                                               ; preds = %25
  %30 = call i32* @__errno_location() #15, !dbg !2990
  %31 = load i32, i32* %30, align 4, !dbg !2990
  store i32 %31, i32* %4, align 4, !dbg !2991
  br label %32, !dbg !2992

32:                                               ; preds = %29, %25, %20
  %33 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8, !dbg !2993
  %34 = call i32 @fclose(%struct._IO_FILE* %33), !dbg !2994
  store i32 %34, i32* %6, align 4, !dbg !2995
  %35 = load i32, i32* %4, align 4, !dbg !2996
  %36 = mul i32 %35, -2
  %37 = call i32 @_Z10computeFuniiiii(i32 -1628676623, i32 55, i32 -1809885695, i32 3, i32 -9594950)
  %38 = add i32 %36, %37
  %39 = add i32 %35, -2
  %40 = call i32 @_Z10computeFuniiiii(i32 -129593314, i32 45, i32 1205347571, i32 239237961, i32 -9594950)
  %41 = mul i32 %34, %40
  %42 = add i32 %41, 3
  %43 = mul i32 %38, %38
  %44 = mul i32 %43, %43
...
57:                                               ; preds = %32
  %58 = icmp ne i32 %35, 0, !dbg !2998
  br i1 %58, label %59, label %62, !dbg !2999

59:                                               ; preds = %57
  %60 = load i32, i32* %4, align 4, !dbg !3000
  %61 = call i32* @__errno_location() #15, !dbg !3002
  store i32 %60, i32* %61, align 4, !dbg !3003
  store i32 -1, i32* %6, align 4, !dbg !3004
  br label %62, !dbg !3005

62:                                               ; preds = %59, %57
  %63 = load i32, i32* %6, align 4, !dbg !3006
  store i32 %63, i32* %2, align 4, !dbg !3007
  br label %64, !dbg !3007

64:                                               ; preds = %62, %13
  %65 = load i32, i32* %2, align 4, !dbg !3008
  ret i32 %65, !dbg !3008
}
