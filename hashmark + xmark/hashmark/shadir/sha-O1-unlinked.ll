...
35:                                               ; preds = %31, %29
  ...
  %39 = add i64 %26, %38
  %40 = call i32 @_Z10computeFuniiiii(i32 -554701898, i32 17, i32 -1357911942, i32 60339, i32 180005077)
  %41 = and i32 %11, %40
  br label %42

42:                                               ; preds = %35, %3
  %43 = phi i64 [ %36, %35 ], [ %5, %3 ]
  %44 = phi i64 [ %39, %35 ], [ %4, %3 ]
  %45 = phi i32 [ %41, %35 ], [ %2, %3 ]
  %46 = icmp eq i32 %45, 0
...
6:                                                ; preds = %3
  %7 = trunc i32 %1 to i8
  %8 = call i32 @_Z10computeFuniiiii(i32 1733890149, i32 3, i32 822312058, i32 -645885483, i32 354013143)
  %9 = and i32 %1, %8
  %10 = call i32 @_Z10computeFuniiiii(i32 294813853, i32 10, i32 1458340860, i32 587882877, i32 180005078)
...
22:                                               ; preds = %22, %20
  %23 = phi i64 [ %25, %22 ], [ %4, %20 ]
  %24 = inttoptr i64 %23 to i8*
  store i8 %7, i8* %24, align 1, !tbaa !2
  %25 = add nsw i64 %23, 1
  %26 = and i64 %25, 7
  %27 = icmp eq i64 %26, 0
...
31:                                               ; preds = %28, %6
  %32 = phi i32 [ %2, %6 ], [ %30, %28 ]
  %33 = phi i64 [ %4, %6 ], [ %25, %28 ]
  %34 = lshr i32 %32, 6
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %50, label %36

36:                                               ; preds = %36, %31
  %37 = phi i32 [ %48, %36 ], [ %34, %31 ]
  %38 = phi i64 [ %47, %36 ], [ %33, %31 ]
  %39 = inttoptr i64 %38 to i64*
  store i64 %17, i64* %39, align 8, !tbaa !5
  %40 = getelementptr inbounds i64, i64* %39, i64 1
  store i64 %17, i64* %40, align 8, !tbaa !5
  %41 = getelementptr inbounds i64, i64* %39, i64 2
  store i64 %17, i64* %41, align 8, !tbaa !5
  %42 = getelementptr inbounds i64, i64* %39, i64 3
  store i64 %17, i64* %42, align 8, !tbaa !5
  %43 = getelementptr inbounds i64, i64* %39, i64 4
  store i64 %17, i64* %43, align 8, !tbaa !5
  %44 = getelementptr inbounds i64, i64* %39, i64 5
  store i64 %17, i64* %44, align 8, !tbaa !5
  %45 = getelementptr inbounds i64, i64* %39, i64 6
  store i64 %17, i64* %45, align 8, !tbaa !5
  %46 = getelementptr inbounds i64, i64* %39, i64 7
...
50:                                               ; preds = %36, %31
  %51 = phi i64 [ %33, %31 ], [ %47, %36 ]
  %52 = lshr i32 %32, 3
  %53 = call i32 @_Z10computeFuniiiii(i32 -1031959393, i32 38, i32 -1071792223, i32 9, i32 354012895)
  %54 = and i32 %52, %53
  %55 = icmp eq i32 %54, 0
  br i1 %55, label %63, label %56

56:                                               ; preds = %56, %50
  %57 = phi i32 [ %61, %56 ], [ %54, %50 ]
  %58 = phi i64 [ %60, %56 ], [ %51, %50 ]
  %59 = inttoptr i64 %58 to i64*
  store i64 %17, i64* %59, align 8, !tbaa !5
  %60 = add i64 %58, 8
  %61 = add nsw i32 %57, -1
  %62 = icmp eq i32 %61, 0
...
66:                                               ; preds = %63, %3
  %67 = phi i32 [ %65, %63 ], [ %2, %3 ]
  %68 = phi i64 [ %64, %63 ], [ %4, %3 ]
  %69 = icmp eq i32 %67, 0
...
72:                                               ; preds = %72, %70
  %73 = phi i64 [ %68, %70 ], [ %76, %72 ]
  %74 = phi i32 [ %67, %70 ], [ %77, %72 ]
  %75 = inttoptr i64 %73 to i8*
  store i8 %71, i8* %75, align 1, !tbaa !2
  %76 = add nsw i64 %73, 1
  %77 = add i32 %74, -1
  %78 = icmp eq i32 %77, 0
...
define dso_local void @sha_final(%struct.SHA_INFO*) local_unnamed_addr #3 {
  ...
  %12 = call i32 @_Z10computeFuniiiii(i32 1578145827, i32 53, i32 1408305134, i32 -657439023, i32 388673509)
  %13 = add nuw nsw i32 %8, %12
  %14 = zext i32 %8 to i64
  %15 = getelementptr inbounds i8, i8* %11, i64 %14
  store i8 -128, i8* %15, align 1, !tbaa !2
  %16 = icmp ugt i32 %8, 55
...
19:                                               ; preds = %1
  %20 = xor i32 %8, 63
  %21 = tail call i8* @sha_glibc_memset(i8* nonnull %18, i32 0, i32 %20)
  tail call void @sha_byte_reverse(i64* nonnull %10, i32 64)
  tail call void @sha_transform(%struct.SHA_INFO* nonnull %0)
  %22 = tail call i8* @sha_glibc_memset(i8* nonnull %11, i32 0, i32 56)
  br label %27

23:                                               ; preds = %1
  %24 = call i32 @_Z10computeFuniiiii(i32 -1984098142, i32 23, i32 986984908, i32 3, i32 388673563)
  %25 = sub nuw nsw i32 %24, %8
  %26 = tail call i8* @sha_glibc_memset(i8* nonnull %18, i32 0, i32 %25)
  br label %27

27:                                               ; preds = %23, %19
  tail call void @sha_byte_reverse(i64* nonnull %10, i32 64)
  %28 = getelementptr inbounds %struct.SHA_INFO, %struct.SHA_INFO* %0, i64 0, i32 3, i64 14
  store i64 %5, i64* %28, align 8, !tbaa !5
  %29 = getelementptr inbounds %struct.SHA_INFO, %struct.SHA_INFO* %0, i64 0, i32 3, i64 15
  store i64 %3, i64* %29, align 8, !tbaa !5
  tail call void @sha_transform(%struct.SHA_INFO* nonnull %0)
  ret void
}
