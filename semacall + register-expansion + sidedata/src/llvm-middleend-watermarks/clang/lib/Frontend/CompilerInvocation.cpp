...
#undef CODEGEN_OPTION_WITH_MARSHALLING
  ...
  Opts.GetsKey = std::string(Args.getLastArgValue(OPT_watermark_gets_key_EQ));
  Opts.GetsVal = std::string(Args.getLastArgValue(OPT_watermark_gets_val_EQ));
  Opts.AtoiKey = std::string(Args.getLastArgValue(OPT_watermark_atoi_key_EQ));
  Opts.AtoiVal = std::string(Args.getLastArgValue(OPT_watermark_atoi_val_EQ));
  Opts.TimeKey = std::string(Args.getLastArgValue(OPT_watermark_time_key_EQ));
  Opts.TimeVal = std::string(Args.getLastArgValue(OPT_watermark_time_val_EQ));
  Opts.RegsKey = atoi(Args.getLastArgValue(OPT_watermark_key_EQ).str().c_str());
  Opts.RegsVal = atoi(Args.getLastArgValue(OPT_watermark_val_EQ).str().c_str());
  Opts.SidedataKey = std::string(Args.getLastArgValue(OPT_sidedata_key_EQ));
  Opts.SidedataVal = std::string(Args.getLastArgValue(OPT_sidedata_val_EQ));
